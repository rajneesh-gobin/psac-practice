-- ═══════════════════════════════════════════════════════════════════════════
--  Worksheets on the class page — 2026-09-20
--
--  A worksheet (public.physical_homework) is a paper task the teacher uploads
--  or describes, with a deadline. Until now it lived only on the teacher's
--  Activities tab: pupils could not see it, and its deadline was on no
--  calendar. materials_library_open() now returns 'worksheets' for the
--  classroom, behind the same PIN as everything else, never on the info call.
--
--  ⚠ Function body is the LIVE one (read from pg_proc on 2026-09-20 after the
--    calendar migration), with one declaration, one query and one return key
--    added. Idempotent: CREATE OR REPLACE only.
-- ═══════════════════════════════════════════════════════════════════════════
