...
for (const [section, countAdded] of [['evidence',17], ['language',15]]) {
...
console.log('32 evidence/language additions passed coverage and structural checks.');
