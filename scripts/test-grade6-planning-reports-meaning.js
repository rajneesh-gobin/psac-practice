...
for (const [chapterId, section, countAdded] of [
  ['g6eng-writing','planning',5], ['g6eng-passages','report',6], ['g6eng-vocabulary','meaning',10]
]) {
...
console.log('21 planning/report/meaning additions passed coverage and structural checks.');
