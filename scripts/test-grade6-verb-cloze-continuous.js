...
for (const [section, countAdded] of [['continuous',18], ['cloze',9]]) {
...
console.log('27 continuous/cloze additions passed coverage and structural checks.');
