...
for (const [section, countAdded] of [['confusables',16], ['prefix_suffix',18]]) {
...
console.log('34 confusable/affix additions passed coverage and structural checks.');
