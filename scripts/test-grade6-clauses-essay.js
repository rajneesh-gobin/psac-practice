...
const added = bank.filter(q => q.id.startsWith('g6eng-ce-'));
...
for (const [chapterId, section, countAdded] of [
  ['g6eng-clauses','cloze',11], ['g6eng-clauses','clause_types',2], ['g6eng-writing','essay',15]
]) {
...
console.log('28 clause/essay additions passed coverage and structural checks.');
