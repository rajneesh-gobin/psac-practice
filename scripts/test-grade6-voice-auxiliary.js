...
for (const [section, countAdded] of [['voice',14], ['auxiliary',17]]) {
...
console.log('31 voice/auxiliary additions passed coverage and structural checks.');
