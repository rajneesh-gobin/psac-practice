...
<div class="paper">
  ...
  <div class="footer">
    Generated by MathMaster Grade 5 · MIE Mauritius Curriculum · mathmaster-g5 &nbsp;|&nbsp;
...
document.getElementById('export-btn').addEventListener('click', () => {
  ...
  a.download = `mathmaster-progress-${new Date().toISOString().slice(0,10)}.json`;
  a.click();
...
console.log(`✅ MathMaster Grade 5 loaded. ${STATIC_QUESTIONS.length} static questions across ${CHAPTERS.length} chapters.`);
