...
const LabQuadratData = (() => {
  ...
  const GUIDES = [
    { id: 'first', icon: '🟩', title: 'Throw your first quadrats',
      ...
      steps: [
        { on: 'gloves:on', say: 'Put your gloves on - some plants in this clearing have prickles.', btn: '🧤 Gloves on' },
        { on: 'species:guava', say: 'Choose what to count: strawberry guava, an invasive alien species.', btn: '🍒 Strawberry guava' },
        { on: 'throw', say: 'Throw the quadrat at random. Two random numbers give its x and y coordinates on the plot.', btn: '🎲 Throw at random' },
        { on: 'count', say: 'Count the guava inside the frame. A plant on the frame counts only if it crosses the top or left side.', btn: '✅ Count (edge rule)' },
        { on: 'throw', say: 'One square metre is not enough. Throw again.', btn: '🎲 Throw at random' },
        { on: 'count', say: 'Count this one too.', btn: '✅ Count (edge rule)' },
        { on: 'auto5', say: 'Throw and count five more quadrats at random.', btn: '⏩ 5 more at random' },
        { on: 'estimate', say: 'Now work out the estimate: mean per quadrat × (400 m² ÷ 1 m²).', btn: '🧮 Work out the estimate' },
      ] },
    { id: 'census', icon: '🔢', title: 'Is the estimate right?',
      ...
      steps: [
        { on: 'gloves:on', say: 'Gloves on first.', btn: '🧤 Gloves on' },
        { on: 'species:guava', say: 'Count the strawberry guava.', btn: '🍒 Strawberry guava' },
        { on: 'auto5', say: 'Throw and count five quadrats at random.', btn: '⏩ 5 at random' },
        { on: 'auto5', say: 'Five more - ten altogether.', btn: '⏩ 5 more at random' },
        { on: 'estimate', say: 'Work out your estimate for the whole plot.', btn: '🧮 Work out the estimate' },
        { on: 'census', say: 'Now the ranger team counts every one of the 400 squares - a census. How close were you?', btn: '🔢 Count every square' },
      ] },
    { id: 'invasion', icon: '⏩', title: 'Ten years of invasion',
      ...
      steps: [
        { on: 'gloves:on', say: 'Gloves on.', btn: '🧤 Gloves on' },
        { on: 'species:guava', say: 'Count the strawberry guava.', btn: '🍒 Strawberry guava' },
        { on: 'auto5', say: 'Five quadrats at random.', btn: '⏩ 5 at random' },
        { on: 'auto5', say: 'Five more.', btn: '⏩ 5 more at random' },
        { on: 'estimate', say: 'Estimate the guava population today.', btn: '🧮 Work out the estimate' },
        { on: 'event:spread', say: 'Now let ten years pass with nobody controlling the invaders.', btn: '⏩ 10 years of invasion' },
        { on: 'auto5', say: 'Survey the plot again: five quadrats at random.', btn: '⏩ 5 at random' },
        { on: 'auto5', say: 'Five more.', btn: '⏩ 5 more at random' },
        { on: 'estimate', say: 'Estimate the guava population ten years on.', btn: '🧮 Work out the estimate' },
      ] },
    { id: 'ebony', icon: '🌱', title: 'Find the endemic ebony',
      ...
      steps: [
        { on: 'gloves:on', say: 'Gloves on.', btn: '🧤 Gloves on' },
        { on: 'species:ebony', say: 'Choose the Mauritian ebony seedlings - an endemic species.', btn: '🌱 Ebony seedlings' },
        { on: 'auto5', say: 'Throw and count five quadrats at random.', btn: '⏩ 5 at random' },
        { on: 'auto5', say: 'Five more.', btn: '⏩ 5 more at random' },
        { on: 'estimate', say: 'Work out the estimate. How many zeros are in your table?', btn: '🧮 Work out the estimate' },
      ] },
  ];
