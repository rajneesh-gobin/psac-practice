...
const LabWaterData = (() => {
  ...
  const GUIDES = [
    { id: 'ice_steam', icon: '🔥', title: 'From ice to steam', grades: [4],
      ...
      steps: [
        { on: 'rig:heat', say: 'Go to the heating bench.', btn: '🔥 Heat & cool' },
        { on: 'adult:on', say: 'The hot plate gets very hot. Ask an adult to help you.', btn: '🧑 Ask an adult to help' },
        { on: 'place:hot', say: 'Put the beaker of ice on the hot plate.', btn: '🔥 On the hot plate' },
        { on: 'five', say: 'Wait 5 minutes. Watch the ice.', btn: '⏩ Wait 5 minutes' },
        { on: 'read', say: 'The ice is melting. Read the thermometer, with your eyes level.', btn: '🌡️ Read the thermometer' },
        { on: 'five', say: 'Wait 5 more minutes. Watch the water.', btn: '⏩ Wait 5 minutes' },
        { on: 'min', say: 'Wait 1 more minute. Look for big bubbles.', btn: '⏱ Wait 1 minute' },
        { on: 'read', say: 'The water is boiling. Read the thermometer again.', btn: '🌡️ Read the thermometer' },
        { on: 'name:steam', say: 'Something rises from the water. What is it?', btn: '🏷️ It is steam' },
        { on: 'catch', say: 'Hold a cold plate over the steam. Wear an oven glove.', btn: '🍽️ Hold a cold plate over it' },
      ] },
    { id: 'freeze', icon: '❄️', title: 'Freeze it', grades: [4],
      ...
      steps: [
        { on: 'rig:heat', say: 'Go to the heating bench.', btn: '🔥 Heat & cool' },
        { on: 'start:water', say: 'Start with a beaker of tap water.', btn: '💧 Tap water' },
        { on: 'place:freezer', say: 'Put the beaker in the freezer.', btn: '❄️ In the freezer' },
        { on: 'five', say: 'Wait 5 minutes. Watch the water.', btn: '⏩ Wait 5 minutes' },
        { on: 'read', say: 'Ice is forming. Read the thermometer, with your eyes level.', btn: '🌡️ Read the thermometer' },
        { on: 'five', say: 'Wait 5 more minutes.', btn: '⏩ Wait 5 minutes' },
      ] },
    { id: 'drying', icon: '☀️', title: 'The drying race', grades: [4],
      ...
      steps: [
        { on: 'rig:dry', say: 'Go to the drying race. Each dish holds 30 ml of water.', btn: '☀️ Drying race' },
        { on: 'dish:B', say: 'Dish A stays as it is. Tap dish B.', btn: 'Dish B' },
        { on: 'spot:sun', say: 'Put dish B in the sun.', btn: '☀️ In the sun' },
        { on: 'dish:C', say: 'Now tap dish C.', btn: 'Dish C' },
        { on: 'fan:on', say: 'Put a fan by dish C. It blows air over the water.', btn: '🌀 Fan on' },
        { on: 'six', say: 'Wait 6 hours. Which dish has the least water left?', btn: '⏩ Wait 6 hours' },
      ] },
    { id: 'jar', icon: '🫙', title: 'A water cycle in a jar', grades: [4],
      ...
      steps: [
        { on: 'rig:jar', say: 'Go to the glass jar.', btn: '🫙 Water cycle' },
        { on: 'jwater:warm', say: 'Pour warm tap water into the jar. Warm, not boiling!', btn: '♨️ Warm water' },
        { on: 'jlid:ice', say: 'Cover the jar with a plate. Put ice cubes on the plate.', btn: '🧊 Plate of ice' },
        { on: 'ten', say: 'Wait 10 minutes. Look under the lid.', btn: '⏱ Wait 10 minutes' },
        { on: 'ten', say: 'Wait 10 more minutes. Watch the drops.', btn: '⏱ Wait 10 minutes' },
      ] },
  ];
