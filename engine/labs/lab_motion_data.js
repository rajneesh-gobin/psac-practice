...
const LabMotionData = (() => {
  ...
  const GUIDES = [
    { id: 'ramp', icon: '🛷', title: 'Roll a trolley down a ramp',
      ...
      steps: [
        { on: 'setup:ramp',  say: 'Put the trolley and ramp on the bench.',                                        btn: '🛷 Set up the ramp' },
        { on: 'block:on',    say: 'Safety first: clamp the stop block at the bottom of the ramp.',                 btn: '🧱 Fit the stop block' },
        { on: 'height:20',   say: 'Raise the top end of the ramp to 20 cm.',                                       btn: '▲ Raise the ramp to 20 cm' },
        { on: 'run',         say: 'Let go of the trolley. Watch the speed-time graph draw itself as it rolls.',   btn: '▶ Release the trolley' },
        { on: 'gradient',    say: 'Draw a triangle on the line and work out its gradient.',                        btn: '📐 Find the gradient' },
        { on: 'area',        say: 'Now shade the area under the line. What does it come to?',                      btn: '▦ Shade the area' },
      ] },
    { id: 'steady', icon: '➖', title: 'Steady speed and slowing down',
      ...
      steps: [
        { on: 'setup:ramp',  say: 'Put the trolley and track on the bench.',                                        btn: '🛷 Set up the track' },
        { on: 'height:2',    say: 'Raise one end just 2 cm - enough to cancel friction (a friction-compensated runway).', btn: '▲ Set the track to 2 cm' },
        { on: 'start:push',  say: 'This time you will give the trolley a gentle push.',                            btn: '👋 Choose “Pushed”' },
        { on: 'run',         say: 'Push it and watch the line.',                                                   btn: '▶ Push the trolley' },
        { on: 'height:0',    say: 'Now lay the track flat.',                                                       btn: '▼ Lower the track to flat' },
        { on: 'run',         say: 'Push it again with the same push. Is the line still level?',                    btn: '▶ Push the trolley' },
      ] },
    { id: 'walk', icon: '🧭', title: 'Distance or displacement?',
      ...
      steps: [
        { on: 'setup:walk',     say: 'Go out onto the school field with a tape measure and a compass.',            btn: '🚶 Go to the field' },
        { on: 'disp:straight',  say: 'Displacement is measured in a straight line from start to finish.',           btn: '📏 Straight line, start to finish' },
        { on: 'route:back',     say: 'Choose the route “There and back”: 40 m east, then 40 m back.',               btn: '↔️ Choose There and back' },
        { on: 'walk',           say: 'Jog the route. Watch the distance and the displacement.',                      btn: '🚶 Jog the route' },
        { on: 'route:corner',   say: 'Now choose “Round the corner”: 30 m north, then 40 m east.',                  btn: '↱ Choose Round the corner' },
        { on: 'walk',           say: 'Jog it. Which is bigger this time?',                                           btn: '🚶 Jog the route' },
      ] },
  ];
