...
const LabMaterialsData = (() => {
  ...
  const GUIDES = [
    G('magnet', '🧲', 'Magnet test', 'Which things does a magnet pull?',
      ...
      [{ on: 'station:magnet', say: 'Tap the 🧲 Magnet in the tool bar on the left!' },
       { on: 'test:nail',      say: 'Now tap the iron nail in the tray below.' },
       { on: 'test:pin',       say: 'Tap the steel pin — is it attracted too?' },
       { on: 'test:foil',      say: 'Foil is a metal. Tap it — will the magnet pull it?' },
       { on: 'test:wood',      say: 'Last one: tap the wooden block.' }]),
    G('torch', '🔦', 'Torch test', 'Does light go through it?',
      ...
      [{ on: 'station:torch', say: 'Tap 🔦 Torch in the tool bar on the left.' },
       { on: 'lights:off',    say: 'Tap the lights switch to turn the room lights off.' },
       { on: 'test:glass',    say: 'Now tap the glass tile in the tray.' },
       { on: 'test:frosted',  say: 'Tap the frosted glass — does light still go through?' },
       { on: 'test:wood',     say: 'Tap the wooden block — can light go through wood?' }]),
    G('bulb', '💡', 'Bulb test', 'Which things let electricity through?',
      ...
      [{ on: 'station:circuit', say: 'Tap 💡 Bulb tester in the tool bar on the left.' },
       { on: 'test:copper',     say: 'Tap the copper wire — does the bulb light up?' },
       { on: 'test:bottle',     say: 'Tap the plastic bottle — what happens now?' },
       { on: 'test:lead',       say: 'Tap the pencil lead — pencil is not a metal, but try it!' }]),
    G('water', '💧', 'Water tests', 'Does it float? Does it soak up water?',
      ...
      [{ on: 'station:bowl', say: 'Tap 💧 Bowl of water in the tool bar.' },
       { on: 'test:cork',    say: 'Tap the cork — will it float or sink?' },
       { on: 'test:stone',   say: 'Tap the stone — heavier than cork!' },
       { on: 'station:drop', say: 'Now tap 🌧️ Water drop in the tool bar.' },
       { on: 'test:sponge',  say: 'Tap the sponge — does the drop soak in?' },
       { on: 'test:ball',    say: 'Tap the rubber ball — does water soak in or stay on top?' }]),
    G('bend', '🤏', 'Bend test', 'Which things bend?',
      ...
      [{ on: 'station:bend', say: 'Tap 🤏 Bend test in the tool bar.' },
       { on: 'test:towel',   say: 'Tap the cotton towel — does it bend?' },
       { on: 'test:copper',  say: 'Tap the copper wire — flexible or rigid?' },
       { on: 'test:stone',   say: 'Tap the stone — can you bend it?' }]),
    G('origin', '🌳', 'Nature or factory?', 'Natural or man-made?',
      ...
      [{ on: 'station:origin', say: 'Tap 🌳 Where from? in the tool bar.' },
       { on: 'test:wood',      say: 'Tap the wooden block — where does wood come from?' },
       { on: 'test:towel',     say: 'Tap the cotton towel — is cotton natural or man-made?' },
