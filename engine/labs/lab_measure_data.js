...
const LabMeasureData = (() => {
  ...
  const READ4 = { on: 'read', say: 'Now read the scale. Type the number, pick the unit and tap Check.', btn: '✏️ Show me the reading' };
  const READ78 = { on: 'read', say: 'Now read it. Type the number, pick the unit and tap Check.', btn: '✏️ Show me the reading' };
  const GUIDES = [
    ...
    { id: 'g4_ruler', grades: [4], icon: '📏', title: 'Measure with a ruler',
      ...
      steps: [
        { on: 'inst:ruler30', say: 'Pick the ruler.', btn: '📏 Pick the ruler' },
        { on: 'spec:pencil4', say: 'Choose the pencil to measure.', btn: '✏️ Measure the pencil' },
        { on: 'align:zero',   say: 'Move the pencil so its end is on the 0 mark.', btn: '📍 Start at 0' },
        READ4,
      ] },
    { id: 'g4_jug', grades: [4], icon: '🫗', title: 'Read a measuring jug',
      ...
      steps: [
        { on: 'inst:jug',         say: 'Pick the measuring jug.', btn: '🫗 Pick the jug' },
        { on: 'spec:juice4',      say: 'Choose the orange juice.', btn: '🧃 Measure the juice' },
        { on: 'eye:above',        say: 'Stand up tall. Your eye is now ABOVE the juice.', btn: '👁️ Eye above' },
        { on: 'misread:apparent', say: 'Read the mark where the dashed line meets the scale.', btn: '✏️ Read it from up here' },
        { on: 'eye:level',        say: 'Now bend down. Get your eye level with the juice.', btn: '👁️ Eye level' },
        READ4,
      ] },
    { id: 'g4_thermo', grades: [4], icon: '🌡️', title: 'Read a thermometer',
      ...
      steps: [
        { on: 'inst:thermo4', say: 'Pick the thermometer.', btn: '🌡️ Pick the thermometer' },
        { on: 'spec:tap4',    say: 'Put it in the tap water.', btn: '🚰 Tap water' },
        { on: 'zoom',         say: 'Zoom in on the red line.', btn: '🔍 Zoom in' },
        { on: 'zoom',         say: 'Closer. Each small mark is 2 °C.', btn: '🔍 Zoom in' },
        READ4,
      ] },
    { id: 'g4_scale', grades: [4], icon: '⚖️', title: 'Weigh a mango',
      ...
      steps: [
        { on: 'inst:scale4', say: 'Pick the kitchen scale.', btn: '⚖️ Pick the scale' },
        { on: 'tare',        say: 'Look: the pointer is not on 0. Turn the knob to set it to 0.', btn: '0️⃣ Set to 0' },
        { on: 'spec:mango4', say: 'Now put the mango on the scale.', btn: '🥭 Weigh the mango' },
        { on: 'zoom',        say: 'Zoom in on the pointer.', btn: '🔍 Zoom in' },
        READ4,
      ] },
    { id: 'g4_fair', grades: [4], icon: '🔁', title: 'Measure three times',
      ...
      steps: [
        { on: 'inst:watch4', say: 'Pick the stopwatch.', btn: '⏱️ Pick the stopwatch' },
        { on: 'spec:ball4',  say: 'Choose the ball on the slope.', btn: '⚽ Time the ball' },
        { on: 'start',       say: 'Press Start. The ball rolls. The stopwatch stops at the bottom.', btn: '▶️ Start timing' },
        READ4,
        { on: 'start',       say: 'Time it again. Press Start.', btn: '▶️ Time it again' },
        READ4,
        { on: 'start',       say: 'One more time. Press Start.', btn: '▶️ Time it again' },
        READ4,
      ] },
    ...
    { id: 'g7_cyl', grades: [7], icon: '🧪', title: 'Read a measuring cylinder',
      ...
      steps: [
        { on: 'inst:cyl78',   say: 'Pick the measuring cylinder.', btn: '🧪 Pick the cylinder' },
        { on: 'spec:water78', say: 'Choose the water in it.', btn: '💧 Measure the water' },
        { on: 'zoom',         say: 'Zoom in on the water level.', btn: '🔍 Zoom in' },
        { on: 'zoom',         say: 'Closer. See how the surface curves? That is the meniscus.', btn: '🔍 Zoom in' },
        READ78,
      ] },
    { id: 'g7_displace', grades: [7], icon: '🪨', title: 'Volume of a stone',
      ...
      steps: [
        { on: 'inst:cyl78',    say: 'Pick the measuring cylinder. It holds 50 cm³ of water.', btn: '🧪 Pick the cylinder' },
        { on: 'spec:stone78',  say: 'Lower the stone in gently on a thread.', btn: '🪨 Lower the stone in' },
        { on: 'misread:level', say: 'Try the easy mistake first: write down the new level as the volume.', btn: '✏️ Write down the new level' },
        { on: 'read',          say: 'Now take away the first reading. Type the stone’s volume and its unit.', btn: '✏️ Show me the volume' },
      ] },
    { id: 'g7_bubble', grades: [7], icon: '🫧', title: 'Beat the air bubble',
      ...
      steps: [
        { on: 'inst:cyl78',     say: 'Pick the measuring cylinder. It holds 40 cm³ of water.', btn: '🧪 Pick the cylinder' },
        { on: 'spec:bubble78',  say: 'Lower the rough stone in. Look: an air bubble is stuck to it.', btn: '🫧 Lower the rough stone in' },
        { on: 'misread:bubble', say: 'Work out the volume with the bubble still there.', btn: '✏️ Read it with the bubble' },
        { on: 'tap',            say: 'Tap the glass to free the bubble.', btn: '👆 Tap the glass' },
        READ78,
      ] },
    { id: 'g7_block', grades: [7], icon: '🧱', title: 'Volume of a block',
      ...
      steps: [
        { on: 'inst:block7', say: 'Pick the ruler and block.', btn: '🧱 Pick the ruler and block' },
        { on: 'spec:box7',   say: 'Choose the wooden block. Its sides have been measured for you.', btn: '🧱 The wooden block' },
        { on: 'read',        say: 'Multiply the three sides. Type the volume and pick its unit.', btn: '✏️ Show me the volume' },
      ] },
    { id: 'g7_balance', grades: [7], icon: '⚖️', title: 'Weigh a stone',
      ...
      steps: [
        { on: 'inst:bal78',   say: 'Pick the electronic balance. Look at the empty pan.', btn: '⚖️ Pick the balance' },
        { on: 'tare',         say: 'It reads 2.4 g with nothing on it. Press Zero.', btn: '0️⃣ Zero the balance' },
        { on: 'spec:stone78', say: 'Put the stone on the pan.', btn: '🪨 Weigh the stone' },
        READ78,
      ] },
    ...
    { id: 'g8_block', grades: [8], icon: '⬜', title: 'Density of a metal block',
      ...
      steps: [
        { on: 'inst:dens8',   say: 'Pick the density bench.', btn: '🧮 Pick the density bench' },
        { on: 'spec:alu8',    say: 'Choose the aluminium block.', btn: '⬜ Aluminium block' },
        { on: 'misread:flip', say: 'Try the upside-down slip first: volume ÷ mass.', btn: '✏️ Divide volume by mass' },
        { on: 'read',         say: 'Now mass ÷ volume. Type the density and pick g/cm³.', btn: '✏️ Show me the density' },
      ] },
    { id: 'g8_stone', grades: [8], icon: '🪨', title: 'The whole method: a stone',
      ...
      steps: [
        { on: 'inst:bal78',   say: 'Pick the electronic balance.', btn: '⚖️ Pick the balance' },
        { on: 'tare',         say: 'Zero it with the pan empty.', btn: '0️⃣ Zero the balance' },
        { on: 'spec:stone78', say: 'Put the stone on the pan.', btn: '🪨 Weigh the stone' },
        { on: 'read',         say: 'Read its mass, in grams.', btn: '✏️ Show me the mass' },
        { on: 'inst:cyl78',   say: 'Now pick the measuring cylinder.', btn: '🧪 Pick the cylinder' },
        { on: 'spec:stone78', say: 'Lower the same stone gently into 50 cm³ of water.', btn: '🪨 Lower the stone in' },
        { on: 'read',         say: 'Its volume is the final reading − the first reading.', btn: '✏️ Show me the volume' },
        { on: 'inst:dens8',   say: 'Now the density bench.', btn: '🧮 Pick the density bench' },
        { on: 'spec:stone8',  say: 'Choose the same stone.', btn: '🪨 The stone' },
        { on: 'read',         say: 'Density = mass ÷ volume. Type it and pick g/cm³.', btn: '✏️ Show me the density' },
      ] },
    { id: 'g8_float', grades: [8], icon: '🛟', title: 'Float or sink?',
      ...
      steps: [
        { on: 'inst:dens8',  say: 'Pick the density bench.', btn: '🧮 Pick the density bench' },
        { on: 'spec:cork8',  say: 'Choose the cork block.', btn: '🍾 Cork block' },
        { on: 'read',        say: 'Work out its density. Will it float?', btn: '✏️ Show me the density' },
        { on: 'spec:steel8', say: 'Now the steel block.', btn: '🔩 Steel block' },
        { on: 'read',        say: 'Work out its density. Float or sink?', btn: '✏️ Show me the density' },
      ] },
    { id: 'g8_liquid', grades: [8], icon: '🫒', title: 'Density of a liquid',
      ...
      steps: [
        { on: 'inst:dens8',    say: 'Pick the density bench.', btn: '🧮 Pick the density bench' },
        { on: 'spec:oil8',     say: 'Choose the cooking oil.', btn: '🫒 Cooking oil' },
        { on: 'misread:total', say: 'Try the slip first: use the full reading as the mass.', btn: '✏️ Use the full reading' },
        { on: 'read',          say: 'Now take off the empty cylinder, then divide by the volume.', btn: '✏️ Show me the density' },
      ] },
  ];
