...
const LabMicroscopeData = (() => {
  ...
  const GUIDES = [
    ...
    { id: 'g7_onion', grades: [7], icon: '🧅', title: 'Onion skin cells',
      ...
      steps: [
        { on: 'rig:scope', say: 'Go to the microscope.', btn: '🔬 Microscope' },
        { on: 'slide:onion', say: 'Peel a thin layer of skin (the epidermis) from inside an onion with forceps. Lay it flat in a drop of water on a clean slide.', btn: '🧅 Onion skin' },
        { on: 'stain:iodine', say: 'Add ONE drop of iodine solution. Iodine is a stain: it colours parts of the cell so you can see them.', btn: '💧 One drop of iodine' },
        { on: 'cover:angle', say: 'Touch one edge of a cover slip (a thin square of glass) to the slide, then lower it slowly, at an angle. This pushes the air out.', btn: '🔲 Cover slip at an angle' },
        { on: 'clips', say: 'The slide is on the stage. Hold it still with the two stage clips.', btn: '📎 Clip the slide' },
        { on: 'light:lamp', say: 'Switch on the lamp in the base.', btn: '💡 Lamp on' },
        { on: 'obj:4', say: 'Turn the nosepiece to the LOW-power objective, ×4. Always start here.', btn: '🔍 ×4 objective' },
        { on: 'lower', say: 'Watching from the SIDE, lower the lens until it is just above the slide.', btn: '⬇️ Lower it, watching from the side' },
        { on: 'focus:near', say: 'Now look through the eyepiece. Turn the COARSE focus so the lens moves UP, away from the slide, until the cells appear.', btn: '⤴️ Coarse focus up' },
        { on: 'focus:sharp', say: 'Turn the FINE focus a little at a time until the cells are sharp.', btn: '🎯 Fine focus' },
        { on: 'obj:40', say: 'Now swing in the HIGH-power objective, ×40.', btn: '🔬 ×40 objective' },
        { on: 'focus:sharp', say: 'Use ONLY the fine focus now, a little at a time.', btn: '🎯 Fine focus' },
        { on: 'part:nucleus', say: 'The pointer is on a dark, round spot. Name this part of the cell.', btn: '🟤 Nucleus' },
      ] },
    { id: 'g7_cheek', grades: [7], icon: '👄', title: 'Your own cheek cells',
      ...
      steps: [
        { on: 'rig:scope', say: 'Go to the microscope.', btn: '🔬 Microscope' },
        { on: 'slide:cheek', say: 'Gently scrape the inside of your OWN cheek with a clean cotton bud, and smear it in a drop of water on a slide. Put the used bud straight into the disinfectant.', btn: '👄 My cheek cells' },
        { on: 'stain:blue', say: 'Add ONE drop of methylene blue, a blue stain.', btn: '💧 One drop of methylene blue' },
        { on: 'cover:angle', say: 'Lower a cover slip slowly, one edge first, at an angle.', btn: '🔲 Cover slip at an angle' },
        { on: 'clips', say: 'Hold the slide still with the stage clips.', btn: '📎 Clip the slide' },
        { on: 'light:lamp', say: 'Switch on the lamp.', btn: '💡 Lamp on' },
        { on: 'obj:4', say: 'Low power first: the ×4 objective.', btn: '🔍 ×4 objective' },
        { on: 'lower', say: 'Watching from the side, lower the lens to just above the slide.', btn: '⬇️ Lower it, watching from the side' },
        { on: 'focus:near', say: 'Looking through the eyepiece, coarse focus UP until the cells appear.', btn: '⤴️ Coarse focus up' },
        ...
        { on: 'obj:40', say: 'Swing in the ×40 objective.', btn: '🔬 ×40 objective' },
        { on: 'focus:sharp', say: 'Fine focus only.', btn: '🎯 Fine focus' },
        { on: 'part:nucleus', say: 'A dark blue spot inside the cell. Name it.', btn: '🟤 Nucleus' },
        { on: 'move:left', say: 'Move the slide to the LEFT.', btn: '◀ Move the slide left' },
        { on: 'move:left', say: 'And once more - to the very edge of the cell.', btn: '◀ Move the slide left' },
        { on: 'part:membrane', say: 'A very thin line around the cell. Name it.', btn: '⭕ Cell membrane' },
        { on: 'kind:animal', say: 'No wall, no big vacuole, no green discs. Plant or animal?', btn: '👄 Animal cell' },
      ] },
    { id: 'g7_leaf', grades: [7], icon: '🌿', title: 'Green leaf cells',
      ...
      steps: [
        { on: 'rig:scope', say: 'Go to the microscope.', btn: '🔬 Microscope' },
        { on: 'slide:leaf', say: 'Lay one small pondweed leaf flat in a drop of water on a slide. It is very thin, so light can pass through it.', btn: '🌿 Pondweed leaf' },
        { on: 'cover:angle', say: 'No stain needed. Lower a cover slip slowly, at an angle.', btn: '🔲 Cover slip at an angle' },
        { on: 'clips', say: 'Hold the slide still with the stage clips.', btn: '📎 Clip the slide' },
        { on: 'light:lamp', say: 'Switch on the lamp.', btn: '💡 Lamp on' },
        { on: 'obj:4', say: 'Low power first: the ×4 objective.', btn: '🔍 ×4 objective' },
        { on: 'lower', say: 'Watching from the side, lower the lens to just above the slide.', btn: '⬇️ Lower it, watching from the side' },
        ...
        { on: 'obj:40', say: 'Swing in the ×40 objective.', btn: '🔬 ×40 objective' },
        { on: 'focus:sharp', say: 'Fine focus only.', btn: '🎯 Fine focus' },
        { on: 'part:chloroplast', say: 'The pointer is on a small green disc. Name it.', btn: '🟢 Chloroplast' },
        { on: 'move:left', say: 'Move the slide to the LEFT, onto the edge of the cell.', btn: '◀ Move the slide left' },
        { on: 'part:wall', say: 'A firm line around the box-shaped cell. Name it.', btn: '🧱 Cell wall' },
        { on: 'kind:plant', say: 'A wall and chloroplasts. Plant or animal?', btn: '🌿 Plant cell' },
      ] },
  ];
