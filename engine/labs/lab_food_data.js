...
const LabFoodData = (() => {
  ...
  const GUIDES = [
    { id: 'starch', icon: '🌽', title: 'Test for starch', grades: D8,
      ...
      steps: [
        { on: 'slot:1',         say: 'Choose tube 1 in the rack.',                                           btn: 'Choose tube 1' },
        { on: 'food:cornflour', say: 'Put a little cornflour in tube 1 - a small sample is enough.',          btn: '🌽 Add cornflour' },
        { on: 'test:iodine',    say: 'Add a few drops of orange-brown iodine solution.',                     btn: '🟠 Add iodine solution' },
        { on: 'read',           say: 'Look at tube 1 and read the colour.',                                  btn: '🔎 Read the result' },
        { on: 'rinse',          say: 'Rinse the spatula before the next sample.',                            btn: '🧽 Rinse the spatula' },
        { on: 'slot:2',         say: 'Now choose tube 2 for the control.',                                    btn: 'Choose tube 2' },
        { on: 'food:water',     say: 'Put water in tube 2. This is the control: it has no nutrients.',       btn: '💧 Add water' },
        { on: 'test:iodine',    say: 'Add iodine solution to the control too.',                              btn: '🟠 Add iodine solution' },
        { on: 'read',           say: 'Read tube 2 and compare it with tube 1.',                              btn: '🔎 Read the result' },
      ] },
    { id: 'sugar', icon: '🧱', title: 'Test for sugar', grades: D8,
      ...
      steps: [
        { on: 'goggles',         say: 'This test uses heat. Put on your goggles first.',                     btn: '🥽 Put on goggles' },
        { on: 'slot:1',          say: 'Choose tube 1 in the rack.',                                          btn: 'Choose tube 1' },
        { on: 'food:glucose',    say: 'Add some glucose solution to tube 1.',                                btn: '🍯 Add glucose' },
        { on: 'test:benedicts',  say: 'Add blue Benedict’s solution.',                                       btn: '🔵 Add Benedict’s' },
        { on: 'bath',            say: 'Stand the tube in the hot water bath. Never heat it in the flame.',  btn: '🛁 Into the water bath' },
        { on: 'heated',          say: 'Watch the colour change as it heats…' },
        { on: 'read',            say: 'The colour has stopped changing. Read it.',                           btn: '🔎 Read the result' },
        { on: 'burner-off',      say: 'Finished with heat: turn the Bunsen burner off.',                     btn: '🧯 Turn the burner off' },
      ] },
    { id: 'protein', icon: '🟣', title: 'Test for protein', grades: D8,
      ...
      steps: [
        { on: 'goggles',       say: 'Biuret solution is corrosive. Put on your goggles.',                    btn: '🥽 Put on goggles' },
        { on: 'slot:1',        say: 'Choose tube 1 in the rack.',                                            btn: 'Choose tube 1' },
        { on: 'food:gelatine', say: 'Add some gelatine solution to tube 1.',                                 btn: '🍮 Add gelatine' },
        { on: 'test:biuret',   say: 'Add blue Biuret solution.',                                             btn: '🔷 Add Biuret' },
        { on: 'developed',     say: 'Wait a few minutes for the colour to come through…' },
        { on: 'read',          say: 'Now read the colour.',                                                  btn: '🔎 Read the result' },
      ] },
    { id: 'fat', icon: '🧈', title: 'Test for fat: the grease spot', grades: D8,
      ...
      steps: [
        { on: 'slot:1',     say: 'Choose place 1.',                                                         btn: 'Choose place 1' },
        { on: 'food:oil',   say: 'Take a drop of cooking oil.',                                             btn: '🫒 Add oil' },
        { on: 'test:paper', say: 'Rub it onto a piece of filter paper.',                                    btn: '📄 Rub on filter paper' },
        { on: 'dry',        say: 'Leave the paper to dry…' },
        { on: 'read',       say: 'Hold the paper up to the light and read it.',                             btn: '🔎 Read the result' },
        { on: 'rinse',      say: 'Rinse the spatula before the next sample.',                               btn: '🧽 Rinse the spatula' },
        { on: 'slot:2',     say: 'Choose place 2 for the control.',                                         btn: 'Choose place 2' },
        { on: 'food:water', say: 'Take a drop of water - the control.',                                     btn: '💧 Add water' },
        { on: 'test:paper', say: 'Rub it onto filter paper too.',                                           btn: '📄 Rub on filter paper' },
        { on: 'dry',        say: 'Leave it to dry…' },
        { on: 'read',       say: 'Hold it up to the light. Compare the two spots.',                         btn: '🔎 Read the result' },
      ] },
    { id: 'emulsion', icon: '☁️', title: 'Test for fat: the ethanol test', grades: D8,
      ...
      steps: [
        { on: 'goggles',      say: 'Put on your goggles.',                                                  btn: '🥽 Put on goggles' },
        { on: 'burner-off',   say: 'Ethanol is flammable. Turn the Bunsen burner off first.',               btn: '🧯 Turn the burner off' },
        { on: 'slot:1',       say: 'Choose tube 1 in the rack.',                                            btn: 'Choose tube 1' },
        { on: 'food:oil',     say: 'Add a few drops of cooking oil.',                                       btn: '🫒 Add oil' },
        { on: 'test:ethanol', say: 'Shake it with ethanol, then pour the ethanol into water.',              btn: '🍶 Do the ethanol test' },
        { on: 'read',         say: 'Look at the water. Read the result.',                                   btn: '🔎 Read the result' },
      ] },
  ];
