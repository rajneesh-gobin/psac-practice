...
const LabRustingData = (() => {
  ...
  const GUIDES = [
    { id: 'three_tubes', icon: '🧪', title: 'The three test tubes', grades: [6],
      ...
      steps: [
        { on: 'rig:tubes', say: 'Go to the test-tube rack.', btn: '🧪 Test tubes' },
        { on: 'adult:on', say: 'Boiling water is hot. Ask an adult to help you.', btn: '🧑 Ask an adult to help' },
        { on: 'tube:A', say: 'Tap tube A.', btn: 'Tube A' },
        { on: 'water:boiled', say: 'Fill tube A with boiled water. Boiling drives the air out.', btn: '♨️ Boiled water' },
        { on: 'oil:on', say: 'Pour a thin layer of oil on top. Oil keeps air out.', btn: '🛢️ Add an oil layer' },
        { on: 'tube:B', say: 'Now tap tube B.', btn: 'Tube B' },
        { on: 'water:tap', say: 'Fill tube B with tap water. Air can reach this nail.', btn: '💧 Tap water' },
        { on: 'tube:C', say: 'Now tap tube C.', btn: 'Tube C' },
        { on: 'dryer:on', say: 'Add a drying agent. It soaks up water from the air.', btn: '🧂 Add a drying agent' },
        { on: 'cork:on', say: 'Close tube C with a cork. The air inside stays dry.', btn: '🍾 Put the cork in' },
        { on: 'week', say: 'Wait 7 days. Watch the three nails.', btn: '⏩ Wait 7 days' },
      ] },
    { id: 'salt', icon: '🌊', title: 'Salt water and rust', grades: [6],
      ...
      steps: [
        { on: 'rig:tubes', say: 'Go to the test-tube rack.', btn: '🧪 Test tubes' },
        { on: 'tube:B', say: 'Tap tube B.', btn: 'Tube B' },
        { on: 'water:tap', say: 'Fill tube B with tap water.', btn: '💧 Tap water' },
        { on: 'tube:D', say: 'Now tap tube D.', btn: 'Tube D' },
        { on: 'water:salt', say: 'Fill tube D with salt water.', btn: '🧂 Salt water' },
        { on: 'wait', say: 'Wait one day. Which nail has more rust?', btn: '🌙 Wait 1 day' },
        { on: 'wait', say: 'Wait one more day. Compare the two nails.', btn: '🌙 Wait 1 day' },
      ] },
    { id: 'stop', icon: '🛡️', title: 'Stop the rust!', grades: [6],
      ...
      steps: [
        { on: 'rig:coats', say: 'Go to the five jars. Each nail sits half in water, half in air.', btn: '🛡️ The five jars' },
        { on: 'jar:2', say: 'Jar 1 stays bare. Tap jar 2.', btn: 'Jar 2' },
        { on: 'coat:paint', say: 'Paint the nail in jar 2.', btn: '🎨 Paint' },
        { on: 'jar:3', say: 'Tap jar 3.', btn: 'Jar 3' },
        { on: 'coat:grease', say: 'Cover the nail in jar 3 with grease.', btn: '🚲 Grease' },
        { on: 'jar:4', say: 'Tap jar 4.', btn: 'Jar 4' },
        { on: 'coat:plastic', say: 'Coat the nail in jar 4 with plastic.', btn: '🧴 Plastic coat' },
        { on: 'jar:5', say: 'Tap jar 5.', btn: 'Jar 5' },
        { on: 'coat:zinc', say: 'Use a galvanised nail in jar 5. It is coated with zinc.', btn: '🏠 Zinc (galvanised)' },
        { on: 'week', say: 'Wait 7 days. Which nails rust?', btn: '⏩ Wait 7 days' },
      ] },
    { id: 'scratch', icon: '🩹', title: 'A scratch in the paint', grades: [6],
      ...
      steps: [
        { on: 'rig:coats', say: 'Go to the five jars.', btn: '🛡️ The five jars' },
        { on: 'jar:2', say: 'Tap jar 2.', btn: 'Jar 2' },
        { on: 'coat:paint', say: 'Paint the nail in jar 2.', btn: '🎨 Paint' },
        { on: 'jar:3', say: 'Tap jar 3.', btn: 'Jar 3' },
        { on: 'coat:scratched', say: 'Paint this nail too, then scratch the paint.', btn: '🩹 Paint, then scratch' },
        { on: 'week', say: 'Wait 7 days. Look closely at jar 3.', btn: '⏩ Wait 7 days' },
      ] },
  ];
