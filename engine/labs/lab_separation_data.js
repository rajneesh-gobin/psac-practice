...
const LabSeparationData = (() => {
  ...
  GUIDES.push(
    { id: 'g8_filter', grades: [8], icon: '🧻', title: 'Filter muddy water',
      ...
      steps: [
        { on: 'mode:filter',          say: 'Open the filtration bench: a filter funnel on a stand.',                               btn: '🧻 Filtration bench' },
        { on: 'part:fmix:muddy',      say: 'Take a beaker of muddy water - soil stirred into water.',                             btn: '🥤 Muddy water' },
        { on: 'part:paper:cone',      say: 'Fold a filter paper in half, then in half again, and open it into a cone in the funnel.', btn: '🧻 Folded into a cone' },
        { on: 'part:fbeaker:sound',   say: 'Put a clean beaker under the funnel to catch the filtrate.',                          btn: '🫙 A clean beaker' },
        { on: 'part:pouring:rod',     say: 'Pour slowly down a glass rod, so the liquid stays below the top of the paper.',       btn: '🥢 Slowly, down a glass rod' },
        { on: 'pour',                 say: 'Now pour.',                                                                            btn: '🫗 Pour' },
    ...
    { id: 'g8_salt', grades: [8], icon: '💠', title: 'Salt from salt water',
      ...
      steps: [
        { on: 'mode:evap',        say: 'Open the evaporation bench: an evaporating basin on a tripod and gauze.',      btn: '♨️ Evaporation bench' },
        { on: 'part:emix:salt',   say: 'Pour salt water into the basin - 5 g of salt dissolved in 50 cm³ of water.',  btn: '🥣 Salt water' },
        { on: 'goggles',          say: 'Goggles on - a heated basin can spit.',                                        btn: '🥽 Put on goggles' },
        { on: 'heat',             say: 'Heat the basin to evaporate the water.',                                       btn: '🔥 Start heating' },
        { on: 'wait:edge',        say: 'Watch the edge of the liquid. Stop as soon as the first crystals appear…' },
        { on: 'heat-off',         say: 'Crystals at the edge! Turn the heat off now - do not heat it dry.',          btn: '🧯 Turn off the heat' },
        { on: 'leave',            say: 'Leave the basin somewhere warm so the rest of the water evaporates slowly.',  btn: '🪟 Leave it to dry' },
    ...
    { id: 'g8_ink', grades: [8], icon: '🌈', title: 'Separate the dyes in ink',
      ...
      steps: [
        { on: 'mode:chroma',       say: 'Open the chromatography bench: a strip of paper hanging in a beaker.', btn: '🌈 Chromatography bench' },
        { on: 'part:ink:green',    say: 'Put a small spot of green ink on the paper.',                          btn: '🖊️ Green ink' },
        { on: 'part:line:pencil',  say: 'The spot sits on a start line drawn in PENCIL.',                       btn: '✏️ Drawn in pencil' },
        { on: 'part:level:low',    say: 'Pour water into the beaker - its level must be BELOW the start line.', btn: '💧 Below the start line' },
        { on: 'run',               say: 'Lower the paper so its bottom edge dips into the water.',              btn: '💧 Stand it in the water' },
    ...
    { id: 'g8_which', grades: [8], icon: '🤔', title: 'Which technique?',
      ...
      steps: [
        { on: 'mode:choose',          say: 'Open the technique chooser.',                                              btn: '🤔 Which technique?' },
        { on: 'choose:iron_sulphur',  say: 'Iron filings and sulphur - you want the iron. Iron is magnetic. Which technique?', btn: '🧲 Magnetic separation - iron is magnetic' },
        { on: 'choose:muddy_water',   say: 'Muddy water - you want clear water. Mud does not dissolve. Which technique?',     btn: '🧻 Filtration - mud is insoluble' },
      ] },
    ...
    { id: 'g7_dissolve', grades: [7], icon: '🧂', title: 'Dissolve salt and weigh it',
      ...
      steps: [
        { on: 'mode:dissolve',       say: 'Open the dissolving bench: a beaker of water on a balance.',   btn: '🥄 Dissolving bench' },
        { on: 'part:solid:salt',     say: 'Weigh out 5 g of salt on a weighing boat.',                   btn: '🥄 5 g of salt' },
        { on: 'part:dbeaker:sound',  say: 'Put a beaker with 100 g of water on the balance.',           btn: '🫙 A beaker of water' },
        { on: 'add',                 say: 'Tip the salt into the water. Look at the balance.',          btn: '🥄 Tip it in' },
        { on: 'stir',                say: 'Stir with a glass rod.',                                     btn: '🥢 Stir' },
    ...
    { id: 'g7_back', grades: [7], icon: '💠', title: 'Get the salt back',
      ...
      steps: [
        { on: 'mode:evap',        say: 'Open the evaporation bench: an evaporating basin on a tripod and gauze.', btn: '♨️ Evaporation bench' },
        { on: 'part:emix:salt',   say: 'Pour salt water into the basin.',                                         btn: '🥣 Salt water' },
        { on: 'goggles',          say: 'Goggles on - a heated basin can spit.',                                   btn: '🥽 Put on goggles' },
        { on: 'heat',             say: 'Heat the basin.',                                                         btn: '🔥 Start heating' },
        { on: 'wait:edge',        say: 'Watch the edge of the liquid for the first crystals…' },
        { on: 'heat-off',         say: 'Crystals! Turn the heat off now.',                                        btn: '🧯 Turn off the heat' },
        { on: 'leave',            say: 'Leave it somewhere warm to finish drying.',                               btn: '🪟 Leave it to dry' },
    ...
    { id: 'g7_water', grades: [7], icon: '💧', title: 'Get the water back too',
      ...
      steps: [
        { on: 'mode:distil',    say: 'Open the distillation bench.',                                                 btn: '⚗️ Distillation bench' },
        { on: 'build:correct',  say: 'Your teacher has set up a distillation rig with a flask of sea water.',        btn: '🔧 Set up the rig' },
        { on: 'goggles',        say: 'Goggles on before heating.',                                                   btn: '🥽 Put on goggles' },
        { on: 'heat',           say: 'Heat the flask.',                                                              btn: '🔥 Start heating' },
    ...
    { id: 'g7_kinds', grades: [7], icon: '🔹', title: 'Element, compound or mixture?',
      ...
      steps: [
        { on: 'mode:choose',   say: 'Open the sorting bench.',                                                       btn: '🔹 Element or mixture?' },
        { on: 'choose:iron',   say: 'Iron - symbol Fe. It has only iron atoms. What is it?',                         btn: '🔹 Element - one kind of atom' },
        { on: 'choose:air',    say: 'Air - nitrogen, oxygen and other gases, not joined together. What is it?',      btn: '🥣 Mixture - not joined' },
      ] },
  );
