...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5fr-nom-001', chapterId:'fr-noms', subsection:'genre', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-002', chapterId:'fr-noms', subsection:'articles_def', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-003', chapterId:'fr-noms', subsection:'pluriel', difficulty:1,
    question:'Quel est le pluriel de "un bateau" ?',
    options:['des bateaux','les bateaus','des bateau','des bateaus'],
    answer:'des bateaux',
  ...
  makeMCQ({ id:'g5fr-nom-004', chapterId:'fr-noms', subsection:'pluriel', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-005', chapterId:'fr-noms', subsection:'genre', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-006', chapterId:'fr-noms', subsection:'articles_def', difficulty:2,
    question:'Complétez : "J\'ai ___ chien et ___ chat."',
    options:['un / un','un / une','une / un','le / la'],
    answer:'un / un',
    hint:'"Chien" et "chat" sont tous les deux masculins → article indéfini "un".',
    explanation:'"J\'ai <b>un</b> chien (masc.) et <b>un</b> chat (masc.)." - Pour la femelle, on dit "une chatte" (chatte = féminin), et là c\'est "une". "Chien" est toujours masculin. Articles indéfinis : <b>un</b> (masc. sing.), <b>une</b> (fém. sing.), <b>des</b> (pluriel).' }),

  makeMCQ({ id:'g5fr-nom-007', chapterId:'fr-noms', subsection:'articles_def', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-008', chapterId:'fr-noms', subsection:'pluriel', difficulty:2,
  ...
  makeTF({ id:'g5fr-nom-009', chapterId:'fr-noms', subsection:'genre', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-010', chapterId:'fr-noms', subsection:'articles_def', difficulty:2,
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5fr-nom-011', chapterId:'fr-noms', subsection:'articles_def', difficulty:1,
    question:'Quel article utilise-t-on avec "eau" (water) ?',
    options:['le','la','l\'','les'],
    answer:'l\'',
    hint:'"Eau" commence par une voyelle → élision.',
    explanation:'"<b>l\'eau</b>" (féminin). "Eau" commence par une voyelle, donc "la" devient "l\'" (élision). "L\'eau est fraîche." Le genre est caché par l\'élision, mais l\'adjectif le montre : l\'eau fraîche (féminin). Autres élisions : l\'arbre (masc), l\'école (fém), l\'ami (masc).' }),

  makeMCQ({ id:'g5fr-nom-012', chapterId:'fr-noms', subsection:'pluriel', difficulty:1,
    question:'Quel est le pluriel irrégulier de "un œil" ?',
    options:['des œils','des yeux','des œillets','des œilles'],
    answer:'des yeux',
  ...
  makeMCQ({ id:'g5fr-nom-013', chapterId:'fr-noms', subsection:'partitifs', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-014', chapterId:'fr-noms', subsection:'articles_def', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-015', chapterId:'fr-noms', subsection:'pluriel', difficulty:2,
  ...
  makeTF({ id:'g5fr-nom-016', chapterId:'fr-noms', subsection:'pluriel', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-017', chapterId:'fr-noms', subsection:'articles_indef', difficulty:3,
  ...
  makeMCQ({ id:'g5fr-nom-018', chapterId:'fr-noms', subsection:'pluriel', difficulty:3,
  ...
  makeMCQ({ id:'g5fr-nom-019', chapterId:'fr-noms', subsection:'articles_def', difficulty:4,
  ...
  makeMCQ({ id:'g5fr-nom-020', chapterId:'fr-noms', subsection:'genre', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-021', chapterId:'fr-noms', subsection:'genre', difficulty:1,
  ...
  makeTF({ id:'g5fr-nom-022', chapterId:'fr-noms', subsection:'genre', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-023', chapterId:'fr-noms', subsection:'articles_indef', difficulty:2,
  ...
  makeTF({ id:'g5fr-nom-026', chapterId:'fr-noms', subsection:'pluriel', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-027', chapterId:'fr-noms', subsection:'articles_indef', difficulty:2,
    question:'Formez un nom à partir de "déplacer" + le suffixe -ment.',
    options:['déplacement','déplaceur','déplacerie','déplaçage'],
    answer:'déplacement',
  ...
  makeMCQ({ id:'g5fr-nom-028', chapterId:'fr-noms', subsection:'genre', difficulty:2,
    question:'Quel est le féminin de "pharmacien" ?',
    options:['pharmacière','pharmacienne','pharmacieure','pharmacien'],
    answer:'pharmacienne',
  ...
  makeMCQ({ id:'g5fr-nom-029', chapterId:'fr-noms', subsection:'genre', difficulty:2,
  ...
  makeTF({ id:'g5fr-nom-030', chapterId:'fr-noms', subsection:'pluriel', difficulty:1,
  ...
  makeMCQ({ id:'g5fr-nom-031', chapterId:'fr-noms', subsection:'articles_indef', difficulty:3,
  ...
  makeMCQ({ id:'g5fr-nom-032', chapterId:'fr-noms', subsection:'pluriel', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-033', chapterId:'fr-noms', subsection:'articles_indef', difficulty:3,
    question:'Formez un adjectif à partir du nom "nuage".',
    options:['nuageux','nuagé','nuagier','nuagal'],
    answer:'nuageux',
    hint:'"Nuage" + suffixe -eux → adjectif.',
    explanation:'"<b>nuageux/nuageuse</b>" - Le suffixe <b>-eux/-euse</b> forme des adjectifs à partir de noms : nuage → nuageux/nuageuse, neige → neigeux/neigeuse, soleil → ensoleillé/ensoleillée (suffixe -é), danger → dangereux/dangereuse.' }),

  makeMCQ({ id:'g5fr-nom-034', chapterId:'fr-noms', subsection:'genre', difficulty:2,
  ...
  makeMCQ({ id:'g5fr-nom-035', chapterId:'fr-noms', subsection:'articles_indef', difficulty:4,
...
// ── Illustrated questions: gendered article practice with a real picture.
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5fr-nom-041', chapterId:'fr-noms', subsection:'genre', difficulty:2,
    ...
    explanation:'"<b>La</b> plage" = the beach. "Plage" est féminin, donc on utilise "la" (ou "une").' })
