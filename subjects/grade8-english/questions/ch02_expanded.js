...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g8eng-listening-008', chapterId:'g8eng-listening', difficulty:2,
    ...
    options:["The talk explained reef formation, the threats they face and how to protect them.","Coral reefs are beautiful and they are found in many warm parts of the world.","The speaker clearly likes coral reefs and wants everyone else to like them too.","Communities living near the coast should do much more to look after the reefs."],
  ...
  makeMCQ({ id:'g8eng-listening-009', chapterId:'g8eng-listening', difficulty:3,
    ...
    options:["\"Many experts believe will cause catastrophic damage\" is opinion.","\"Scientists estimate 2°C by 2100\" is the opinion in this sentence.","Both parts of the sentence are equally factual statements here.","Both parts of the sentence are equally statements of opinion."],
  ...
  makeMCQ({ id:'g8eng-listening-010', chapterId:'g8eng-listening', difficulty:3,
    ...
    options:["The documentary examined the destruction of rainforests and its impact on indigenous peoples, as well as government and charity responses.","The documentary argued that governments around the world are failing to act, and that this is the single most important part of the problem.","The documentary argued mainly that conservation charities need far more money than they receive at present in order to save the rainforests.","The documentary was about charities and trees, and about the people who work for those charities in the rainforests of the world today."],
  ...
  makeMCQ({ id:'g8eng-listening-011', chapterId:'g8eng-listening', difficulty:4,
    ...
    options:["The journalist — they explain a limitation of the statistic.","Both speakers present an equally complete picture of crime.","The politician — a precise 12% figure must be a clear fact.","Neither speaker — crime statistics are never at all reliable."],
  ...
  makeMCQ({ id:'g8eng-speaking-007', chapterId:'g8eng-speaking', difficulty:1,
    ...
    options:["To respond to and challenge the opposing team's arguments.","To thank the judges and the audience for their attention.","To introduce the topic for the first time in the debate.","To summarise your own team's main points at the very end."],
  ...
  makeMCQ({ id:'g8eng-speaking-008', chapterId:'g8eng-speaking', difficulty:2,
    ...
    options:["\"Good evening. It is a pleasure to address parents and teachers this evening.\"","\"Well, I guess I'll just say some stuff about the school and how it goes.\"","\"Yo! Thanks for coming out, you guys. Let's get this over with quickly.\"","\"Hi everyone, so like, I want to talk about something to do with school.\""],
  ...
  makeMCQ({ id:'g8eng-speaking-010', chapterId:'g8eng-speaking', difficulty:4,
    ...
    options:["Yes — clear, simple language is appropriate for younger pupils.","Yes, but only if they also use much more formal vocabulary.","No — they should never use contractions such as \"it's\" here.","No — they should use far more technical language than that."],
  ...
  makeMCQ({ id:'g8eng-reading-010', chapterId:'g8eng-reading', difficulty:3,
    ...
    options:["The village is experiencing a severe drought and the farmers are desperate.","The river is being cleaned out by the villagers during the dry season.","It is simply a beautiful summer day and everyone is enjoying the sun.","The farmers are standing in their fields watching aeroplanes fly past."],
  ...
  makeMCQ({ id:'g8eng-reading-011', chapterId:'g8eng-reading', difficulty:4,
    ...
    options:["Text A will be objective and formal; Text B will be personal and subjective.","Text A will be emotional and personal; Text B will be formal and objective.","Text A will be far funnier and livelier than the diary entry in Text B.","Both texts will have exactly the same tone, since the event is the same."],
  ...
  makeMCQ({ id:'g8eng-writing-009', chapterId:'g8eng-writing', difficulty:3,
    ...
    options:["The student repeats the same point without developing or supporting it.","The student has written far too many paragraphs for a short essay.","The statement is only an opinion and so it must be changed completely.","The student uses the word \"should\" far too often in the paragraphs."],
  ...
  makeMCQ({ id:'g8eng-writing-011', chapterId:'g8eng-writing', difficulty:4,
    ...
    options:["Adding a statistic: \"Studies show that 80% of zoo animals display signs of stress.\"","Repeating the very same point in different words in the following paragraph.","Adding the sentence: \"Everyone already knows that zoos are bad for animals.\"","Adding the line: \"In my opinion, animals are important and deserve freedom.\""],
  ...
  makeMCQ({ id:'g8eng-gr-pronouns-008', chapterId:'g8eng-gr-pronouns', difficulty:2,
    ...
    options:["\"Priya helped her mother with Priya's own project.\"","\"They worked together on the school project.\"","\"She helped her with her own project at home.\"","\"Priya and her mother had a project together.\""],
  ...
  makeMCQ({ id:'g8eng-gr-modals-007', chapterId:'g8eng-gr-modals', difficulty:1,
    ...
    options:["You should definitely see a doctor.","You could probably see a doctor.","You may see a doctor sometime.","You might want to see a doctor."],
  ...
  makeMCQ({ id:'g8eng-gr-modals-008', chapterId:'g8eng-gr-modals', difficulty:2,
    ...
    options:["Strong deduction about a past event","Permission granted in the past","Ability to do it in the past","Obligation placed in the past"],
  ...
  makeMCQ({ id:'g8eng-gr-prepositions-008', chapterId:'g8eng-gr-prepositions', difficulty:2,
    ...
    options:["Adverbial phrase (describing HOW she arrived)","Adjective phrase (describing the person \"she\")","Subject of the sentence (the whole noun group)","Direct object of the verb \"arrived\" here"],
  ...
  makeMCQ({ id:'g8eng-gr-punctuation-008', chapterId:'g8eng-gr-punctuation', difficulty:2,
    ...
    options:["Some words from the original quotation have been left out.","The sentence being quoted is grammatically incomplete here.","The scientist paused for a moment while she was speaking.","The writer is uncertain about the wording of the quotation."],
  ...
  makeMCQ({ id:'g8eng-gr-punctuation-009', chapterId:'g8eng-gr-punctuation', difficulty:3,
    ...
    options:["The answer — as everyone suspected — was wrong.","The — answer, as everyone suspected, was wrong.","She is going to school tomorrow morning — .","She — is — going — to — the — school — today."],
