'use strict';
// Grade 6 Science - Enrichment: Ecosystems & Food Webs
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sci-enr-eco-003', chapterId:'g6sci-enr-ecosystems', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/aerial-view-of-the-amazon-rainforest.jpg" alt="An aerial view of a vast, dense green forest stretching to the horizon" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What type of ecosystem is shown in this aerial photograph?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-eco-006', chapterId:'g6sci-enr-ecosystems', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/pacific-ocean-as-viewed-from-goes-18-on-september-23-2023.jpg" alt="A satellite view of the vast deep blue ocean covering most of what is visible from space" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What type of ecosystem is shown in this satellite image?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-eco-007', chapterId:'g6sci-enr-ecosystems', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/lake-idro-italy-2005-08-16.jpg" alt="A calm, clear blue lake surrounded by green hills and vegetation" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What type of ecosystem is shown in this photograph?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-eco-008', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-enr-eco-009', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:1,
    question:'In a food chain, what is a CONSUMER?',
    options:['An organism that eats other organisms', 'A living thing that breaks down waste', 'A plant that makes its own food', 'A non-living part of a habitat'],
    answer:'An organism that eats other organisms',
    hint:'Producers make their own food. What does everything else in the chain have to do instead?',
  ...
  makeMCQ({ id:'g6sci-enr-eco-010', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:1,
    question:'What is a DECOMPOSER in an ecosystem?',
    options:['It breaks down dead plants and animals', 'A large predator at the top of the web', 'A consumer that eats plants and meat', 'A plant that makes food for others'],
  ...
  makeMCQ({ id:'g6sci-enr-eco-011', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:2,
  ...
  makeMCQ({ id:'g6sci-enr-eco-012', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:2,
    question:'What is the difference between a FOOD CHAIN and a FOOD WEB?',
    options:['A chain is one line; a web links many', 'A chain shows all organisms present', 'A chain is aquatic; a web is on land', 'There is no difference between them'],
    answer:'A chain is one line; a web links many',
  ...
  makeMCQ({ id:'g6sci-enr-eco-013', chapterId:'g6sci-enr-ecosystems', subsection:'habitats', difficulty:2,
    question:'Why is BIODIVERSITY important for an ecosystem?',
    options:['A variety of species keeps it stable', 'Fewer species make it easier to study', 'It only helps humans grow more food', 'Biodiversity does not really matter'],
    answer:'A variety of species keeps it stable',
  ...
  makeMCQ({ id:'g6sci-enr-eco-014', chapterId:'g6sci-enr-ecosystems', subsection:'habitats', difficulty:2,
  ...
  makeMCQ({ id:'g6sci-enr-eco-015', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:2,
  ...
  makeMCQ({ id:'g6sci-enr-eco-016', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:3,
    ...
    options:['Rabbits and mice would both increase', 'Rabbits and mice would both decrease', 'Only the mouse population would rise', 'The grass would grow faster at once'],
    answer:'Rabbits and mice would both increase',
  ...
  makeMCQ({ id:'g6sci-enr-eco-017', chapterId:'g6sci-enr-ecosystems', subsection:'food_webs', difficulty:3,
    question:'If all DECOMPOSERS disappeared from a forest, what would happen?',
    options:['Nutrients would stop returning to the soil', 'The forest would grow faster than before', 'The forest would become much healthier', 'Consumers would take over their role'],
    answer:'Nutrients would stop returning to the soil',
