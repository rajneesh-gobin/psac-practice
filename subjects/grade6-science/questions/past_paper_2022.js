...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sc-pp22-001', chapterId:'g6-animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Incisors are the flat, chisel-shaped teeth at the front of the mouth used to cut food. Canines are the pointed teeth beside them; molars and pre-molars are the flat back teeth used for grinding. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-002', chapterId:'g6-air', subsection:'breathing', difficulty:1,
    ...
    explanation:'Carbon dioxide (CO₂) is used in fire extinguishers because it displaces oxygen around the fire, removing one of the three conditions needed for burning. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-003', chapterId:'g6-animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Bread (energy) + fish (growth) + lettuce (health/vitamins) covers all three food groups. The other options lack one group - B and D have no health food; C has no food for energy. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-004', chapterId:'g6-air', subsection:'wind_pressure', difficulty:2,
    ...
    explanation:'Pressing the suction cup removes air from inside, so air pressure inside drops below the air pressure outside. The greater outside pressure holds the cup firmly against the surface. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-005', chapterId:'g6-solar-system', subsection:'planets', difficulty:1,
    ...
    explanation:'Earth rotates on its own axis once every 24 hours - one half faces the Sun (day) while the other half is in shadow (night). The revolution around the Sun causes seasons, not day and night. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-006', chapterId:'g6-animals', subsection:'life_cycle', difficulty:2,
    ...
    explanation:'Three pairs of legs (6 legs) means Animal Y is an insect - a butterfly. Pigeons and penguins are birds (feathers, 2 legs). Bats are mammals (give birth, no eggs). 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-007', chapterId:'g6-animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Adults have 32 permanent teeth: 8 incisors, 4 canines, 8 pre-molars, and 12 molars (including 4 wisdom teeth). Children have 20 milk teeth. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-008', chapterId:'g6-materials', subsection:'properties', difficulty:2,
    ...
    explanation:'Nylon is a synthetic (man-made) material that does not allow water to pass through - it is impermeable. Cotton, silk, and wool are natural fibres that absorb water. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-009', chapterId:'g6-plants', subsection:'growth', difficulty:1,
    ...
    explanation:'The lotus grows rooted in pond mud with its leaves and flowers on the water surface - it is an aquatic plant. Fern and moss grow on damp land; mugut (lily of the valley) grows on dry land. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-010', chapterId:'g6-plants', subsection:'parts', difficulty:2,
    ...
    explanation:'Part S is the stigma (top of the pistil / female part). Its function is to receive pollen during pollination. The anthers (male part) produce pollen; petals attract insects; leaves manufacture food. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-011', chapterId:'g6-ecosystems', subsection:'habitats', difficulty:1,
    ...
    explanation:'Precipitation is the process of water falling from clouds as rain, hail, or snow. Evaporation is water turning to vapour; condensation is vapour turning to water droplets (forming clouds). 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-012', chapterId:'g6-solar-system', subsection:'day_night', difficulty:1,
    ...
    hint:'A day, a month and a year each match a different movement. Which of these movements takes the longest?',
    explanation:'One complete revolution of the Earth around the Sun takes 365¼ days - one year. Earth\'s rotation on its axis takes 24 hours (day/night). The Moon orbits Earth in about 28 days. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-013', chapterId:'g6-energy', subsection:'sources', difficulty:1,
    ...
    explanation:'Solar panels use light energy from the Sun and convert it directly into electrical energy. They do not need heat - they work even on cold, bright days. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp22-014', chapterId:'g6-ecosystems', subsection:'habitats', difficulty:2,
    ...
    explanation:'The Sparrow is an introduced (exotic) species brought to Mauritius from other countries. The Echo Parakeet, Pink Pigeon, and Solitaire are all native or endemic to the Mascarene islands. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6sc-pp22-015', chapterId:'g6-air', subsection:'composition', difficulty:3,
    ...
    explanation:'The cockroach breathes - it uses up oxygen and releases carbon dioxide through respiration. In a closed jar, oxygen decreases and carbon dioxide increases over time. 📄 PSAC 2022 exam.' })

);
window.PSAC_PDF_QUESTIONS = window.PSAC_PDF_QUESTIONS || [];
window.PSAC_PDF_QUESTIONS.push(
  { id:'g6sc-pp22-pdf-001', image:'assets/past-papers/g6-science-2022/d3-animals.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-animals', marks:3, year:2022, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp22-pdf-002', image:'assets/past-papers/g6-science-2022/d4-car.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-materials', marks:1, year:2022, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp22-pdf-003', image:'assets/past-papers/g6-science-2022/d5-television.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-energy', marks:3, year:2022, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp22-pdf-004', image:'assets/past-papers/g6-science-2022/d7-ecosystem.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-ecosystems', marks:2, year:2022, grade:6, subject:'Science',
