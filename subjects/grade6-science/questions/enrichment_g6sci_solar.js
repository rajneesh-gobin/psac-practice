'use strict';
// Grade 6 Science - Enrichment: Our Solar System
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sci-enr-sol-004', chapterId:'g6sci-enr-solar', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/mars-august-30-2021-flickr-kevin-m-gill.jpg" alt="A reddish-orange rocky planet with visible surface features and a thin atmosphere" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>Which planet is shown in this photograph?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-sol-005', chapterId:'g6sci-enr-solar', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/jupiter-opal-2024.jpg" alt="A very large banded gas planet with brown and orange cloud stripes and a distinctive large oval storm" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>Which planet is shown in this Hubble Space Telescope image?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-sol-008', chapterId:'g6sci-enr-solar', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/neptune-voyager2-color-calibrated.jpg" alt="A deep blue planet with visible faint cloud features on its surface" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>Which planet is shown in this Voyager 2 photograph, the last and most distant planet in our Solar System?</b>',
  ...
  makeMCQ({ id:'g6sci-enr-sol-013', chapterId:'g6sci-enr-solar', subsection:'planets', difficulty:2,
    question:'What makes Earth the only planet known to support life?',
    options:['It has water, air and mild temperatures', 'It is the largest planet in the system', 'It is closest to the Sun for warmth', 'It has no atmosphere at all'],
  ...
  makeMCQ({ id:'g6sci-enr-sol-014', chapterId:'g6sci-enr-solar', subsection:'planets', difficulty:3,
    ...
    options:['It has not cleared its orbit of objects', 'It was found to be too hot for a planet', 'It is too small to be seen at all', 'It does not orbit the Sun'],
    answer:'It has not cleared its orbit of objects',
