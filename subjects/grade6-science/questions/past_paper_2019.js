...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sc-pp19-001', chapterId:'g6-air', subsection:'breathing', difficulty:1,
    ...
    explanation:'Carbon dioxide (CO₂) is used in fire extinguishers - it is heavier than air and forms a blanket over the fire, cutting off oxygen and extinguishing the flame. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-002', chapterId:'g6-animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Adults have 32 permanent teeth: 8 incisors, 4 canines, 8 pre-molars, and 12 molars. Children have only 20 milk (deciduous) teeth. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-003', chapterId:'g6-air', subsection:'composition', difficulty:1,
    ...
    explanation:'Oxygen makes up approximately 21% of the atmosphere. Nitrogen accounts for about 78%. Carbon dioxide is only about 0.03%; 78.1% would be nitrogen, not oxygen. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-004', chapterId:'g6-materials', subsection:'properties', difficulty:1,
    ...
    explanation:'Silk is obtained from the silkworm (an animal) - it unravels the silk fibre from the silkworm cocoon. Cotton comes from the cotton plant; paper from wood (plant); rubber from the rubber tree (plant). 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-005', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Feathers are unique to birds - no other animal has them. Exoskeletons belong to insects/crustaceans; giving birth to live young is a mammal trait; crawling is associated with reptiles and some insects. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-006', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Cucumbers and carrots are vegetables rich in vitamins and minerals - they belong to the food for health group. Carbohydrates (bread, rice) give energy; proteins (fish, meat, lentils) support growth. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-007', chapterId:'g6-materials', subsection:'natural_manmade', difficulty:2,
    ...
    explanation:'Tissue paper lets water through in only 5 seconds - the fastest - making it the most permeable. Leather (5 hours) is least permeable among those that allow water; plastic sheet is completely impermeable. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-008', chapterId:'g6-materials', subsection:'natural_manmade', difficulty:2,
    ...
    explanation:'A raincoat needs to be completely impermeable. Plastic sheet is the only material in the experiment through which water does not pass at all - making it ideal for a raincoat. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-009', chapterId:'g6-solar-system', subsection:'planets', difficulty:1,
    ...
    explanation:'One complete revolution (orbit) of the Earth around the Sun takes 365¼ days - one year. This movement also causes the seasons. One rotation on its own axis takes only 24 hours. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-010', chapterId:'g6-energy', subsection:'renewable', difficulty:1,
    ...
    explanation:'Heavy oil is a fossil fuel - non-renewable because it cannot be replenished once used. Falling water (hydro), bagasse (from sugarcane), and wind are all renewable sources. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-011', chapterId:'g6-energy', subsection:'renewable', difficulty:1,
    ...
    explanation:'Falling water (hydro power) generates electricity by spinning turbines with the force of falling water - no fuel is burned, so no air pollution is produced directly. It is also renewable. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-012', chapterId:'g6-ecosystems', subsection:'food_webs', difficulty:2,
    ...
    explanation:'Sun → Lettuce → Snail is correct. The lettuce is a producer (uses sunlight to make food); the snail is a consumer (eats the lettuce). Energy always flows from sun to plants to animals. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp19-013', chapterId:'g6-ecosystems', subsection:'habitats', difficulty:2,
    ...
    options:['Dust blocks sunlight from the leaves', 'It increases the oxygen in the forest', 'It adds minerals that help them grow', 'It increases rainfall over the forest'], answer:'Dust blocks sunlight from the leaves',
    hint:'Trees need sunlight for photosynthesis. What happens if their leaves are covered in dust?',
    explanation:'Dust from the stone crusher settles on leaves and blocks sunlight, reducing photosynthesis. Less food is produced, weakening the trees. Pollutants may also damage leaf tissue directly. 📄 PSAC 2019 exam.' })
...
window.PSAC_PDF_QUESTIONS.push(
  ...
  { id:'g6sc-pp19-pdf-004', image:'assets/past-papers/g6-science-2019/d5-lettuce-snails.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-ecosystems', marks:2, year:2019, grade:6, subject:'Science',
