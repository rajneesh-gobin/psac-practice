...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sci-en-001', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'How does a THERMAL power station make electricity?',
    options:['Burning fuel makes steam turn turbines', 'Wind pushes the turbine blades round', 'Falling water spins the turbines', 'Solar panels convert the sunlight'],
    answer:'Burning fuel makes steam turn turbines',
  ...
  makeMCQ({ id:'g6sci-en-002', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'How does a HYDROELECTRIC power station make electricity?',
    options:['Falling water spins the turbines', 'Solar heat turns water into steam', 'Burning wood produces the steam', 'Hydrogen gas is used as fuel'],
    answer:'Falling water spins the turbines',
  ...
  makeMCQ({ id:'g6sci-en-003', chapterId:'g6-energy', subsection:'forms', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-004', chapterId:'g6-energy', subsection:'photos', difficulty:2,
    ...
    options:['It changes the voltage', 'It generates the electricity', 'It stores electricity for later', 'It turns electricity into heat'],
    answer:'It changes the voltage',
  ...
  makeTF({ id:'g6sci-en-005', chapterId:'g6-energy', subsection:'sources', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-006', chapterId:'g6-energy', subsection:'sources', difficulty:2,
  ...
  makeMCQ({ id:'g6sci-en-007', chapterId:'g6-energy', subsection:'sources', difficulty:1,
    question:'Why is it important to SAVE electricity at home?',
    options:['It saves fuel and reduces pollution', 'Electricity dims when it is overused', 'Companies ask us to as a favour', 'Electricity is free anyway'],
    answer:'It saves fuel and reduces pollution',
  ...
  makeMCQ({ id:'g6sci-en-008', chapterId:'g6-energy', subsection:'saving', difficulty:1,
  ...
  makeTF({ id:'g6sci-en-009', chapterId:'g6-energy', subsection:'sources', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-010', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'What is the main DISADVANTAGE of solar panels?',
    options:['They work only in sunshine', 'They are heavier than a power station', 'They are made of toxic material', 'They produce too much power'],
    answer:'They work only in sunshine',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sci-en-011', chapterId:'g6-energy', subsection:'transfer', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-012', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'Is BAGASSE a renewable or a non-renewable source of energy?',
    options:['Renewable - it is sugar cane waste', 'Non-renewable - it comes from plants', 'A fossil fuel found underground', 'A nuclear source of energy'],
    answer:'Renewable - it is sugar cane waste',
  ...
  makeMCQ({ id:'g6sci-en-013', chapterId:'g6-energy', subsection:'sources', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-014', chapterId:'g6-energy', subsection:'sources', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-015', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'What is the role of the WIRE in a simple electric circuit? (PSAC 2025 Q6d)',
    options:['To carry the electric current', 'To change electrical into chemical', 'To control the amount of current', 'To store energy for later use'],
    answer:'To carry the electric current',
  ...
  makeMCQ({ id:'g6sci-en-016', chapterId:'g6-energy', subsection:'forms', difficulty:1,
  ...
  makeTF({ id:'g6sci-en-017', chapterId:'g6-energy', subsection:'renewable', difficulty:1,
  ...
  makeMCQ({ id:'g6sci-en-018', chapterId:'g6-energy', subsection:'sources', difficulty:2,
  ...
  makeMCQ({ id:'g6sci-en-019', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    question:'Which TWO methods produce most of the electricity in Mauritius?',
    options:['Thermal (fuel) and bagasse', 'Nuclear power and hydroelectric', 'Wind turbines and solar panels', 'Tidal energy and geothermal'],
    answer:'Thermal (fuel) and bagasse',
