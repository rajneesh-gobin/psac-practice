...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sc-pp23-001', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Crocodiles are reptiles - scaly skin, cold-blooded, lay eggs on land. Butterflies are insects, dolphins are mammals, and fish belong to their own class. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-002', chapterId:'g6-animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'A child has 20 milk (deciduous) teeth. These fall out and are replaced by 32 permanent teeth in adulthood. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-003', chapterId:'g6-energy', subsection:'renewable', difficulty:1,
    ...
    explanation:'Heavy oil is a fossil fuel and non-renewable. Bagasse (from sugarcane), falling water (hydro), and wind are all renewable - they are naturally replenished. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-004', chapterId:'g6-air', subsection:'properties', difficulty:2,
    ...
    explanation:'Air is 78 % nitrogen (the largest sector) and 21 % oxygen (the second-largest sector). Gas X - the second-largest section - is oxygen. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-005', chapterId:'g6-energy', subsection:'sources', difficulty:2,
    ...
    explanation:'In a thermal power station: burning fuel → steam → turbine spins → generator produces electricity. Y is the generator. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-006', chapterId:'g6-plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The male part (stamen / anther) produces and contains pollen. The female part (pistil / stigma) receives pollen during pollination. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-007', chapterId:'g6-plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The carrot is a root vegetable. We eat its swollen taproot. Papaya (fruit), sugarcane (stem juice), and vetiver (used for soil conservation) are not eaten as roots. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-008', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Frogs are amphibians - moist skin, breathe through skin and lungs, and lay eggs in water. Dogs are mammals, snakes are reptiles, spiders are arachnids. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-009', chapterId:'g6-conservation', subsection:'pollution', difficulty:1,
    ...
    explanation:'Smoke containing harmful gases and particles causes air pollution. Land, noise, and water pollution each affect different parts of the environment. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-010', chapterId:'g6-ecosystems', subsection:'habitats', difficulty:2,
    ...
    explanation:'The Cardinal Jaune (Rodrigues Cardinal) is endemic to Rodrigues - it evolved there and is found nowhere else. The Echo Parakeet is endemic to Mauritius island. Pigeons and sparrows are introduced species. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-011', chapterId:'g6-conservation', subsection:'pollution', difficulty:1,
    ...
    explanation:'Dried leaves are organic matter - they decompose naturally to form compost and enrich the soil. Used cells, tin cans, and plastic bottles are non-organic and cannot be composted. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-012', chapterId:'g6-energy', subsection:'renewable', difficulty:1,
    ...
    explanation:'Coal is a fossil fuel formed over millions of years - once burned it cannot be replaced (non-renewable). Bagasse, the sun, and tides are renewable sources. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-013', chapterId:'g6-solar-system', subsection:'planets', difficulty:1,
    ...
    explanation:'One rotation of Earth on its axis (24 hours) causes day and night - one side faces the Sun (day), the other is in shadow (night). One revolution around the Sun (365 days) causes seasons. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-014', chapterId:'g6-solar-system', subsection:'planets', difficulty:1,
    ...
    explanation:'There are 8 planets: Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, Neptune. Pluto was reclassified as a dwarf planet in 2006. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp23-015', chapterId:'g6-conservation', subsection:'pollution', difficulty:2,
    ...
    explanation:'Gabions are rock-filled wire cages placed along the shore that absorb wave energy and slow erosion. Cutting trees, removing sand, and removing mangroves all increase erosion. 📄 PSAC 2023 exam.' })
...
window.PSAC_PDF_QUESTIONS.push(
  ...
  { id:'g6sc-pp23-pdf-003', image:'assets/past-papers/g6-science-2023/d6-plant-gases.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-plants', marks:4, year:2023, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp23-pdf-005', image:'assets/past-papers/g6-science-2023/d10-waste.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-conservation', marks:3, year:2023, grade:6, subject:'Science',
