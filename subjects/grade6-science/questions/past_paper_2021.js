...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6sc-pp21-001', chapterId:'g6-materials', subsection:'natural_manmade', difficulty:1,
    ...
    explanation:'Gold is a metal - it is shiny, conducts electricity and heat, and is mined from the earth. Cotton and wool are plant/animal fibres; leather is an animal material. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-002', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Ants are insects - 6 legs, 3 body sections, antennae. Crabs are crustaceans (10 legs); pigeons are birds; spiders are arachnids (8 legs). 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-003', chapterId:'g6-plants', subsection:'parts', difficulty:1,
    ...
    explanation:'Leaves carry out photosynthesis - they contain chlorophyll that captures sunlight to convert water and carbon dioxide into food (glucose). Flowers, fruits, and roots have other roles. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-004', chapterId:'g6-energy', subsection:'forms', difficulty:1,
    ...
    explanation:'A television is powered by electrical energy from the socket. It converts that into light, sound, and heat energy as outputs. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-005', chapterId:'g6-air', subsection:'breathing', difficulty:2,
    ...
    explanation:'Candle S is uncovered and has unlimited oxygen from the surrounding air, so it burns the longest. Candles P, Q, and R will each extinguish when their limited oxygen inside the jar runs out. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-006', chapterId:'g6-air', subsection:'composition', difficulty:2,
    ...
    explanation:'Gas X is oxygen - it makes up about 21% of air, the second-largest portion after nitrogen (78%). Oxygen is essential for respiration and combustion. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-007', chapterId:'g6-air', subsection:'properties', difficulty:1,
    ...
    explanation:'Nitrogen makes up approximately 78% of dry air - the largest proportion. Oxygen is next at 21%; carbon dioxide is only 0.04%; water vapour varies but is much less than nitrogen. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-008', chapterId:'g6-air', subsection:'breathing', difficulty:1,
    ...
    explanation:'Fire extinguishers release carbon dioxide (CO₂). It forms a blanket over the fire, displacing oxygen and extinguishing the flame by removing one of the three requirements for burning. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-009', chapterId:'g6-animals', subsection:'classification', difficulty:1,
    ...
    explanation:'The whale is a mammal - it breathes air through a blowhole, gives birth to live young, and feeds them milk. Fish breathe through gills and reproduce by laying eggs. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-010', chapterId:'g6-materials', subsection:'properties', difficulty:2,
    ...
    explanation:'Aluminium is used for the airplane body because it is light (low density) and strong. Being lightweight reduces fuel consumption without sacrificing structural strength. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-011', chapterId:'g6-energy', subsection:'renewable', difficulty:2,
    ...
    options:['The water cycle keeps replacing it', 'It can be stored in batteries easily', 'It is cheaper than burning coal', 'It produces no waste at all'], answer:'The water cycle keeps replacing it',
    hint:'Think about where the water in rivers and reservoirs comes from.',
    explanation:'Falling water is renewable because it is continuously replenished by the water cycle - rain refills rivers and reservoirs. It is not a fossil fuel and will not run out as long as the water cycle continues. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6sc-pp21-012', chapterId:'g6-materials', subsection:'natural_manmade', difficulty:2,
    ...
    explanation:'The reddish-brown substance is rust - it forms when iron reacts with both water and oxygen. This process is called rusting (or corrosion). 📄 PSAC 2021 exam.' })

);
window.PSAC_PDF_QUESTIONS = window.PSAC_PDF_QUESTIONS || [];
window.PSAC_PDF_QUESTIONS.push(
  { id:'g6sc-pp21-pdf-001', image:'assets/past-papers/g6-science-2021/d3-teeth.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-animals', marks:3, year:2021, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp21-pdf-002', image:'assets/past-papers/g6-science-2021/d6-power-station.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-energy', marks:2, year:2021, grade:6, subject:'Science',
  ...
  { id:'g6sc-pp21-pdf-003', image:'assets/past-papers/g6-science-2021/d8-airplane.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'g6-materials', marks:2, year:2021, grade:6, subject:'Science',
