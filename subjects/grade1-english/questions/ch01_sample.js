'use strict';
// Grade 1 English — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g1eng-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g1eng-samp-001', chapterId:'g1eng-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 1 English questions.',
    explanation:'Placeholder question for the Grade 1 English pack.' })
