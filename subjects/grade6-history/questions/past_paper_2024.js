...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g6h-pp24-001', chapterId:'g6-land-use', subsection:'agriculture', difficulty:1,
    ...
    explanation:'Maize is grown on terraced hillsides in Rodrigues because the land is steep and terracing prevents soil erosion. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-002', chapterId:'g6-slaves-immigrants', subsection:'chinese', difficulty:1,
    ...
    explanation:'Early Chinese immigrants settled in Port Louis, mainly in the China Town area, where they set up shops and businesses. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-003', chapterId:'g6-land-use', subsection:'agriculture', difficulty:1,
    ...
    explanation:'Plastic is non-biodegradable - it does not decompose naturally and can remain in the environment for hundreds of years. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-004', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
    ...
    explanation:'The Solitaire (Rodrigues solitaire) is shown on the Coat of Arms of Rodrigues. It was a large flightless bird that lived only in Rodrigues and became extinct. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-005', chapterId:'g6-slaves-immigrants', subsection:'indentured', difficulty:1,
    ...
    explanation:'Most indentured labourers came from India. They arrived through the Aapravasi Ghat in Port Louis between 1834 and 1924. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-006', chapterId:'g6-slaves-immigrants', subsection:'slavery', difficulty:1,
    ...
    explanation:'In the 19th century (from 1810), Mauritius became a British colony after the British defeated the French at the Battle of Grand Port. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-007', chapterId:'g6-independence', subsection:'independence', difficulty:2,
    ...
    explanation:'Sir Veerasamy Ringadoo became the first President of the Republic of Mauritius when the country became a republic on 12 March 1992. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-008', chapterId:'g6-land-use', subsection:'agriculture', difficulty:1,
    ...
    explanation:'Plantation agriculture involves growing one crop on large areas. Sugar cane is the main plantation crop in Mauritius. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-009', chapterId:'g6-land-use', subsection:'agriculture', difficulty:2,
    ...
    explanation:'Rainfall is a physical factor that influences farming - crops need water to grow. Other physical factors include soil type, relief (slope of land), and temperature. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-010', chapterId:'g6-land-use', subsection:'tourism', difficulty:1,
    ...
    explanation:'Most tourist hotels in Mauritius are situated in coastal regions because tourists are attracted by the beaches, lagoons, and sea activities. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-011', chapterId:'g6-slaves-immigrants', subsection:'slavery', difficulty:2,
    ...
    explanation:'Slaves were brought from African countries including Madagascar, Mozambique, Senegal, and other parts of Africa to work on sugar cane plantations in Ile de France (Mauritius). 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-012', chapterId:'g6-slaves-immigrants', subsection:'indentured', difficulty:2,
    ...
    explanation:'Rice was one of the basic food items given as ration to indentured labourers. They also received dried fish and other basic provisions. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-013', chapterId:'g6-natural-hazards', subsection:'preparedness', difficulty:2,
    ...
    explanation:'During torrential rains, people should stay indoors and away from rivers, drains, and low-lying flood-prone areas to avoid being swept away by flash floods. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-014', chapterId:'g6-natural-hazards', subsection:'floods', difficulty:2,
    ...
    explanation:'Deforestation removes trees that absorb rainwater, and building on flood plains means water cannot drain away naturally. These human activities cause more frequent flash floods. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-015', chapterId:'g6-independence', subsection:'symbols', difficulty:1,
    ...
    explanation:'The Trochetia boutoniana (also known as the "Boucle d\'oreille") is the national flower of Mauritius. It is a small, bell-shaped pink flower found mainly in the Black River Gorges. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-016', chapterId:'g6-cultural-heritage', subsection:'sites', difficulty:2,
    ...
    explanation:'The Slave Route Monument is at the foot of Le Morne Brabant mountain. Le Morne was a refuge for runaway slaves (maroons) and is a UNESCO World Heritage Site. 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-017', chapterId:'g6-cultural-heritage', subsection:'sites', difficulty:2,
    ...
    explanation:'The National History Museum (Chateau de Mahebourg) is situated in Mahebourg, in the south-east of Mauritius. It houses artefacts from the Battle of Grand Port (1810). 📄 PSAC 2024 exam.' }),
  makeMCQ({ id:'g6h-pp24-018', chapterId:'g6-cultural-heritage', subsection:'sites', difficulty:2,
    ...
    explanation:'The Beau Plan sugar mill in the north of Mauritius has been converted into a museum (L\'Aventure du Sucre), celebrating the history of the sugar industry in Mauritius. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6h-pp24-019', chapterId:'g6-natural-hazards', subsection:'cyclones', difficulty:2,
    ...
    explanation:'The 14 Jan position is above Mauritius (further north) and to its left (further west), so the cyclone was to the <b>North West</b> of the island. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6h-pp24-020', chapterId:'g6-land-use', subsection:'agriculture', difficulty:1,
    ...
    explanation:'<b>Market gardening</b> is the growing of vegetables, fruit and flowers on small plots for sale at local markets. Mixed farming would also include animals; plantation farming grows one crop over a large area. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6h-pp24-021', chapterId:'g6-land-use', subsection:'agriculture', difficulty:2,
    ...
    explanation:'Market gardening grows vegetables such as <b>tomatoes, lettuce, carrots and cabbages</b> for local markets. Sugar cane and tea are plantation crops; wheat and barley are not grown in Mauritius. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6h-pp24-022', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:1,
    ...
    explanation:'<b>Picture 5</b> is the <b>Coat of Arms of Mauritius</b>, showing a dodo and a Sambar deer holding a shield, with the motto <i>Stella Clavisque Maris Indici</i>. Picture 4 is the national flag and Picture 6 is the Trochetia, the national flower. 📄 PSAC 2024 exam.' })
