...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6hg-ind-001', chapterId:'g6-independence', subsection:'independence', difficulty:1,
  ...
  makeMCQ({ id:'g6hg-ind-002', chapterId:'g6-independence', subsection:'independence', difficulty:1,
  ...
  makeMCQ({ id:'g6hg-ind-003', chapterId:'g6-independence', subsection:'flag', difficulty:2,
  ...
  makeMCQ({ id:'g6hg-ind-004', chapterId:'g6-independence', subsection:'flag', difficulty:2,
  ...
  makeMCQ({ id:'g6hg-ind-005', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:1,
    question:'What is the motto on the Coat of Arms of Mauritius?',
    options:['Stella Clavisque Maris Indici', 'Liberté, Égalité, Fraternité', 'L\'union fait la force', 'Dieu et mon droit'],
    answer:'Stella Clavisque Maris Indici',
    hint:'The motto is about the island\'s position on the old Indian Ocean sea routes - not about freedom, and not about royalty.',
  ...
  makeMCQ({ id:'g6hg-ind-006', chapterId:'g6-independence', subsection:'independence', difficulty:2,
  ...
  makeTF({ id:'g6hg-ind-007', chapterId:'g6-independence', subsection:'flag', difficulty:1,
  ...
  makeMCQ({ id:'g6hg-ind-008', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
  ...
  makeMCQ({ id:'g6hg-ind-009', chapterId:'g6-independence', subsection:'symbols', difficulty:1,
  ...
  makeMCQ({ id:'g6hg-ind-010', chapterId:'g6-independence', subsection:'flag', difficulty:2,
    question:'What does the GREEN stripe on the Mauritian flag represent?',
    options:['The vegetation of the island', 'The struggle for independence', 'The light of independence', 'The Indian Ocean'],
    answer:'The vegetation of the island',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6hg-ind-011', chapterId:'g6-independence', subsection:'symbols', difficulty:1,
    question:'What is Mauritius\'s national FLOWER?',
    options:['Trochetia (Boucle d\'oreille)', 'Hibiscus (Rose de Chine)', 'Bougainvillier (Bougainvillea)', 'Anthurium (Flamingo flower)'],
  ...
  makeMCQ({ id:'g6hg-ind-012', chapterId:'g6-independence', subsection:'star_key', difficulty:1,
    question:'In "Star and Key of the Indian Ocean", what does KEY refer to?',
    options:['Its place on the sea trade routes', 'The many locks used in its forts', 'Its rank as top sugar producer', 'Its size as the smallest island'],
    answer:'Its place on the sea trade routes',
  ...
  makeMCQ({ id:'g6hg-ind-013', chapterId:'g6-independence', subsection:'flag', difficulty:2,
    question:'What does the YELLOW stripe on the Mauritian flag represent?',
    options:['The light of independence', 'The vegetation of the island', 'The struggle for independence', 'The Indian Ocean'],
  ...
  makeMCQ({ id:'g6hg-ind-014', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
  ...
  makeTF({ id:'g6hg-ind-015', chapterId:'g6-independence', subsection:'independence', difficulty:1,
  ...
  makeMCQ({ id:'g6hg-ind-016', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
    question:'What does the Coat of Arms of Rodrigues show?',
    options:['Animals found only in Rodrigues', 'The same design as Mauritius', 'A map of the Indian Ocean', 'Only the British crown'],
    answer:'Animals found only in Rodrigues',
  ...
  makeMCQ({ id:'g6hg-ind-017', chapterId:'g6-independence', subsection:'flag', difficulty:2,
    question:'Which leader opposed independence and preferred a link with Britain?',
    options:['Sir Gaëtan Duval', 'Sir Seewoosagur Ramgoolam', 'Sir Anerood Jugnauth', 'Paul Bérenger'],
    answer:'Sir Gaëtan Duval',
  ...
  makeMCQ({ id:'g6hg-ind-018', chapterId:'g6-independence', subsection:'independence', difficulty:3,
    question:'Why did Mauritius become a REPUBLIC in 1992?',
    options:['To replace the British monarch as head of state', 'To leave the Commonwealth of Nations at last', 'To end the sugar trade agreement with Britain', 'To become a member of the United Nations'],
    answer:'To replace the British monarch as head of state',
    hint:'Independence in 1968 did not change who formally stood at the top of the state. Ask what did change in 1992.',
  ...
  makeMCQ({ id:'g6hg-ind-019', chapterId:'g6-independence', subsection:'flag', difficulty:4,
    question:'A pupil says the blue stripe on the Mauritian flag stands for the sky. Which correction is right?',
    options:['Blue stands for the Indian Ocean', 'Blue stands for the night sky', 'Blue stands for our fresh water', 'Blue stands for the police force'],
    answer:'Blue stands for the Indian Ocean',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6hg-ind-020', chapterId:'g6-independence', subsection:'flag', difficulty:2,
    question:'What do the four colours of the Mauritian flag represent, from top to bottom?',
    options:['Struggle, ocean, independence, farming', 'Blood, sky, gold and forest', 'Hindu, Muslim, Creole, Chinese', 'Sun, sea, soil and sky'],
    answer:'Struggle, ocean, independence, farming',
  ...
  makeMCQ({ id:'g6hg-ind-021', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/coat-of-arms-of-mauritius.png" alt="a coat of arms with a shield and two animals as supporters" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>Which famous extinct bird of Mauritius appears as a supporter on the Coat of Arms?</b>',
  ...
  makeMCQ({ id:'g6hg-ind-022', chapterId:'g6-independence', subsection:'symbols', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/trochetia-boutoniana.jpg" alt="a pink flowering plant on a rocky slope" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>This beautiful endemic flower is the national flower of Mauritius. What is its name?</b>',
  ...
  makeMCQ({ id:'g6hg-ind-023', chapterId:'g6-independence', subsection:'coat_of_arms', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/mauritius-satellite.jpg" alt="a satellite view of a small island in the ocean" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>This satellite image shows Mauritius in the Indian Ocean. Which Latin motto on the Coat of Arms reflects this strategic island location?</b>',
    options:['Stella Clavisque Maris Indici', 'Liberté, Égalité, Fraternité', 'Unity, Faith, Discipline', 'In God We Trust'],
    answer:'Stella Clavisque Maris Indici',
