'use strict';
// Grade 1 Mathematics — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g1m-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g1m-samp-001', chapterId:'g1m-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 1 Maths questions.',
    explanation:'Placeholder question for the Grade 1 Mathematics pack.' })
