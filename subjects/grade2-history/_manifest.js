'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 2 — History & Geography   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g2h-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G2HG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g2h-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
