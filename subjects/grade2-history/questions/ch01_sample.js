'use strict';
// Grade 2 History & Geography — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g2h-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g2h-samp-001', chapterId:'g2h-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 2 History & Geography questions.',
    explanation:'Placeholder question for the Grade 2 History & Geography pack.' })
