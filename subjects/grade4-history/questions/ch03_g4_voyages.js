...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4h-voy-001', chapterId:'g4hist-voyages', subsection:'traders', difficulty:1,
  ...
  makeMCQ({ id:'g4h-voy-002', chapterId:'g4hist-voyages', subsection:'traders', difficulty:1,
  ...
  makeMCQ({ id:'g4h-voy-003', chapterId:'g4hist-voyages', subsection:'reasons', difficulty:1,
    ...
    answer:'To preserve and flavour food',
  ...
  makeMCQ({ id:'g4h-voy-004', chapterId:'g4hist-voyages', subsection:'traders', difficulty:1,
  ...
  makeMCQ({ id:'g4h-voy-006', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    ...
    options:[
      ...
      'Found naturally ONLY in Mauritius and nowhere else',
      'An animal that has recently become extinct'
    ],
    answer:'Found naturally ONLY in Mauritius and nowhere else',
  ...
  makeMCQ({ id:'g4h-voy-007', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    ...
    options:[
      'It flew away to another island far away',
      'It died from a very cold winter storm',
      'It was hunted by sailors and rats ate its eggs',
      'It was taken to Europe and never came back'
    ],
    answer:'It was hunted by sailors and rats ate its eggs',
  ...
  makeMCQ({ id:'g4h-voy-008', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
  ...
  makeMCQ({ id:'g4h-voy-009', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    question:'What is DEFORESTATION and how did it affect Mauritius?',
    options:[
      'Planting more trees to make Mauritius greener',
      'Cutting down forests for farming, building and fuel',
      'A type of weather event that killed many trees',
      'Building roads through forests without cutting trees'
    ],
    answer:'Cutting down forests for farming, building and fuel',
  ...
  makeMCQ({ id:'g4h-voy-010', chapterId:'g4hist-voyages', subsection:'traders', difficulty:3,
    question:'Why was the BLACK RIVER GORGES NATIONAL PARK established in Mauritius?',
    options:[
      'To build a new city for more people',
      'To protect native forest and endemic species',
      'To create a racing circuit for cars',
      'To grow more sugar cane for export'
    ],
    answer:'To protect native forest and endemic species',
  ...
  makeMCQ({ id:'g4h-voy-011', chapterId:'g4hist-voyages', subsection:'traders', difficulty:1,
    ...
    options:['Rubber, coconut oil and rice','Silk, porcelain and tea','Gold, diamonds and silver','Spices like pepper and cloves'],
    answer:'Silk, porcelain and tea',
  ...
  makeMCQ({ id:'g4h-voy-012', chapterId:'g4hist-voyages', subsection:'traders', difficulty:1,
    question:'What is the PINK PIGEON - and why is it special to Mauritius?',
    options:['A common bird found all over the world','An endemic bird that is now protected by law','A bird introduced from India long ago','A type of flamingo that visits Mauritius'],
    answer:'An endemic bird that is now protected by law',
  ...
  makeMCQ({ id:'g4h-voy-013', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    ...
    options:[
      ...
      'A nature reserve with giant tortoises',
      'A military base for the navy',
      'A sugar cane farm and factory'
    ],
    answer:'A nature reserve with giant tortoises',
  ...
  makeMCQ({ id:'g4h-voy-014', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    question:'What were MONSOON WINDS and why were they important to Indian Ocean traders?',
    options:[
      'Violent storms that destroyed trading ships',
      'Predictable seasonal winds sailors used to plan voyages',
      'Winds that only blew on the island of Mauritius',
      'Strong winds that only occurred in the Atlantic Ocean'
    ],
    answer:'Predictable seasonal winds sailors used to plan voyages',
  ...
  makeTF({ id:'g4h-voy-015', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
  ...
  makeMCQ({ id:'g4h-voy-016', chapterId:'g4hist-voyages', subsection:'traders', difficulty:3,
    ...
    options:[
      ...
      'Tourism money helps to fund conservation work',
      'It means the animals do not need to be fed',
      'Tourists help to hunt threatened animals'
    ],
    answer:'Tourism money helps to fund conservation work',
  ...
  makeMCQ({ id:'g4h-voy-017', chapterId:'g4hist-voyages', subsection:'traders', difficulty:3,
    ...
    options:[
      ...
      'Trade routes also spread ideas, religions and cultures',
      'Religions spread only through wars and conquest',
      'Indian traders kept their culture completely secret'
    ],
    answer:'Trade routes also spread ideas, religions and cultures',
  ...
  makeMCQ({ id:'g4h-voy-018', chapterId:'g4hist-voyages', subsection:'traders', difficulty:3,
    question:'The EBONY TREE is endemic to Mauritius and was nearly logged to extinction. Why is ebony so valuable?',
    options:[
      'It produces a fruit that is very sweet to eat',
      'Its hard, dark wood was prized for fine furniture',
      'It can survive in salt water near the sea',
      'Its leaves are used to make a popular tea'
    ],
    answer:'Its hard, dark wood was prized for fine furniture',
  ...
  makeMCQ({ id:'g4h-voy-019', chapterId:'g4hist-voyages', subsection:'traders', difficulty:4,
    ...
    options:[
      'The student is right - extinct species cannot come back',
      'Many endemic species are still alive and can still be saved',
      'The student is right - no endemic species are left',
      'Conservation only matters in big countries, not islands'
    ],
    answer:'Many endemic species are still alive and can still be saved',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4h-voy-023', chapterId:'g4hist-voyages', subsection:'traders', difficulty:2,
    ...
    options:['A military base for the navy','A tourist hotel and resort','A nature reserve being restored','A large sugar cane plantation'],
    answer:'A nature reserve being restored',
