...
const G4HG_LEARN = {
  'g4hg-cov-reasons-3': '<b>Trade</b> is the buying and selling of goods between people, cities or countries. It allows each place to get things it cannot easily produce itself, in exchange for things it has in abundance. Long-distance trade has happened for thousands of years, connecting continents by sea and land routes.',
  'g4hg-cov-reasons-5': '<b>Sea routes</b> were vital for long-distance trade before modern roads and railways. A single large ship could carry far more cargo than hundreds of carts. The Indian Ocean was one of the world\'s busiest trade zones, connecting East Africa, Arabia, India and South-East Asia for over 2,000 years.',
  'g4hg-cov-ships-0': '<b>Navigation</b> is the skill of finding your way at sea. Before GPS, sailors used the stars (which always appear in the same positions in the night sky) and a compass (which always points north). They also used sea charts, tides, and ocean currents to plot and follow a course.',
  'g4hg-cov-ships-5': '<b>Navigation</b> means working out where you are and which way to steer. At sea there are no roads or landmarks, so sailors used tools: a <i>compass</i> (always points north), the <i>stars</i> (fixed patterns in the night sky), and <i>sea charts</i> showing coastlines, reefs and depths.',
  'g4hg-cov-relief-0': 'The <b>relief</b> of the land describes its physical shape — how high or low it is, and whether it is flat, hilly or mountainous. Mauritius has a central plateau (high flat land), mountain peaks rising from it, and flat coastal plains around the edges leading down to the sea.',
  'g4hg-cov-relief-1': 'A <b>plateau</b> is a large area of high, fairly flat land. It differs from a mountain, which rises to a narrow peak. The central plateau of Mauritius sits at about 400–600 m above sea level, making it cooler and wetter than the coast below it.',
  'g4hg-cov-coast-1': 'A <b>lagoon</b> is a stretch of shallow, calm sea water separated from the open ocean by a coral reef or a sand bar. Mauritius has one of the world\'s longest fringing reef systems, creating a large lagoon around most of the island that is safe for swimming and fishing.',
  'g4hg-cov-coast-5': 'A <b>coral reef</b> is built up over thousands of years by tiny animals called coral polyps. As they die, their calcium carbonate skeletons accumulate, forming a rocky structure. Reefs are among the richest habitats on Earth, sheltering a quarter of all marine species despite covering less than 1% of the ocean floor.',
  'g4hg-cov-natural-0': 'Geographers divide landscape features into <b>natural</b> (made by the Earth itself — mountains, rivers, beaches) and <b>man-made</b> (built by people — roads, bridges, schools). Understanding this difference helps us study how people have changed the natural environment over time.',
};
  const add = (id, chapterId, subsection, question, options, answer, hint, explanation) => STATIC_QUESTIONS.push(makeMCQ({ id, chapterId, subsection, difficulty: 2, question, options, answer, hint, explanation: G4HG_EXPL[id] || explanation, learnMore: G4HG_LEARN[id] || '' }));
