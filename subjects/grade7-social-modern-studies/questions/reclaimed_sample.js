...
STATIC_QUESTIONS.push(
  makeMCQ({
    id: "g7sms-samp-001",
    chapterId: "g7sms-islands",
    difficulty: 1,
    subsection: "islands_republic",
    question: "Which of these islands forms part of the <b>Republic of Mauritius</b>?",
    options: ["Rodrigues","Reunion","Madagascar","Comoros"],
    answer: "Rodrigues",
    hint: "One of these is governed from Port Louis.",
    explanation: "Rodrigues is part of the Republic of Mauritius and has its own Regional Assembly. Reunion is a French department, while Madagascar and the Comoros are separate countries."
  })
);
