'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 9 — Science   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g9s-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G9SC_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g9s-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
