...
const MCQ_B1 = [
  ...
  ['g9s-bpi-007', 'blood_vessels', 3,
   ...
   ["Reduced blood flow to the heart muscle and raised blood pressure within the narrowed region","Reduced removal of carbon dioxide from the lungs and an increased volume of blood plasma","Blocked lymph drainage from the heart and swelling of the tissue that surrounds the vessel","Increased oxygen delivery to the heart muscle and a much lower pulse rate while resting"],
  ...
  ['g9s-bpi-008', 'cardiovascular_disease', 1,
   ...
   ["A condition in which the coronary arteries become narrowed, reducing blood supply to the heart muscle","A condition in which the heart beats far too slowly to supply enough blood to the rest of the body","A condition in which the valves inside the heart become stiff and are no longer able to open fully","A condition in which the veins carry blood backwards because their valves have completely failed"],
  ...
  ['g9s-bpi-009', 'cardiovascular_disease', 2,
   ...
   ["High saturated fat → raised blood cholesterol → fatty plaque in artery walls → narrowed coronary artery → blocked blood supply → heart muscle dies","High saturated fat → raised blood glucose → excess insulin released → inflammation of the heart valves → valve failure → sudden heart attack","High saturated fat → reduced red blood cell production → less oxygen carried in the blood → slower heart rate → weak pulse → cardiac arrest","High saturated fat → hardened capillary walls → raised venous pressure → fluid leaks into the tissues → swollen legs → total heart failure"],
  ...
  ['g9s-bpi-012', 'cardiovascular_disease', 3,
   ...
   ["Smoking chemicals damage artery walls, trigger plaque formation, raise blood pressure and reduce oxygen carried by red blood cells","Smoking destroys the white blood cells, so the body can no longer remove cholesterol from the blood or repair damaged arteries","Smoking makes red blood cells clump together, forming clots that appear only inside the veins and never inside any artery wall","Smoking slows the heart rate so severely that far too little blood reaches the muscles whenever the person takes any exercise"],
  ...
  ['g9s-bpi-016', 'pulse', 2,
   ...
   ["At the wrist (radial artery) or neck (carotid artery), because arteries are close to the skin surface there","In the middle of the palm, because the capillaries of the hand lie very close to the skin surface there","At the top of the foot, because the aorta divides at that point and the blood pressure reaches a peak","At the back of the knee (popliteal vein), because veins carry the highest pressure at that point in the leg"],
  ...
  ['g9s-bpi-020', 'interpreting_health_data', 3,
   ...
   ["There is a positive correlation between salt intake and cardiovascular death rate, but this alone does not prove causation","Reducing the salt intake would completely eliminate cardiovascular disease in every one of the four countries shown","A high salt intake directly causes cardiovascular disease in every single individual who consumes a large amount of it","The data is unreliable because the four countries differ in many other ways, so no conclusion can be drawn at all"],
...
const MCQ_B2 = [
  ...
  ['g9s-bpi-023', 'female_reproductive_system', 1,
   ...
   ["In the oviduct (fallopian tube)","In the ovary (inside the follicle)","In the uterus (womb lining)","In the vagina (the birth canal)"],
  ...
  ['g9s-bpi-025', 'female_reproductive_system', 2,
   ...
   ["The birth canal through which the baby passes during delivery, and the passage for menstrual blood","The gland that secretes the hormones needed to maintain a pregnancy after implantation happens","The organ that produces and then releases one mature egg cell each month under hormonal control","The tube that carries the egg cell from the ovary to the place where fertilisation usually happens"],
  ...
  ['g9s-bpi-027', 'stds', 1,
   ...
   ["A bacterium (Neisseria gonorrhoeae)","A protozoan parasite (Trichomonas vaginalis)","A virus (human papillomavirus)","A fungus (Candida albicans)"],
  ...
  ['g9s-bpi-030', 'interpreting_health_data', 3,
   ...
   ["Mean of 6.2 new cases per 1000 per year; a consistent downward trend suggesting the campaign may have contributed to falling rates","Mean of 5.3 new cases per 1000 per year; a steady upward trend showing that the health campaign has had no effect at all so far","Mean of 4.0 new cases per 1000 per year; a downward trend that proves beyond any doubt that the campaign caused the reduction","Mean of 8.2 new cases per 1000 per year; no clear trend at all, because the figures fluctuate randomly from one year to the next"],
...
const MCQ_B3 = [
  ...
  ['g9s-bpi-040', 'quadrat_sampling', 3,
   ...
   ["Mean = 11 species per quadrat; a higher mean indicates greater species richness, suggesting a healthier and more biodiverse ecosystem","Mean = 10 species per quadrat; a higher mean indicates that the forest is being badly degraded by nearby human activity such as logging","Mean = 55 species per quadrat; a higher mean indicates that far fewer quadrats should have been used when the survey was carried out","Mean = 15 species per quadrat; a higher mean indicates that invasive alien species are now dominating the whole of the habitat"],
...
const MCQ_B4 = [
  ...
  ['g9s-bpi-050', 'photosynthesis', 3,
   ...
   ["During the day photosynthesis removes more CO₂ than respiration releases; at night only respiration occurs, releasing CO₂","During the day CO₂ dissolves into the soil and is absorbed by the roots; at night the roots slowly release all of it back","During the day CO₂ is converted into oxygen, which then turns back into CO₂ at night by a reversal of the same reaction","During the day the plant stops respiring so CO₂ falls; at night it begins to respire again and so the CO₂ level rises"],
  ...
  ['g9s-bpi-052', 'leaf_adaptation', 1,
   ...
   ["To allow carbon dioxide in and oxygen out, and to let water vapour escape during transpiration","To anchor the leaf firmly to the stem and stop it being torn off in a strong wind or storm","To absorb the sunlight and convert it into the chemical energy that is stored inside glucose","To transport water and dissolved minerals from the roots to the rest of the leaf and stem"],
  ...
  ['g9s-bpi-058', 'mineral_nutrition', 2,
   ...
   ["They are components of ATP (for energy transfer) and DNA (for genetic information), and they promote healthy root development","They are the main component of chlorophyll (for absorbing light), and they promote the growth of healthy new leaves in spring","They provide the nitrogen needed for protein synthesis (for growth), and they strengthen the cell walls of the stem and leaves","They regulate water uptake by the root hair cells (by osmosis), and they produce the sugars that are used up in respiration"],
  ...
  ['g9s-bpi-059', 'mineral_nutrition', 2,
   ...
   ["Magnesium is mobile in the plant and is moved from older to younger leaves when supplies are low, so older leaves show deficiency first","Older leaves make far more chlorophyll than the young leaves do, so they use up the available magnesium supply very much faster","The roots absorb magnesium last of all, so it takes the longest time to reach the older leaves at the very bottom of the plant","Older leaves are more exposed to bright sunlight, and the magnesium is bleached out of their chlorophyll by the UV radiation"],
