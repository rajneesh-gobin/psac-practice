...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g9s-pp24b-001', chapterId:'g9s-b1-circulatory', subsection:'components_of_blood', difficulty:1,
    ...
    explanation:'<b>Platelets</b> clump together at a wound and trigger the clotting process that seals it. Red cells carry oxygen, white cells fight infection and plasma is the liquid they all travel in. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-002', chapterId:'g9s-b1-circulatory', subsection:'blood_vessels', difficulty:2,
    ...
    explanation:'The label points to the central channel, the <b>lumen</b>, and in an artery it is narrow compared with the very thick muscular wall. That thick wall and narrow lumen are what let an artery withstand high pressure; a vein has the reverse. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-003', chapterId:'g9s-b2-reproductive', subsection:'sexual_asexual', difficulty:1,
    ...
    explanation:'An <b>amoeba</b> is a single-celled organism that simply divides in two, so one parent produces two identical offspring. Cats, elephants and pigeons all reproduce sexually. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-004', chapterId:'g9s-b2-reproductive', subsection:'stds', difficulty:1,
    ...
    explanation:'<b>Gonorrhoea</b> is a bacterial infection spread by sexual contact. Cholera comes from contaminated water, COVID-19 spreads through the air and a stroke is not an infection at all. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-005', chapterId:'g9s-b2-reproductive', subsection:'stds', difficulty:2,
    ...
    explanation:'A used needle carries blood, so <b>sharing needles</b> passes HIV directly from one person to another. Condoms reduce the spread, and diet and exercise do not transmit the virus either way. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-006', chapterId:'g9s-b2-reproductive', subsection:'female_reproductive_system', difficulty:1,
    ...
    explanation:'The <b>ovary</b> produces and releases the egg cells. The oviduct carries the egg, the uterus is where a fertilised egg develops and the vagina is the entrance to the system. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-007', chapterId:'g9s-b3-biodiversity', subsection:'quadrat_sampling', difficulty:2,
    ...
    explanation:'A quadrat counts organisms that do not move away, so it suits plants and <b>algae</b>. Birds, dogs and fish move around, so they would be counted twice or missed entirely. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-008', chapterId:'g9s-b4-plant-nutrition', subsection:'photosynthesis', difficulty:1,
    ...
    explanation:'<b>Chlorophyll</b> absorbs light energy for photosynthesis and gives leaves their green colour. Haemoglobin is the red pigment in blood, and starch is the food that photosynthesis produces. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-009', chapterId:'g9s-b4-plant-nutrition', subsection:'leaf_adaptation', difficulty:2,
    ...
    explanation:'P points to the outer edge, the <b>leaf margin</b>. Q points to the single thick vein running from the stalk to the tip, the <b>midrib</b>. The finer branching lines would be the network of veins, and the tip would be the apex. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-010', chapterId:'g9s-b4-plant-nutrition', subsection:'photosynthesis_experiments', difficulty:2,
    ...
    explanation:'Alcohol dissolves the green <b>chlorophyll</b> out of the leaf. Without that step the leaf stays green and the blue-black iodine colour cannot be seen. Boiling in water is what kills the leaf and stops reactions. 📄 NCE 2024 exam.' }),
  ...
  makeMCQ({ id:'g9s-pp24b-011', chapterId:'g9s-b2-reproductive', subsection:'sexual_asexual', difficulty:3,
    ...
    explanation:'Sexual reproduction joins gametes from <b>two</b> parents, so the offspring vary. Asexual reproduction uses <b>one</b> parent and produces offspring genetically identical to it. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-012', chapterId:'g9s-b2-reproductive', subsection:'sexual_asexual', difficulty:2,
    ...
    explanation:'A <b>potato</b> tuber and a <b>ginger</b> rhizome each grow into a new plant identical to the parent, with no seed and no second parent. The others are all grown from seed, which is sexual reproduction. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-013', chapterId:'g9s-b3-biodiversity', subsection:'what_is_biodiversity', difficulty:2,
    ...
    explanation:'Biodiversity is the <b>variety of living organisms</b> in a habitat - the range of different species, not simply how many individuals there are. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-014', chapterId:'g9s-b3-biodiversity', subsection:'natural_threats', difficulty:2,
    ...
    explanation:'A <b>cyclone</b> and a <b>drought</b> are natural events. Pollution and deforestation are caused by people, so they are human activities rather than natural calamities. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-015', chapterId:'g9s-b3-biodiversity', subsection:'importance_of_biodiversity', difficulty:3,
    ...
    explanation:'A varied community keeps <b>food chains and webs stable</b>, so losing one species does not collapse the system. Tourism, jobs and export earnings are socio-economic benefits. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-016', chapterId:'g9s-b1-circulatory', subsection:'blood_vessels', difficulty:2,
    ...
    explanation:'The mesh of extremely fine vessels linking the artery to the vein is the <b>capillary</b> network. Their walls are one cell thick, which is what allows exchange with the surrounding tissue. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-017', chapterId:'g9s-b1-circulatory', subsection:'blood_vessels', difficulty:2,
    ...
    explanation:'Capillary walls are one cell thick, so oxygen and nutrients pass out to the cells and waste passes in - the <b>exchange</b> the whole circulatory system exists to deliver. Carrying blood at pressure is the artery’s job, and valves stop backflow in veins. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-018', chapterId:'g9s-b1-circulatory', subsection:'blood_vessels', difficulty:3,
    ...
    explanation:'Arteries carry blood <b>away from</b> the heart, at high pressure and in surges; veins return it <b>towards</b> the heart at low pressure and steadily, which is why they need valves. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-019', chapterId:'g9s-b1-circulatory', subsection:'pulse', difficulty:2,
    ...
    explanation:'Each surge of blood from the heart stretches the artery wall, which then recoils. That wave is the <b>pulse</b>, and it can be felt wherever an artery runs close to the skin. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-020', chapterId:'g9s-b1-circulatory', subsection:'cardiovascular_disease', difficulty:2,
    ...
    explanation:'<b>Smoking</b> damages artery walls and a <b>high-fat diet</b> builds fatty deposits that narrow the coronary arteries. The other options all reduce the risk. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-021', chapterId:'g9s-b1-circulatory', subsection:'components_of_blood', difficulty:2,
    ...
    explanation:'Some white blood cells <b>engulf and digest</b> germs; others make <b>antibodies</b> that stick to germs and destroy them. Carrying oxygen is the red cell’s job and clotting is the platelet’s. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-022', chapterId:'g9s-b1-circulatory', subsection:'magnification', difficulty:3,
    ...
    explanation:'Magnification = image size &divide; actual size, so <b>actual size = image size &divide; magnification</b>. Measure the drawing with a ruler and divide by 8000. Multiplying would make an already-enlarged picture larger still. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-023', chapterId:'g9s-b4-plant-nutrition', subsection:'leaf_adaptation', difficulty:1,
    ...
    explanation:'The pores are <b>stomata</b> (one is a stoma). Each is opened and closed by a pair of guard cells. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-024', chapterId:'g9s-b4-plant-nutrition', subsection:'leaf_adaptation', difficulty:2,
    ...
    explanation:'Stomata let <b>carbon dioxide in and oxygen out</b> (and water vapour escapes through them too). Light is trapped by chlorophyll, water is absorbed by roots and food is carried in the phloem. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-025', chapterId:'g9s-b4-plant-nutrition', subsection:'factors_for_photosynthesis', difficulty:4,
    ...
    explanation:'Bubbles of oxygen appeared only when light AND carbon dioxide were both present, so <b>both are required</b>. Removing either one stopped photosynthesis, which is exactly what a controlled experiment is designed to show. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24b-026', chapterId:'g9s-inquiry', subsection:'hypothesis_testing', difficulty:3,
    ...
    explanation:'<b>Temperature</b> (and the type and amount of pond weed) must be held constant, or a change in bubbles could be caused by something other than light or carbon dioxide. Those two are the independent variables and the bubble count is the dependent one. 📄 NCE 2024 exam.' }),
