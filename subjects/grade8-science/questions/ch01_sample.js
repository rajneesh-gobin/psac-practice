'use strict';
// Grade 8 Science - PLACEHOLDER. Delete this file when real questions land.
// IDs format: g8s-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g8s-samp-001', chapterId:'g8s-inquiry', difficulty:1,
    question:'Placeholder - this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 8 Science questions.',
    explanation:'Placeholder question for the Grade 8 Science pack.' })
