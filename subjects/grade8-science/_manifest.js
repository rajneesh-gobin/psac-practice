'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 8 — Science   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g8s-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G8SC_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g8s-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
