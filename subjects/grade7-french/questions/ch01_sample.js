'use strict';
// Grade 7 Français — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g7fr-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g7fr-samp-001', chapterId:'g7fr-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 7 French questions.',
    explanation:'Placeholder question for the Grade 7 Français pack.' })
