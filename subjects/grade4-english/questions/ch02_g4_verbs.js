...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4eng-verb-001', chapterId:'g4eng-verbs', subsection:'in_context', difficulty:1,
    ...
    learnMore:'<b>Verbs</b> are the engine of every sentence — no sentence is complete without one. <i>Action verbs</i> describe what someone does (run, eat, think). <i>Linking verbs</i> describe a state of being (is, seems, becomes). <i>Auxiliary verbs</i> help the main verb form tenses (is running, has eaten, will go).' }),

  makeMCQ({ id:'g4eng-verb-002', chapterId:'g4eng-verbs', subsection:'present_tense', difficulty:1,
    ...
    learnMore:'<b>Present simple</b> describes habits, routines and general truths. The key rule: add <i>-s</i> or <i>-es</i> to the verb when the subject is he, she or it (third person singular). Examples: he <i>plays</i>, she <i>teaches</i>, it <i>does</i>. For all other subjects (I, you, we, they), use the base verb without -s.' }),

  makeMCQ({ id:'g4eng-verb-003', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:1,
    ...
    learnMore:'<b>Regular past tense</b>: simply add <i>-ed</i> to the base verb. Spelling rules: (1) verb ends in -e → add -d only (live→lived). (2) Short vowel + consonant → double the consonant (stop→stopped). (3) Verb ends in consonant + y → change y to i (carry→carried). Regular verbs are the majority in English.' }),

  makeTF({ id:'g4eng-verb-004', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:1,
    ...
    learnMore:'<b>Irregular verbs</b> do not follow the -ed pattern and must be memorised individually. Common groups: (1) vowel change: run→ran, sing→sang, swim→swam. (2) Completely different: go→went, be→was/were. (3) Same form: cut→cut, put→put, hit→hit. English has about 200 common irregular verbs.' }),

  makeMCQ({ id:'g4eng-verb-005', chapterId:'g4eng-verbs', subsection:'continuous', difficulty:2,
    ...
    learnMore:'<b>Present continuous</b> (also called present progressive) = <i>be</i> + verb-ing. Use "am" with I, "is" with he/she/it, "are" with you/we/they. It describes: (1) actions happening right now ("She is eating"), (2) temporary situations ("I am staying with my aunt"), (3) future plans ("We are leaving tomorrow").' }),

  makeMCQ({ id:'g4eng-verb-006', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-007', chapterId:'g4eng-verbs', subsection:'agreement', difficulty:2,
    ...
    learnMore:'<b>Subject-verb agreement</b>: the verb must always match its subject in number. Singular subject → verb + s/es (the dog barks). Plural subject → base verb (the dogs bark). Tricky cases: "The team is" (team is one group), "Neither of them is" (neither = not one, so singular), "My friend and I are" (two people = plural).' }),

  makeNum({ id:'g4eng-verb-008', chapterId:'g4eng-verbs', subsection:'in_context', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-009', chapterId:'g4eng-verbs', subsection:'in_context', difficulty:3,
  ...
  makeMCQ({ id:'g4eng-verb-010', chapterId:'g4eng-verbs', subsection:'present_tense', difficulty:4,
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4eng-verb-011', chapterId:'g4eng-verbs', subsection:'future_tense', difficulty:1,
  ...
  makeMCQ({ id:'g4eng-verb-012', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:1,
  ...
  makeTF({ id:'g4eng-verb-013', chapterId:'g4eng-verbs', subsection:'auxiliary', difficulty:1,
  ...
  makeMCQ({ id:'g4eng-verb-014', chapterId:'g4eng-verbs', subsection:'perfect', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-015', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-016', chapterId:'g4eng-verbs', subsection:'agreement', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-017', chapterId:'g4eng-verbs', subsection:'present_tense', difficulty:2,
  ...
  makeMCQ({ id:'g4eng-verb-018', chapterId:'g4eng-verbs', subsection:'in_context', difficulty:3,
  ...
  makeMCQ({ id:'g4eng-verb-019', chapterId:'g4eng-verbs', subsection:'past_tense', difficulty:4,
