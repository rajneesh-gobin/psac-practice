...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4eng-noun-020', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/stack-of-books-spines.jpg" alt="an object" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for the object shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-021', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/red-apple.jpg" alt="a fruit" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for the fruit shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-022', chapterId:'g4eng-nouns', subsection:'common_proper', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/plastic-chair.jpg" alt="a piece of furniture" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for this piece of furniture?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-023', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/canis-lupus-familiaris.jpg" alt="a pet animal" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>The animal shown is called a "dog". Which type of noun is "dog"?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-024', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/classroom.jpg" alt="a photograph of a room" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>Look at the scene. Which word names the PLACE shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-025', chapterId:'g4eng-nouns', subsection:'in_context', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/man-running.jpg" alt="a person running" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>In the sentence "The athlete is <u>running</u> fast", what part of speech is the underlined word?</b>',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4eng-noun-026', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/elephant.jpg" alt="a large animal" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for the animal shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-027', chapterId:'g4eng-nouns', subsection:'common_proper', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/hat.jpg" alt="an item of clothing" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for this item of clothing?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-028', chapterId:'g4eng-nouns', subsection:'common_proper', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/ruler.jpg" alt="a school object" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for this school object?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-029', chapterId:'g4eng-nouns', subsection:'common_proper', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/scissors.jpg" alt="a tool" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for this tool?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-030', chapterId:'g4eng-nouns', subsection:'common_proper', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/cup.jpg" alt="an object" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for this object?</b>',
  ...
  makeMCQ({ id:'g4eng-noun-031', chapterId:'g4eng-nouns', subsection:'picture_nouns', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/turtle.jpg" alt="an animal" style="max-height:180px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What is the noun for the animal shown in this picture?</b>',
