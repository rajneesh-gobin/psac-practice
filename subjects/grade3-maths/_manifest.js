'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 3 — Mathematics   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g3m-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G3M_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g3m-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
