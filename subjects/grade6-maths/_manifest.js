...
registerSubject({
  ...
  // from the real 2023 and 2024 papers, question by question: every
  // mark goes to the chapter that teaches it. Papers used: 2023 and 2024 (100 marks each).
  //
  //   g6-ratio-pct        33 marks   16.5%  ->  weight 7
  //   g6-four-ops         29 marks   14.5%  ->  weight 6
  //   g6-time-speed       23 marks   11.5%  ->  weight 4
  //   g6-measure          21 marks   10.5%  ->  weight 4
  //   g6-area-vol         20 marks   10.0%  ->  weight 4
  //   g6-graphs           19 marks    9.5%  ->  weight 4
  //   g6-numeration       15 marks    7.5%  ->  weight 3
  //   g6-geometry         14 marks    7.0%  ->  weight 3
  //   g6-fractions        11 marks    5.5%  ->  weight 2
  //   g6-factors-hcf       8 marks    4.0%  ->  weight 2
  //   g6-decimals          7 marks    3.5%  ->  weight 1
  //
  // ⚠ Two years, because topics rotate at the margins. Every chapter here is
  // scored in both papers, so the shape is stable.
  ...
  chapters: [
    ...
    { id: 'g6-four-ops',     name: 'Four Operations',                  icon: '➕', examWeight: 6,
    ...
    { id: 'g6-fractions',    name: 'Fractions',                        icon: '½',  examWeight: 2,
    ...
    { id: 'g6-decimals',     name: 'Decimals',                         icon: '•',  examWeight: 1,
    ...
    { id: 'g6-factors-hcf',  name: 'Factors, Multiples, HCF & LCM',   icon: '🔣', examWeight: 2,
    ...
    { id: 'g6-ratio-pct',    name: 'Ratio, Average & Percentage',      icon: '%',  examWeight: 7,
    ...
    { id: 'g6-geometry',     name: 'Geometry: Shapes & Angles',        icon: '📐', examWeight: 3,
    ...
    { id: 'g6-measure',      name: 'Measurement & Conversions',        icon: '📏', examWeight: 4,
    ...
    { id: 'g6-area-vol',     name: 'Area, Surface Area & Volume',      icon: '▭',  examWeight: 4,
    ...
    { id: 'g6-time-speed',   name: 'Time & Speed',                     icon: '⏰', examWeight: 4,
    ...
    { id: 'g6-graphs',       name: 'Graphs, Data & Coordinates',       icon: '📈', examWeight: 4,
