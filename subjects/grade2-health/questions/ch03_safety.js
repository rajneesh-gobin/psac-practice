...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g2he-saf-001', chapterId:'g2he-safety', difficulty:1, subsection:'home_safety',
    ...
    options:['A hot stove with boiling water','A closed refrigerator','A sealed jar','A full glass of water'],
    answer:'A hot stove with boiling water',
  ...
  makeMCQ({ id:'g2he-saf-004', chapterId:'g2he-safety', difficulty:2, subsection:'home_safety',
    ...
    options:['Tell an adult immediately and do not touch it',
             'Step over it carefully',
             'Move it to another room',
             'Tape it with any tape available'],
    answer:'Tell an adult immediately and do not touch it',
  ...
  makeMCQ({ id:'g2he-saf-006', chapterId:'g2he-safety', difficulty:1, subsection:'home_safety',
    ...
    options:['They can be dangerous or even deadly if taken in the wrong amount',
             'They taste bad',
             'They are expensive',
             'Children do not like medicine'],
    answer:'They can be dangerous or even deadly if taken in the wrong amount',
  ...
  makeMCQ({ id:'g2he-saf-007', chapterId:'g2he-safety', difficulty:1, subsection:'home_safety',
    ...
    options:['Get out of the building immediately and call for help',
             'Try to put it out with water from the tap',
             'Hide under your bed',
             'Open all the windows first'],
    answer:'Get out of the building immediately and call for help',
  ...
  makeMCQ({ id:'g2he-saf-011', chapterId:'g2he-safety', difficulty:1, subsection:'road_safety',
    ...
    options:['Stop, look left, look right, look left again, then cross when safe',
             'Run quickly without looking',
             'Walk straight across while looking at your phone',
             'Only look one way'],
    answer:'Stop, look left, look right, look left again, then cross when safe',
  ...
  makeMCQ({ id:'g2he-saf-012', chapterId:'g2he-safety', difficulty:1, subsection:'road_safety',
    ...
    options:['At a marked pedestrian crossing','Anywhere between parked cars','While running at any point','From behind a lorry or bus'],
    answer:'At a marked pedestrian crossing',
  ...
  makeMCQ({ id:'g2he-saf-014', chapterId:'g2he-safety', difficulty:1, subsection:'road_safety',
    ...
    options:['A ball or person could roll/fall into the road and be hit by a vehicle',
             'The road is too hard to play on',
             'The road is always wet',
             'It is boring near the road'],
    answer:'A ball or person could roll/fall into the road and be hit by a vehicle',
  ...
  makeMCQ({ id:'g2he-saf-015', chapterId:'g2he-safety', difficulty:2, subsection:'road_safety',
    ...
    options:['Find a safe gap in traffic, stand on the pavement and cross when there are no vehicles',
             'Run across as fast as possible',
             'Cross from behind a parked car',
             'Wave at drivers to stop'],
    answer:'Find a safe gap in traffic, stand on the pavement and cross when there are no vehicles',
  ...
  makeMCQ({ id:'g2he-saf-017', chapterId:'g2he-safety', difficulty:1, subsection:'road_safety',
    ...
    options:['No — you need to watch for traffic at all times',
             'Yes — if you are almost across',
             'Yes — if the message is important',
             'Yes — as long as you walk quickly'],
    answer:'No — you need to watch for traffic at all times',
  ...
  makeMCQ({ id:'g2he-saf-021', chapterId:'g2he-safety', difficulty:1, subsection:'first_aid_basics',
    ...
    options:['Tell an adult and clean the wound with clean water',
             'Put soil on it',
             'Blow on it only',
             'Leave it without doing anything'],
    answer:'Tell an adult and clean the wound with clean water',
  ...
  makeMCQ({ id:'g2he-saf-022', chapterId:'g2he-safety', difficulty:1, subsection:'first_aid_basics',
    ...
    options:['Call for an adult or emergency services immediately',
             'Give them food or water',
             'Shake them very hard',
             'Leave them alone'],
    answer:'Call for an adult or emergency services immediately',
  ...
  makeMCQ({ id:'g2he-saf-024', chapterId:'g2he-safety', difficulty:2, subsection:'first_aid_basics',
    ...
    options:['Run cold water over the burn for 10-20 minutes and tell an adult',
             'Put butter or toothpaste on the burn',
             'Wrap it tightly with a bandage',
             'Leave it alone and go to sleep'],
    answer:'Run cold water over the burn for 10-20 minutes and tell an adult',
  ...
  makeMCQ({ id:'g2he-saf-025', chapterId:'g2he-safety', difficulty:1, subsection:'first_aid_basics',
    ...
    options:['To provide basic medical supplies to treat minor injuries quickly',
             'To store lunch',
             'To carry books',
             'To hold water for drinking'],
    answer:'To provide basic medical supplies to treat minor injuries quickly',
  ...
  makeMCQ({ id:'g2he-saf-027', chapterId:'g2he-safety', difficulty:1, subsection:'first_aid_basics',
    ...
    options:['When someone is seriously injured, unconscious or in danger',
             'When you want to ask about the weather',
             'When you lose a toy',
             'When you feel slightly tired'],
    answer:'When someone is seriously injured, unconscious or in danger',
  ...
  makeMCQ({ id:'g2he-saf-029', chapterId:'g2he-safety', difficulty:1, subsection:'first_aid_basics',
    ...
    options:['Call an adult or emergency services immediately',
             'Give them water to drink',
             'Wait and see if it stops',
             'Tell them to lie down'],
    answer:'Call an adult or emergency services immediately',
