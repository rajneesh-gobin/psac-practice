'use strict';
// Grade 3 History & Geography — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g3h-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g3h-samp-001', chapterId:'g3h-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 3 History & Geography questions.',
    explanation:'Placeholder question for the Grade 3 History & Geography pack.' })
