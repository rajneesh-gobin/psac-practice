...
T.push({
  ...
  parts: [
    ...
    { label: 'b', marks: 1, prompt: 'What is the purpose of a <b>file compression</b> utility?',
      response: pick(['To reduce the size of files so they take up less space and transfer more quickly',
                      'To encrypt files so they cannot be read without a password',
                      'To scan files for viruses',
                      'To defragment the hard disk'],
                     'To reduce the size of files so they take up less space and transfer more quickly'),
...
T.push({
  ...
  parts: [
    ...
    { label: 'b', marks: 1, prompt: 'What device allows wireless devices to connect to a wired LAN?',
      response: pick(['A wireless access point (WAP)',
                      'A repeater',
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'An intranet is best described as:',
      response: pick(['A private network within an organisation that uses web technologies but is not publicly accessible',
                      'The global public internet restricted to one country',
                      'A wireless network available in cafés and public spaces',
                      'A backup copy of the public internet'],
                     'A private network within an organisation that uses web technologies but is not publicly accessible'),
    ...
    { label: 'b', marks: 1, prompt: 'What is the main difference between an intranet and an extranet?',
      response: pick(['An extranet extends controlled access to trusted external parties such as suppliers, whereas an intranet is restricted to employees only',
                      'An extranet is faster than an intranet',
                      'An intranet uses wireless technology and an extranet uses cables',
                      'An extranet has no security controls, unlike an intranet'],
                     'An extranet extends controlled access to trusted external parties such as suppliers, whereas an intranet is restricted to employees only'),
...
T.push({
  ...
  parts: [
    ...
    { label: 'c', marks: 1, prompt: 'When paying online, the presence of <b>https</b> and a padlock symbol in the address bar indicates:',
      response: pick(['The connection is encrypted and the site has a valid security certificate',
                      'The purchase is free of charge',
                      'The website is operated by a government',
                      'The goods will be delivered the next day'],
                     'The connection is encrypted and the site has a valid security certificate'),
...
T.push({
  ...
  parts: [
    ...
    { label: 'b', marks: 1, prompt: 'Using the AND operator between two criteria in a query:',
      response: pick(['Returns only records that satisfy BOTH criteria simultaneously',
                      'Returns records that satisfy either criterion',
                      'Excludes all records',
                      'Doubles the number of results'],
                     'Returns only records that satisfy BOTH criteria simultaneously'),
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'What is the main purpose of a <b>form</b> in a database application?',
      response: pick(['To provide a user-friendly screen for entering and editing records one at a time',
                      'To print a formatted summary of all records',
                      'To search the database with complex criteria',
                      'To design the table structure'],
                     'To provide a user-friendly screen for entering and editing records one at a time'),
    ...
    { label: 'b', marks: 1, prompt: 'Grouping records in a report allows:',
      response: pick(['Records with the same value in a field to be collected together, with optional subtotals for each group',
                      'All records to be displayed in a single column',
                      'The report to be sorted in reverse order',
                      'Images to be added to the report'],
                     'Records with the same value in a field to be collected together, with optional subtotals for each group'),
    ...
    { label: 'c', marks: 1, prompt: 'Exporting a report as a <b>PDF</b> is useful because:',
      response: pick(['The formatted report can be shared and printed by anyone without the database software',
                      'PDF files are automatically updated when the database changes',
                      'PDF files cannot be printed',
                      'PDF is a database format'],
                     'The formatted report can be shared and printed by anyone without the database software'),
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'Why should food and drinks not be brought into a computer laboratory?',
      response: pick(['Spills can damage keyboards and circuit boards, and crumbs attract pests',
                      'The computer works faster without food nearby',
                      'It is considered impolite in all countries',
                      'Food improves the humidity which damages screens'],
                     'Spills can damage keyboards and circuit boards, and crumbs attract pests'),
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'Copyright law gives the creator of an original work the exclusive right to:',
      response: pick(['Reproduce, distribute and adapt the work, and to authorise others to do so',
                      'Allow anyone to copy the work freely',
                      'Use the work only for personal purposes',
                      'Share the work on social media without restriction'],
                     'Reproduce, distribute and adapt the work, and to authorise others to do so'),
    ...
    { label: 'c', marks: 1, prompt: '"Creative Commons" licence allows:',
      response: pick(['Others to use the work under specified conditions set by the creator, often including attribution',
                      'Anyone to use the work for any purpose with no conditions at all',
                      'Only the creator to view the work',
                      'The government to own the work'],
                     'Others to use the work under specified conditions set by the creator, often including attribution'),
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'A full backup copies:',
      response: pick(['All selected data every time the backup runs, regardless of what has changed',
                      'Only files that have changed since the last backup',
                      'Only system files, not user data',
                      'Data to the same drive as the original'],
                     'All selected data every time the backup runs, regardless of what has changed'),
    ...
    { label: 'b', marks: 1, prompt: 'An incremental backup copies:',
      response: pick(['Only files that have changed since the last backup of any kind',
                      'All files every time',
                      'Only system files',
                      'A copy of the last full backup'],
                     'Only files that have changed since the last backup of any kind'),
...
T.push({
  ...
  parts: [
    { label: 'a', marks: 1, prompt: 'Mail merge is used to:',
      response: pick(['Create personalised letters or emails automatically by combining a template document with a data source',
                      'Merge two word-processed documents into one',
                      'Send emails without an internet connection',
                      'Print all documents in a folder at once'],
                     'Create personalised letters or emails automatically by combining a template document with a data source'),
    ...
    { label: 'b', marks: 1, prompt: 'In a mail merge document, a merge field such as <<FirstName>> acts as a:',
      response: pick(['A placeholder that is replaced by the actual data value for each record during the merge',
                      'A formatting instruction for the font',
                      'A hyperlink to the data file',
                      'A formula that calculates a value'],
                     'A placeholder that is replaced by the actual data value for each record during the merge'),
...
T.push({
  ...
  parts: [
    ...
    { label: 'b', marks: 1, prompt: 'If the data values in a spreadsheet are changed after a chart has been created, the chart will:',
      response: pick(['Update automatically to reflect the new values',
                      'Need to be deleted and redrawn',
                      'Display the old values permanently',
