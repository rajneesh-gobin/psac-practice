...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g8m-con-005', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["Two sides and the included angle","Two angles and one included side","Three sides and no angles at all","Three angles and no sides at all"],
  ...
  makeMCQ({ id:'g8m-con-006', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["Two angles and the included side","Two sides and the included angle","Three angles and no sides at all","Three sides and no angles at all"],
  ...
  makeMCQ({ id:'g8m-con-008', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["To mark the exact distances of the other two sides","To draw accurate right angles at each end of the base","To measure the size of the angles inside the triangle","To erase any mistakes made while drawing the base line"], answer:'To mark the exact distances of the other two sides',
  ...
  makeMCQ({ id:'g8m-con-027', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["Draw a 40° angle at one end using a protractor, then mark 7 cm along the new ray","Draw a 7 cm arc from each end of the base and join where the two arcs meet","Measure 40° from the midpoint of the base, then join that point to both ends","Draw the third side straight away without measuring either angle or length"], answer:'Draw a 40° angle at one end using a protractor, then mark 7 cm along the new ray',
  ...
  makeMCQ({ id:'g8m-con-030', chapterId:'g8m-constructions', difficulty:3,
    ...
    options:["SSA (two sides and a non-included angle)","SSS (all three sides of the triangle)","ASA (two angles and the included side)","SAS (two sides and the included angle)"],
  ...
  makeMCQ({ id:'g8m-con-058', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["To ensure the arc is the correct radius (side length)","So that the protractor can still be used afterwards","To check that the triangle inequality is satisfied","To make the arc look neat and evenly drawn on paper"], answer:'To ensure the arc is the correct radius (side length)',
  ...
  makeMCQ({ id:'g8m-con-074', chapterId:'g8m-constructions', difficulty:2,
    ...
    options:["Draw ∠A = 50° at A with a protractor, then mark C at 3 cm along that ray","Draw the perpendicular bisector of AB, then mark C where it crosses","Draw any convenient angle at B, then measure 3 cm from there to find C","Extend AB by a further 3 cm and call the new endpoint C of the triangle"],
  ...
  makeMCQ({ id:'g8m-con-075', chapterId:'g8m-constructions', difficulty:3,
    ...
    options:["SSA (two sides and a non-included angle)","ASA (two angles and the included side)","SAS (two sides and the included angle)","SSS (all three sides of the triangle)"],
    answer:'SSA (two sides and a non-included angle)',
  ...
  makeMCQ({ id:'g8m-con-084', chapterId:'g8m-constructions', difficulty:3,
    ...
    options:["Inaccurate arc radius from incorrect compass setting","The compass was opened far too wide at the start","The wrong type of triangle was drawn altogether","The wrong scale was used for the whole drawing"],
