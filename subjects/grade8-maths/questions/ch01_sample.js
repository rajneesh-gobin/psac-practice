'use strict';
// Grade 8 Mathematics — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g8m-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g8m-samp-001', chapterId:'g8m-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 8 Maths questions.',
    explanation:'Placeholder question for the Grade 8 Mathematics pack.' })
