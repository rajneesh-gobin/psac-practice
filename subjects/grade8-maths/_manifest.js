'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 8 — Mathematics   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g8m-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G8M_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g8m-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
