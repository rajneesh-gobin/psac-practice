'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 8 — History & Geography   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g8h-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G8HG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g8h-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
