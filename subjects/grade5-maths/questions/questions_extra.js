...
const EXTRA = [
  ...
  // ════════════ NUMERATION ════════════
  makeMCQ({ id:'N09', chapterId:'numeration', subsection:'words_digits', difficulty:1,
  ...
  makeNum({ id:'N10', chapterId:'numeration', subsection:'place_value', difficulty:1,
  ...
  makeMCQ({ id:'N11', chapterId:'numeration', subsection:'ordering', difficulty:2,
  ...
  makeNum({ id:'N12', chapterId:'numeration', subsection:'rounding', difficulty:2,
  ...
  makeNum({ id:'N13', chapterId:'numeration', subsection:'place_value', difficulty:2,
  ...
  makeMCQ({ id:'N14', chapterId:'numeration', subsection:'place_value', difficulty:3,
  ...
  makeNum({ id:'N15', chapterId:'numeration', subsection:'words_digits', difficulty:3,
  ...
  makeNum({ id:'N16', chapterId:'numeration', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ FOUR OPERATIONS ════════════
  makeNum({ id:'F10', chapterId:'four_ops', subsection:'addition', difficulty:1,
  ...
  makeNum({ id:'F11', chapterId:'four_ops', subsection:'addition', difficulty:1,
  ...
  makeNum({ id:'F12', chapterId:'four_ops', subsection:'multiplication', difficulty:2,
  ...
  makeNum({ id:'F13', chapterId:'four_ops', subsection:'division', difficulty:2,
    question:'Calculate: <b>6,384 ÷ 8</b>',
    answer:'798',
    hint:'Use long division. 63÷8=7 r7. 78÷8=9 r6. 64÷8=8.',
    explanation:'6,384 ÷ 8 = <b>798</b>.' }),

  makeMCQ({ id:'F14', chapterId:'four_ops', subsection:'division', difficulty:3,
  ...
  makeNum({ id:'F16', chapterId:'four_ops', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'F17', chapterId:'four_ops', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ SQUARE NUMBERS ════════════
  makeNum({ id:'S09', chapterId:'square_nums', subsection:'square_nums', difficulty:1,
    question:'What is <b>12²</b>?',
    answer:'144',
    hint:'12² = 12 × 12.',
    explanation:'12 × 12 = <b>144</b>.' }),

  makeMCQ({ id:'S10', chapterId:'square_nums', subsection:'square_nums', difficulty:1,
  ...
  makeNum({ id:'S12', chapterId:'square_nums', subsection:'patterns', difficulty:2,
  ...
  makeMCQ({ id:'S13', chapterId:'square_nums', subsection:'patterns', difficulty:3,
  ...
  makeNum({ id:'S14', chapterId:'square_nums', subsection:'square_nums', difficulty:4,
  ...
  // ════════════ GEOMETRY ════════════
  makeMCQ({ id:'G09', chapterId:'geometry', subsection:'symmetry', difficulty:1,
  ...
  makeMCQ({ id:'G11', chapterId:'geometry', subsection:'directions', difficulty:2,
  ...
  makeMCQ({ id:'G12', chapterId:'geometry', subsection:'2d_shapes', difficulty:2,
  ...
  makeNum({ id:'G13', chapterId:'geometry', subsection:'angles', difficulty:3,
  ...
  makeNum({ id:'G14', chapterId:'geometry', subsection:'directions', difficulty:3,
  ...
  makeMCQ({ id:'G15', chapterId:'geometry', subsection:'angles', difficulty:4,
  ...
  makeNum({ id:'G16', chapterId:'geometry', subsection:'symmetry', difficulty:4,
  ...
  // ════════════ FRACTIONS ════════════
  makeMCQ({ id:'FR09', chapterId:'fractions', subsection:'equivalent', difficulty:1,
  ...
  makeMCQ({ id:'FR10', chapterId:'fractions', subsection:'fraction_of', difficulty:1,
  ...
  makeNum({ id:'FR11', chapterId:'fractions', subsection:'add_sub', difficulty:2,
  ...
  makeNum({ id:'FR12', chapterId:'fractions', subsection:'proper_improper', difficulty:2,
  ...
  makeNum({ id:'FR13', chapterId:'fractions', subsection:'add_sub', difficulty:3,
  ...
  makeNum({ id:'FR14', chapterId:'fractions', subsection:'add_sub', difficulty:3,
    question:'Calculate: <b>3/4 × 60</b>',
    answer:'45',
    hint:'First ÷ 4 (to get 1/4), then × 3 (to get 3/4). 60 ÷ 4 = 15, then 15 × 3.',
    explanation:'60 ÷ 4 = 15. 15 × 3 = <b>45</b>.' }),

  makeNum({ id:'FR15', chapterId:'fractions', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'FR16', chapterId:'fractions', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'D12', chapterId:'decimals', subsection:'place_value', difficulty:3,
  ...
  makeNum({ id:'D13', chapterId:'decimals', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ POWERS ════════════
  makeNum({ id:'P08', chapterId:'powers', subsection:'calculate', difficulty:1,
    question:'Calculate: <b>4²</b>',
    answer:'16',
    hint:'4² = 4 × 4.',
    explanation:'4 × 4 = <b>16</b>.' }),

  makeNum({ id:'P09', chapterId:'powers', subsection:'calculate', difficulty:2,
    question:'Calculate: <b>5² + 4²</b>',
    answer:'41',
    hint:'Calculate each power separately: 5²=25, 4²=16. Then add.',
    explanation:'5² = 25 and 4² = 16. 25 + 16 = <b>41</b>.' }),

  makeNum({ id:'P10', chapterId:'powers', subsection:'calculate', difficulty:2,
  ...
  makeMCQ({ id:'P11', chapterId:'powers', subsection:'calculate', difficulty:3,
  ...
  makeNum({ id:'P12', chapterId:'powers', subsection:'notation', difficulty:4,
  ...
  // ════════════ AVERAGE ════════════
  makeNum({ id:'A07', chapterId:'average', subsection:'mean', difficulty:1,
  ...
  makeNum({ id:'A08', chapterId:'average', subsection:'mean', difficulty:2,
  ...
  makeNum({ id:'A09', chapterId:'average', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'A10', chapterId:'average', subsection:'mean', difficulty:3,
  ...
  makeNum({ id:'A11', chapterId:'average', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ RATIO ════════════
  makeMCQ({ id:'R07', chapterId:'ratio', subsection:'equivalent', difficulty:1,
  ...
  makeNum({ id:'R08', chapterId:'ratio', subsection:'writing', difficulty:2,
  ...
  makeNum({ id:'R09', chapterId:'ratio', subsection:'writing', difficulty:2,
  ...
  makeNum({ id:'R10', chapterId:'ratio', subsection:'dividing', difficulty:3,
  ...
  makeNum({ id:'R11', chapterId:'ratio', subsection:'dividing', difficulty:4,
  ...
  makeMCQ({ id:'R12', chapterId:'ratio', subsection:'writing', difficulty:3,
  ...
  // ════════════ LENGTH ════════════
  makeNum({ id:'L07', chapterId:'length', subsection:'conversion', difficulty:1,
  ...
  makeNum({ id:'L08', chapterId:'length', subsection:'conversion', difficulty:2,
  ...
  makeNum({ id:'L09', chapterId:'length', subsection:'perimeter', difficulty:3,
  ...
  makeNum({ id:'L10', chapterId:'length', subsection:'perimeter', difficulty:4,
  ...
  // ════════════ AREA ════════════
  makeNum({ id:'AR07', chapterId:'area', subsection:'rectangle', difficulty:1,
  ...
  makeNum({ id:'AR08', chapterId:'area', subsection:'rectangle', difficulty:2,
  ...
  makeNum({ id:'AR09', chapterId:'area', subsection:'triangle', difficulty:3,
  ...
  makeNum({ id:'AR10', chapterId:'area', subsection:'rectangle', difficulty:4,
  ...
  // ════════════ CAPACITY ════════════
  makeNum({ id:'C06', chapterId:'capacity', subsection:'operations', difficulty:1,
    question:'Complete: <b>1 L = ___ cL</b>',
    answer:'100',
    hint:'cL = centilitre. There are 100 centilitres in 1 litre.',
    explanation:'<b>1 L = 100 cL</b>.' }),

  makeNum({ id:'C07', chapterId:'capacity', subsection:'conversion', difficulty:2,
  ...
  makeNum({ id:'C08', chapterId:'capacity', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'C09', chapterId:'capacity', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ MASS ════════════
  makeNum({ id:'M06', chapterId:'mass', subsection:'conversion', difficulty:1,
  ...
  makeNum({ id:'M07', chapterId:'mass', subsection:'operations', difficulty:2,
  ...
  makeNum({ id:'M08', chapterId:'mass', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'M09', chapterId:'mass', subsection:'word_probs', difficulty:4,
  ...
  // ════════════ MONEY ════════════
  makeNum({ id:'MO08', chapterId:'money', subsection:'operations', difficulty:1,
  ...
  makeNum({ id:'MO09', chapterId:'money', subsection:'discount', difficulty:2,
  ...
  makeNum({ id:'MO10', chapterId:'money', subsection:'profit_loss', difficulty:2,
  ...
  makeNum({ id:'MO11', chapterId:'money', subsection:'profit_loss', difficulty:3,
  ...
  makeNum({ id:'MO12', chapterId:'money', subsection:'profit_loss', difficulty:4,
  ...
  makeNum({ id:'MO13', chapterId:'money', subsection:'profit_loss', difficulty:4,
  ...
  // ════════════ TIME ════════════
  makeNum({ id:'T07', chapterId:'time', subsection:'reading', difficulty:1,
    question:'Complete: <b>1 minute = ___ seconds</b>',
    answer:'60',
    hint:'There are 60 seconds in every minute.',
    explanation:'<b>1 minute = 60 seconds</b>.' }),

  makeNum({ id:'T08', chapterId:'time', subsection:'conversion', difficulty:2,
  ...
  makeNum({ id:'T09', chapterId:'time', subsection:'reading', difficulty:2,
  ...
  makeNum({ id:'T10', chapterId:'time', subsection:'duration', difficulty:3,
  ...
  makeNum({ id:'T11', chapterId:'time', subsection:'conversion', difficulty:3,
  ...
  makeNum({ id:'T12', chapterId:'time', subsection:'duration', difficulty:4,
  ...
  // ════════════ GRAPHS ════════════
  makeMCQ({ id:'GR06', chapterId:'graphs', subsection:'pictogram', difficulty:1,
  ...
  makeNum({ id:'GR08', chapterId:'graphs', subsection:'pictogram', difficulty:3,
  ...
  makeNum({ id:'GR09', chapterId:'graphs', subsection:'mean', difficulty:3,
  ...
  makeMCQ({ id:'GR10', chapterId:'graphs', subsection:'pictogram', difficulty:4,
...
// ── DYNAMIC GENERATORS: moved to ../_manifest.js ─────────────────────────────
// Six generators (geometry, length, time, ratio, square_nums, decimals) used to
// live here behind `Object.assign(GENERATORS, …)`. `GENERATORS` is not a global
// any file defines, so that line threw a ReferenceError on every load and none
// of them ever ran.
//
// They now sit in G5M_GENERATORS in the pack manifest, which is where they have
// to be: in production the browser fetches question files as JSON from
// netlify/functions/questions, so NOTHING in a questions/*.js file is executed
// as a script in the browser. Only manifests are. Put a generator here and it
// can never run, however correct the code is.
console.log(`✅ Extra questions loaded. Total pool: ${STATIC_QUESTIONS.length} static questions.`);
