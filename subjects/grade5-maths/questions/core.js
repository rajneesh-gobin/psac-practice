...
How many children prefer <b>Mango</b>?`,
  ...
  makeNum({ id:'GR04', chapterId:'graphs', subsection:'mean', difficulty:3,
    question:'<svg class="q-chart" viewBox="0 0 386 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="193" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Marks by subject</text><path d="M64 34V186H372" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M64 186H372M64 156H372M64 125H372M64 95H372M64 64H372M64 34H372" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="56" y="190">0</text><text x="56" y="160">20</text><text x="56" y="129">40</text><text x="56" y="99">60</text><text x="56" y="68">80</text><text x="56" y="38">100</text></g><rect x="76" y="64" width="36" height="122" rx="3" fill="#3b82f6"/><rect x="136" y="80" width="36" height="106" rx="3" fill="#f59e0b"/><rect x="196" y="95" width="36" height="91" rx="3" fill="#10b981"/><rect x="256" y="110" width="36" height="76" rx="3" fill="#ef4444"/><rect x="316" y="87" width="36" height="99" rx="3" fill="#8b5cf6"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="94" y="203">Maths</text><text x="94" y="58">80</text><text x="154" y="203">English</text><text x="154" y="74">70</text><text x="214" y="203">French</text><text x="214" y="89">60</text><text x="274" y="203">Science</text><text x="274" y="104">50</text><text x="334" y="203">History</text><text x="334" y="81">65</text></g></svg>What is the <b>average mark</b> across all subjects?',
    answer:'65',
