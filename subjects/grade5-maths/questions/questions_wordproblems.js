...
const WP = [
  ...
  //  NUMERATION & NOTATION
  // ════════════════════════════════════════════════
  makeNum({ id:'N_W01', chapterId:'numeration', subsection:'expanded', difficulty:3,
  ...
  makeNum({ id:'N_W02', chapterId:'numeration', subsection:'place_value', difficulty:3,
  ...
  makeMCQ({ id:'N_W03', chapterId:'numeration', subsection:'words_digits', difficulty:3,
  ...
  makeNum({ id:'N_W04', chapterId:'numeration', subsection:'rounding', difficulty:4,
  ...
  makeNum({ id:'N_W05', chapterId:'numeration', subsection:'place_value', difficulty:4,
  ...
  makeNum({ id:'N_W06', chapterId:'numeration', subsection:'place_value', difficulty:4,
  ...
  //  FOUR OPERATIONS
  // ════════════════════════════════════════════════
  makeNum({ id:'F_W01', chapterId:'four_ops', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'F_W02', chapterId:'four_ops', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'F_W03', chapterId:'four_ops', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'F_W04', chapterId:'four_ops', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'F_W05', chapterId:'four_ops', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'F_W06', chapterId:'four_ops', subsection:'word_probs', difficulty:4,
  ...
  // ════════════════════════════════════════════════
  makeNum({ id:'S_W01', chapterId:'square_nums', subsection:'square_nums', difficulty:3,
  ...
  makeNum({ id:'S_W02', chapterId:'square_nums', subsection:'square_nums', difficulty:3,
  ...
  makeMCQ({ id:'S_W03', chapterId:'square_nums', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'S_W05', chapterId:'square_nums', subsection:'patterns', difficulty:4,
  ...
  //  GEOMETRY & ANGLES
  // ════════════════════════════════════════════════
  makeNum({ id:'G_W01', chapterId:'geometry', subsection:'angles', difficulty:3,
  ...
  makeNum({ id:'G_W02', chapterId:'geometry', subsection:'angles', difficulty:3,
  ...
  makeMCQ({ id:'G_W03', chapterId:'geometry', subsection:'angles', difficulty:3,
  ...
  makeMCQ({ id:'G_W04', chapterId:'geometry', subsection:'directions', difficulty:4,
  ...
  makeNum({ id:'G_W05', chapterId:'geometry', subsection:'angles', difficulty:4,
  ...
  makeMCQ({ id:'G_W06', chapterId:'geometry', subsection:'directions', difficulty:4,
  ...
  //  FRACTIONS
  // ════════════════════════════════════════════════
  makeNum({ id:'FR_W01', chapterId:'fractions', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'FR_W02', chapterId:'fractions', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'FR_W03', chapterId:'fractions', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'FR_W04', chapterId:'fractions', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'FR_W05', chapterId:'fractions', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'FR_W06', chapterId:'fractions', subsection:'word_probs', difficulty:4,
  ...
  //  DECIMALS
  // ════════════════════════════════════════════════
  makeNum({ id:'D_W01', chapterId:'decimals', subsection:'operations', difficulty:3,
  ...
  makeNum({ id:'D_W02', chapterId:'decimals', subsection:'operations', difficulty:3,
  ...
  makeNum({ id:'D_W03', chapterId:'decimals', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'D_W04', chapterId:'decimals', subsection:'word_probs', difficulty:4,
  ...
  //  POWERS & EXPONENTS
  // ════════════════════════════════════════════════
  makeNum({ id:'P_W01', chapterId:'powers', subsection:'notation', difficulty:3,
  ...
  makeNum({ id:'P_W02', chapterId:'powers', subsection:'word_probs', difficulty:3,
  ...
  makeMCQ({ id:'P_W03', chapterId:'powers', subsection:'calculate', difficulty:3,
  ...
  makeNum({ id:'P_W04', chapterId:'powers', subsection:'calculate', difficulty:4,
  ...
  makeNum({ id:'P_W05', chapterId:'powers', subsection:'calculate', difficulty:4,
  ...
  makeMCQ({ id:'P_W06', chapterId:'powers', subsection:'calculate', difficulty:4,
  ...
  makeNum({ id:'P_W07', chapterId:'powers', subsection:'notation', difficulty:4,
  ...
  //  AVERAGE
  // ════════════════════════════════════════════════
  makeNum({ id:'A_W01', chapterId:'average', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'A_W02', chapterId:'average', subsection:'mean', difficulty:3,
  ...
  makeNum({ id:'A_W03', chapterId:'average', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'A_W04', chapterId:'average', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'A_W05', chapterId:'average', subsection:'missing', difficulty:4,
  ...
  makeNum({ id:'A_W06', chapterId:'average', subsection:'word_probs', difficulty:4,
  ...
  //  RATIO & PROPORTION
  // ════════════════════════════════════════════════
  makeNum({ id:'R_W01', chapterId:'ratio', subsection:'dividing', difficulty:3,
  ...
  makeNum({ id:'R_W02', chapterId:'ratio', subsection:'writing', difficulty:3,
  ...
  makeNum({ id:'R_W03', chapterId:'ratio', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'R_W04', chapterId:'ratio', subsection:'dividing', difficulty:4,
  ...
  makeNum({ id:'R_W05', chapterId:'ratio', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'R_W06', chapterId:'ratio', subsection:'word_probs', difficulty:4,
  ...
  //  LENGTH & PERIMETER
  // ════════════════════════════════════════════════
  makeNum({ id:'L_W01', chapterId:'length', subsection:'perimeter', difficulty:3,
  ...
  makeNum({ id:'L_W02', chapterId:'length', subsection:'perimeter', difficulty:3,
  ...
  makeNum({ id:'L_W03', chapterId:'length', subsection:'perimeter', difficulty:3,
  ...
  makeNum({ id:'L_W04', chapterId:'length', subsection:'perimeter', difficulty:4,
  ...
  makeNum({ id:'L_W05', chapterId:'length', subsection:'conversion', difficulty:4,
  ...
  //  AREA
  // ════════════════════════════════════════════════
  makeNum({ id:'AR_W01', chapterId:'area', subsection:'rectangle', difficulty:3,
  ...
  makeNum({ id:'AR_W02', chapterId:'area', subsection:'rectangle', difficulty:3,
  ...
  makeNum({ id:'AR_W03', chapterId:'area', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'AR_W04', chapterId:'area', subsection:'rectangle', difficulty:4,
  ...
  //  CAPACITY
  // ════════════════════════════════════════════════
  makeNum({ id:'C_W01', chapterId:'capacity', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'C_W02', chapterId:'capacity', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'C_W03', chapterId:'capacity', subsection:'operations', difficulty:4,
  ...
  makeNum({ id:'C_W04', chapterId:'capacity', subsection:'conversion', difficulty:4,
  ...
  //  MASS
  // ════════════════════════════════════════════════
  makeNum({ id:'M_W01', chapterId:'mass', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'M_W02', chapterId:'mass', subsection:'word_probs', difficulty:3,
  ...
  makeNum({ id:'M_W03', chapterId:'mass', subsection:'operations', difficulty:4,
  ...
  makeNum({ id:'M_W04', chapterId:'mass', subsection:'operations', difficulty:4,
  ...
  //  MONEY & PROFIT / LOSS
  // ════════════════════════════════════════════════
  makeNum({ id:'MO_W01', chapterId:'money', subsection:'profit_loss', difficulty:3,
  ...
  makeNum({ id:'MO_W02', chapterId:'money', subsection:'profit_loss', difficulty:3,
  ...
  makeNum({ id:'MO_W03', chapterId:'money', subsection:'profit_loss', difficulty:4,
  ...
  makeNum({ id:'MO_W04', chapterId:'money', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'MO_W05', chapterId:'money', subsection:'profit_loss', difficulty:4,
  ...
  //  TIME
  // ════════════════════════════════════════════════
  makeNum({ id:'T_W01', chapterId:'time', subsection:'duration', difficulty:3,
  ...
  makeNum({ id:'T_W02', chapterId:'time', subsection:'duration', difficulty:3,
  ...
  makeNum({ id:'T_W03', chapterId:'time', subsection:'duration', difficulty:3,
  ...
  makeNum({ id:'T_W04', chapterId:'time', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'T_W05', chapterId:'time', subsection:'word_probs', difficulty:4,
  ...
  makeNum({ id:'T_W06', chapterId:'time', subsection:'word_probs', difficulty:4,
  ...
  //  GRAPHS & DATA
  // ════════════════════════════════════════════════
  makeMCQ({ id:'GR_W01', chapterId:'graphs', subsection:'bar_chart', difficulty:3,
    question:'<svg class="q-chart" viewBox="0 0 386 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="193" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Fruit sales this week</text><path d="M64 34V186H372" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M64 186H372M64 148H372M64 110H372M64 72H372M64 34H372" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="56" y="190">0</text><text x="56" y="152">100</text><text x="56" y="114">200</text><text x="56" y="76">300</text><text x="56" y="38">400</text></g><rect x="76" y="95" width="36" height="91" rx="3" fill="#3b82f6"/><rect x="136" y="118" width="36" height="68" rx="3" fill="#f59e0b"/><rect x="196" y="64" width="36" height="122" rx="3" fill="#10b981"/><rect x="256" y="140" width="36" height="46" rx="3" fill="#ef4444"/><rect x="316" y="110" width="36" height="76" rx="3" fill="#8b5cf6"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="94" y="203">Apple</text><text x="94" y="89">240</text><text x="154" y="203">Banana</text><text x="154" y="112">180</text><text x="214" y="203">Mango</text><text x="214" y="58">320</text><text x="274" y="203">Orange</text><text x="274" y="134">120</text><text x="334" y="203">Pineapple</text><text x="334" y="104">200</text></g></svg>Which fruit sold <b>twice as many</b> as Orange?',
  ...
  makeNum({ id:'GR_W02', chapterId:'graphs', subsection:'pictogram', difficulty:3,
...
How many books did <b>Carl and Dina together</b> read?`,
  ...
  makeNum({ id:'GR_W03', chapterId:'graphs', subsection:'mean', difficulty:3,
    question:'<svg class="q-chart" viewBox="0 0 386 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="193" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Visitors to the park</text><path d="M64 34V186H372" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M64 186H372M64 148H372M64 110H372M64 72H372M64 34H372" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="56" y="190">0</text><text x="56" y="152">50</text><text x="56" y="114">100</text><text x="56" y="76">150</text><text x="56" y="38">200</text></g><rect x="76" y="95" width="36" height="91" rx="3" fill="#3b82f6"/><rect x="136" y="114" width="36" height="72" rx="3" fill="#f59e0b"/><rect x="196" y="80" width="36" height="106" rx="3" fill="#10b981"/><rect x="256" y="121" width="36" height="65" rx="3" fill="#ef4444"/><rect x="316" y="64" width="36" height="122" rx="3" fill="#8b5cf6"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="94" y="203">Mon</text><text x="94" y="89">120</text><text x="154" y="203">Tue</text><text x="154" y="108">95</text><text x="214" y="203">Wed</text><text x="214" y="74">140</text><text x="274" y="203">Thu</text><text x="274" y="115">85</text><text x="334" y="203">Fri</text><text x="334" y="58">160</text></g></svg>What is the <b>average</b> number of visitors per day?',
    answer:'120',
    hint:'Add all 5 days, then divide by 5.',
    explanation:'120+95+140+85+160=600. 600÷5=<b>120 visitors</b>.' }),

  makeMCQ({ id:'GR_W04', chapterId:'graphs', subsection:'bar_chart', difficulty:4,
  ...
  makeNum({ id:'GR_W05', chapterId:'graphs', subsection:'mean', difficulty:4,
