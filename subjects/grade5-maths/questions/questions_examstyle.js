...
const EX = [
  ...
  makeNum({ id:'EGR01', chapterId:'graphs', subsection:'bar_chart', difficulty:2,
    question:'<svg class="q-chart" viewBox="0 0 380 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="190" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Water bottles sold by Mr Kumar</text><path d="M58 34V186H366" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M58 186H366M58 148H366M58 110H366M58 72H366M58 34H366" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="50" y="190">0</text><text x="50" y="152">5</text><text x="50" y="114">10</text><text x="50" y="76">15</text><text x="50" y="38">20</text></g><rect x="70" y="80" width="36" height="106" rx="3" fill="#3b82f6"/><rect x="130" y="110" width="36" height="76" rx="3" fill="#f59e0b"/><rect x="190" y="140" width="36" height="46" rx="3" fill="#10b981"/><rect x="250" y="125" width="36" height="61" rx="3" fill="#ef4444"/><rect x="310" y="49" width="36" height="137" rx="3" fill="#8b5cf6"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="88" y="203">Mon</text><text x="88" y="74">14</text><text x="148" y="203">Tue</text><text x="148" y="104">10</text><text x="208" y="203">Wed</text><text x="208" y="134">6</text><text x="268" y="203">Thu</text><text x="268" y="119">8</text><text x="328" y="203">Fri</text><text x="328" y="43">18</text></g></svg>On which day did Mr Kumar sell the <b>least</b> number of bottles?<br><i>Type the day name.</i>',
  ...
  makeNum({ id:'EGR03', chapterId:'graphs', subsection:'bar_chart', difficulty:3,
    question:'<svg class="q-chart" viewBox="0 0 368 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="184" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">Water bottles sold by Mr Kumar</text><path d="M58 34V186H354" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M58 186H354M58 135H354M58 85H354M58 34H354" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="50" y="190">0</text><text x="50" y="139">10</text><text x="50" y="89">20</text><text x="50" y="38">30</text></g><rect x="73" y="115" width="42" height="71" rx="3" fill="#3b82f6"/><rect x="145" y="135" width="42" height="51" rx="3" fill="#f59e0b"/><rect x="217" y="156" width="42" height="30" rx="3" fill="#10b981"/><rect x="289" y="145" width="42" height="41" rx="3" fill="#ef4444"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="94" y="203">Mon</text><text x="94" y="109">14</text><text x="166" y="203">Tue</text><text x="166" y="129">10</text><text x="238" y="203">Wed</text><text x="238" y="150">6</text><text x="310" y="203">Thu</text><text x="310" y="139">8</text></g></svg>Mr Kumar sold <b>three times as many</b> bottles on Friday as on Wednesday.<br>How many did he sell on <b>Friday</b>?',
    answer:'18',
  ...
  makeMCQ({ id:'EGR04', chapterId:'graphs', subsection:'bar_chart', difficulty:3,
    question:'<svg class="q-chart" viewBox="0 0 368 218" font-family="sans-serif"><rect width="100%" height="100%" rx="10" fill="#fff"/><text x="184" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="#1e293b">How pupils travel to school</text><path d="M58 34V186H354" stroke="#334155" stroke-width="1.5" fill="none"/><path d="M58 186H354M58 148H354M58 110H354M58 72H354M58 34H354" stroke="#e5e7eb"/><g font-size="10" fill="#64748b" text-anchor="end"><text x="50" y="190">0</text><text x="50" y="152">5</text><text x="50" y="114">10</text><text x="50" y="76">15</text><text x="50" y="38">20</text></g><rect x="73" y="64" width="42" height="122" rx="3" fill="#3b82f6"/><rect x="145" y="95" width="42" height="91" rx="3" fill="#f59e0b"/><rect x="217" y="125" width="42" height="61" rx="3" fill="#10b981"/><rect x="289" y="110" width="42" height="76" rx="3" fill="#ef4444"/><g font-size="11" fill="#334155" text-anchor="middle"><text x="94" y="203">Van</text><text x="94" y="58">16</text><text x="166" y="203">Bus</text><text x="166" y="89">12</text><text x="238" y="203">Car</text><text x="238" y="119">8</text><text x="310" y="203">Foot</text><text x="310" y="104">10</text></g></svg>Which means of transport is used by <b>most</b> pupils?',
