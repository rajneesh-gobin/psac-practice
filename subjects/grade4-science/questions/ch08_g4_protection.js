...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4sc-protect-001', chapterId:'g4sci-protect', subsection:'pollution', difficulty:1,
    question:'Which human activity HARMS the environment?',
    options:[
      'Planting trees in bare areas',
      'Dumping rubbish on the beach',
      'Picking up litter from the road',
      'Using a compost bin'
    ],
    answer:'Dumping rubbish on the beach',
    hint:'Which action makes the environment dirty or damaged?',
    explanation:'<b>Dumping rubbish on the beach</b> harms the environment. It pollutes the sea, harms marine animals (fish and turtles can swallow plastic), and destroys the natural beauty of the coast. Other harmful activities include cutting down trees, burning waste, and pouring chemicals into rivers.' }),

  makeMCQ({ id:'g4sc-protect-002', chapterId:'g4sci-protect', subsection:'pollution', difficulty:1,
  ...
  makeTF({ id:'g4sc-protect-003', chapterId:'g4sci-protect', subsection:'deforestation', difficulty:1,
    question:'Cutting down ALL the trees in a forest helps the environment.',
    answer:false,
    hint:'What do trees provide for animals, soil and the air?',
    explanation:'<b>False.</b> Cutting down all trees (<b>deforestation</b>) harms the environment. Trees: (1) provide homes and food for animals, (2) hold soil together (preventing erosion), (3) absorb carbon dioxide and release oxygen, (4) keep the climate stable. Deforestation destroys habitats, worsens flooding, and increases air pollution.' }),

  makeMCQ({ id:'g4sc-protect-004', chapterId:'g4sci-protect', subsection:'pollution', difficulty:1,
  ...
  makeMCQ({ id:'g4sc-protect-006', chapterId:'g4sci-protect', subsection:'pollution', difficulty:2,
  ...
  makeMCQ({ id:'g4sc-protect-007', chapterId:'g4sci-protect', subsection:'pollution', difficulty:2,
    question:'Burning rubbish in an open space causes which TYPE of pollution?',
    options:['Only water pollution','Only land pollution','Mainly air pollution','No pollution at all'],
    answer:'Mainly air pollution',
    hint:'What does burning rubbish produce?',
    explanation:'Burning rubbish releases <b>smoke and harmful gases</b> (including carbon dioxide, carbon monoxide and toxic chemicals) into the air, causing mainly <b>air pollution</b>. This is why it is better to separate rubbish and recycle or compost it rather than burning it.' }),

  makeMCQ({ id:'g4sc-protect-008', chapterId:'g4sci-protect', subsection:'pollution', difficulty:2,
    question:'How does air pollution AFFECT people\'s health?',
    options:[
  ...
  makeTF({ id:'g4sc-protect-009', chapterId:'g4sci-protect', subsection:'pollution', difficulty:1,
    question:'Picking up litter from the beach is a way to help protect the environment.',
    answer:true,
    hint:'What happens to the beach if everyone picks up their litter?',
    explanation:'<b>True.</b> Picking up litter from the beach is a simple and effective way to protect the environment. It prevents rubbish from entering the sea, where it can harm marine animals (especially turtles and fish that swallow plastic). Clean beaches also protect tourism and biodiversity in Mauritius.' }),

  makeMCQ({ id:'g4sc-protect-010', chapterId:'g4sci-protect', subsection:'recycling', difficulty:2,
    question:'The 3 Rs of conservation are: REDUCE, REUSE and RECYCLE. What does REDUCE mean?',
    options:[
      'Use MORE things than you need',
      'Use LESS of something to produce less waste',
      'Buy old things from a second-hand shop',
      'Throw things in a different bin'
    ],
  ...
  makeMCQ({ id:'g4sc-protect-011', chapterId:'g4sci-protect', subsection:'recycling', difficulty:2,
    question:'What does REUSE mean in the 3 Rs?',
    options:[
      'Throw something away after using it once',
      'Use something again instead of throwing it away',
      'Burn things to make new ones',
      'Buy new items instead of old ones'
    ],
    answer:'Use something again instead of throwing it away',
    hint:'Reuse = use again.',
    explanation:'<b>REUSE</b> means using something <b>again</b> rather than throwing it away. Examples: use a cloth bag instead of a new plastic bag each time; wash and refill water bottles; donate old clothes instead of throwing them away; use both sides of paper. Reuse extends the life of products and reduces waste.' }),

  makeMCQ({ id:'g4sc-protect-012', chapterId:'g4sci-protect', subsection:'pollution', difficulty:2,
  ...
  makeMCQ({ id:'g4sc-protect-013', chapterId:'g4sci-protect', subsection:'deforestation', difficulty:2,
  ...
  makeMCQ({ id:'g4sc-protect-014', chapterId:'g4sci-protect', subsection:'pollution', difficulty:3,
    question:'A class notices that a nearby river has become brown and smelly, and the fish have died. What is the MOST LIKELY cause?',
    options:[
  ...
  makeTF({ id:'g4sc-protect-015', chapterId:'g4sci-protect', subsection:'why_protect', difficulty:2,
  ...
  makeMCQ({ id:'g4sc-protect-017', chapterId:'g4sci-protect', subsection:'pollution', difficulty:3,
    question:'Which choice BEST reduces LAND POLLUTION from food waste?',
    options:[
      'Throw food scraps in a plastic bag and bury them',
      'Burn food scraps to get rid of them quickly',
      'Compost food scraps to make natural fertiliser for plants',
      'Flush food scraps down the toilet'
    ],
    answer:'Compost food scraps to make natural fertiliser for plants',
    hint:'Composting turns organic waste into something useful.',
    explanation:'<b>Composting</b> is the best option. Food scraps (vegetable peels, fruit, leaves) break down naturally in a compost bin to form <b>natural fertiliser (compost)</b> that enriches soil. This reduces waste sent to landfill, avoids the air pollution of burning, and avoids the water pollution of flushing. Composting is an excellent example of <b>reducing and reusing</b> waste.' }),

  makeMCQ({ id:'g4sc-protect-018', chapterId:'g4sci-protect', subsection:'pollution', difficulty:3,
    question:'A factory is releasing dark smoke and dumping waste in a nearby river. Which types of pollution does this cause?',
    options:[
      'Only air pollution',
  ...
  makeMCQ({ id:'g4sc-protect-019', chapterId:'g4sci-protect', subsection:'recycling', difficulty:4,
