...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4s-ani-001', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:1,
  ...
  makeMCQ({ id:'g4s-ani-002', chapterId:'g4sci-animals', subsection:'habitats', difficulty:1,
  ...
  makeTF({ id:'g4s-ani-003', chapterId:'g4sci-animals', subsection:'endangered', difficulty:1,
  ...
  makeMCQ({ id:'g4s-ani-004', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:1,
  ...
  makeMCQ({ id:'g4s-ani-005', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-006', chapterId:'g4sci-animals', subsection:'habitats', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-007', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-008', chapterId:'g4sci-animals', subsection:'habitats', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-009', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:3,
  ...
  makeMCQ({ id:'g4s-ani-010', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:4,
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4s-ani-011', chapterId:'g4sci-animals', subsection:'habitats', difficulty:1,
    question:'An animal WITH a backbone (spine) is called a:',
    options:['Invertebrate','Vertebrate','Herbivore','Predator'],
    answer:'Vertebrate',
    hint:'"Vertebra" is the name for a single bone of the spine. Which option is built from that word, and which adds a prefix that reverses it?',
  ...
  makeTF({ id:'g4s-ani-012', chapterId:'g4sci-animals', subsection:'classification', difficulty:1,
  ...
  makeMCQ({ id:'g4s-ani-014', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-015', chapterId:'g4sci-animals', subsection:'food_chains', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-016', chapterId:'g4sci-animals', subsection:'endangered', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-017', chapterId:'g4sci-animals', subsection:'endangered', difficulty:2,
  ...
  makeMCQ({ id:'g4s-ani-018', chapterId:'g4sci-animals', subsection:'habitats', difficulty:3,
  ...
  makeMCQ({ id:'g4s-ani-019', chapterId:'g4sci-animals', subsection:'classification', difficulty:4,
  ...
  makeMCQ({ id:'g4s-ani-020', chapterId:'g4sci-animals', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/foodchain.png" alt="a food chain diagram" style="max-height:220px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.12)"></div><b>In the food chain diagram shown, which type of organism is ALWAYS at the START of a food chain?</b>',
  ...
  makeMCQ({ id:'g4s-ani-021', chapterId:'g4sci-animals', subsection:'photos', difficulty:1,
  ...
  makeMCQ({ id:'g4s-ani-023', chapterId:'g4sci-animals', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/food-web.png" alt="a food web diagram" style="max-height:220px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.12)"></div><b>In a food web, energy flows from producers up to consumers. The animal at the TOP of the food web that is not eaten by any other animal is called the:</b>',
