...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g4sci-enr-equ-001', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/clinical-thermometer-38-7.jpg" alt="A science instrument" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What instrument is shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4sci-enr-equ-002', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/weather-station-rain-gauge.jpg" alt="A weather instrument" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What weather instrument is shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4sci-enr-equ-003', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/anemometer.jpg" alt="A weather instrument" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What instrument is shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4sci-enr-equ-004', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/magnifying-glass.jpg" alt="A science tool" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What science tool is shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4sci-enr-equ-005', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/optical-microscope-nikon-alphaphot.jpg" alt="A laboratory instrument" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What laboratory instrument is shown in this picture?</b>',
  ...
  makeMCQ({ id:'g4sci-enr-equ-006', chapterId:'g4sci-enr-equipment', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:14px"><img src="assets/questions/measuring-cylinder-hg.jpg" alt="A laboratory instrument" style="max-height:200px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.18)"></div><b>What laboratory instrument is shown in this picture?</b>',
