'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 2 — Science   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g2s-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G2SC_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g2s-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
