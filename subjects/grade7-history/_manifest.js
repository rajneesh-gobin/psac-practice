'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 7 — History & Geography   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g7h-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G7HG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g7h-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
