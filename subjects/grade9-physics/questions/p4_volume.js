...
const MCQ = [
  ...
  ['g9s-p4-v001', 'scalars_vectors', 1,
   ...
   ["A scalar has magnitude only; a vector has both magnitude and direction","Both scalars and vectors have both a magnitude and a direction of their own","Neither a scalar nor a vector quantity has a direction of its own","A scalar has direction only; a vector has magnitude but no direction"],
  ...
  ['g9s-p4-v015', 'distance_displacement', 1,
   'What is distance?',
   ["The total length of the path travelled, regardless of direction","The straight-line separation between the start and the finish point","How fast an object is moving along its path from start to finish","The change in the speed of an object during the whole journey"],
  ...
  ['g9s-p4-v016', 'distance_displacement', 1,
   ...
   ["The straight-line distance from the starting point to the ending point, including direction","The speed at which a moving object travels, measured in one particular direction only","The change in the acceleration of an object during a journey, including direction","The total length of the whole path travelled, without any reference to direction"],
  ...
  ['g9s-p4-v022', 'distance_displacement', 2,
   ...
   ["Distance includes the full path length; displacement is only the shortest straight line between start and finish","Displacement adds all of the directions together, while distance subtracts them from one another as you go","Distance can take a negative value when you turn back, but displacement can only ever be positive","Distance is always measured in metres, while displacement must always be measured in kilometres"],
  ...
  ['g9s-p4-v058', 'speed_time_graphs', 2,
   ...
   ["The object is accelerating uniformly (constant acceleration)","The object is at rest and is not moving at all (zero speed)","The object is decelerating uniformly (constant deceleration)","The object is moving at a constant speed (zero acceleration)"],
  ...
  ['g9s-p4-v059', 'speed_time_graphs', 2,
   ...
   ["The object is moving at constant speed (zero acceleration)","The object is accelerating steadily (its speed is increasing)","The object is decelerating steadily (its speed is decreasing)","The object is at rest for the whole time (its speed is zero)"],
  ...
  ['g9s-p4-v064', 'speed_time_graphs', 3,
   ...
   ["It is never stationary; but the third phase shows deceleration to 0","Phase 2 (4 to 8 s), where the line of the graph is flat and horizontal","Phase 3 (8 to 10 s), where the line slopes downwards to the time axis","Phase 1 (0 to 4 s), where the line slopes upwards away from the origin"],
  ...
  ['g9s-p4-v071', 'speed_time_graphs', 3,
   ...
   ["Non-uniform acceleration (the rate of acceleration is changing)","Deceleration that is followed immediately by acceleration again","Constant speed throughout (the speed does not change at all here)","Uniform acceleration (the speed rises by equal amounts each second)"],
