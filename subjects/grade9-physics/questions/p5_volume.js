...
const MCQ = [
  ...
  ['g9s-p5-v001', 'circuit_symbols', 1,
   ...
   ["A cell (battery with one element)","A lamp (a bulb that lights up)","A switch (opens or closes a gap)","A resistor (it limits the current)"],
  ...
  ['g9s-p5-v008', 'circuit_symbols', 2,
   ...
   ["A battery (two or more cells in series)","A single cell (with one element only)","A capacitor (it stores electric charge)","A parallel pair of identical resistors"],
  ...
  ['g9s-p5-v009', 'circuit_symbols', 2,
   ...
   ["A wire (conductor) with no resistance","A lamp (which glows when current flows)","A switch (which breaks the circuit)","A resistor (it opposes the current)"],
  ...
  ['g9s-p5-v010', 'circuit_symbols', 3,
   ...
   ["An ammeter must be connected in series, not in parallel, with the component","The cell symbol has been drawn the wrong way round in the circuit diagram itself","An ammeter can never be used in the same circuit as a lamp and a switch together","The switch should have been drawn inside the ammeter symbol, not outside it"],
  ...
  ['g9s-p5-v011', 'circuit_symbols', 2,
   ...
   ["To measure the potential difference across the component without significantly changing the current","To reduce the resistance of the component so that a much larger current can flow through the circuit","To measure the size of the current that is flowing through the component without ever stopping it","To increase the voltage that is supplied to the component by the cell driving the circuit"],
  ...
  ['g9s-p5-v012', 'circuit_symbols', 3,
   ...
   ["Two (the main loop and the voltmeter branch)","It depends on the voltage of the cell that is used","One (only the single main series loop)","Three (one for each meter and one for the lamp)"],
  ...
  ['g9s-p5-v033', 'measuring_current_voltage', 3,
   ...
   ["In parallel with the lamp (across both ends of the lamp)","In series with the ammeter in the main loop of the circuit","In parallel with the switch, across both ends of the switch","Across the two terminals of the cell in the main circuit"],
  ...
  ['g9s-p5-v034', 'measuring_current_voltage', 2,
   ...
   ["So that inserting it in series does not reduce the current it is measuring","So that it is able to handle the very large currents that flow in a circuit","So that it measures the voltage across each component accurately as well","So that it can safely be connected in parallel with any other component"],
  ...
  ['g9s-p5-v035', 'measuring_current_voltage', 2,
   ...
   ["So that it draws no current from the circuit and does not change the voltage it measures","So that it can safely be placed in series inside the main loop of the circuit it is testing","So that it is able to measure the very large currents that flow round the circuit","So that it measures the current passing through the component accurately instead"],
   'So that it draws no current from the circuit and does not change the voltage it measures',
  ...
  ['g9s-p5-v039', 'measuring_current_voltage', 2,
   ...
   ["The ammeter short-circuits the lamp; very large current may damage the ammeter","The circuit works normally, because an ammeter can be placed in parallel safely","The lamp will shine much more brightly than it did before the ammeter was added","The ammeter will accurately measure the resistance of the lamp instead of current"],
  ...
  ['g9s-p5-v041', 'measuring_current_voltage', 2,
   ...
   ["The same, because current is the same everywhere in a series circuit","Different, because the lamp uses up some of the current passing through","Both read zero, because the lamp blocks the current from flowing at all","The one before the lamp reads higher than the one placed after the lamp"],
  ...
  ['g9s-p5-v042', 'measuring_current_voltage', 3,
   ...
   ["The cell has internal resistance, so some voltage is &ldquo;lost&rdquo; inside the cell","The e.m.f. of the cell has permanently dropped from 9 V down to just 8.4 V now","The voltmeter must be faulty and is giving a reading that is far too low","The lamp has increased the total resistance of the whole circuit to infinity"],
  ...
  ['g9s-p5-v043', 'current_voltage_resistance', 1,
   ...
   ["The current through a conductor is directly proportional to the potential difference across it (at constant temperature)","The voltage across a conductor is inversely proportional to the current flowing through it (at constant temperature)","The resistance of a conductor is directly proportional to the length of that conductor (at constant temperature)","The current in a conductor is equal to its resistance multiplied by its temperature (at a constant voltage)"],
  ...
  ['g9s-p5-v056', 'current_voltage_resistance', 3,
   ...
   ["At high voltages the lamp gets hotter; its resistance increases with temperature, reducing the current below the Ohm&rsquo;s Law prediction","The student has made measurement errors at the higher voltages; the graph should really have stayed a perfectly straight line throughout","Ohm&rsquo;s Law only applies to voltages above 100 V, so readings taken at lower voltages cannot be expected to lie on a straight line","At high voltages the resistance of the filament falls as it heats up, so the current rises above the value that Ohm&rsquo;s Law predicts"],
  ...
  ['g9s-p5-v057', 'charge_and_current', 1,
   ...
   ["Q = It (charge = current &times; time)","Q = I + t (charge = current + time)","Q = t &divide; I (charge = time &divide; current)","Q = I &divide; t (charge = current &divide; time)"],
  ...
  ['g9s-p5-v076', 'potential_difference', 2,
   ...
   ["The energy given to each coulomb of charge by the cell","The total amount of charge that is stored inside the cell","The resistance of the materials inside the cell itself","The maximum current that the cell can supply to a circuit"],
  ...
  ['g9s-p5-v078', 'potential_difference', 2,
   ...
   ["1 joule of energy is transferred for every coulomb of charge that moves","1 coulomb of charge is stored up for every joule of energy that is supplied","1 ampere of current flows for every ohm of resistance in that circuit","1 watt of power is used up by each component that is in the circuit"],
  ...
  ['g9s-p5-v082', 'potential_difference', 2,
   ...
   ["It quadruples (W = QV; both Q and V doubled)","It stays the same (W = Q &divide; V; both Q and V doubled)","It doubles (W = Q + V; both Q and V doubled)","It halves (W = V &divide; Q; both Q and V doubled)"],
