'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 9 — History & Geography   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g9h-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G9HG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g9h-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
