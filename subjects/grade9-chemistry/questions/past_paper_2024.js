...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g9s-pp24c-002', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:1,
    ...
    explanation:'The nitrogen atom is joined to <b>three</b> hydrogen atoms, which is why ammonia is written NH<sub>3</sub>. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-003', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:2,
    ...
    explanation:'Aluminium is in Group III, so it loses three electrons and has a valency of <b>3</b> - which is why its oxide is Al<sub>2</sub>O<sub>3</sub>. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-004', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:1,
    ...
    explanation:'One carbon and four hydrogens is written <b>CH<sub>4</sub></b>. The subscript follows the symbol it belongs to, so C<sub>4</sub>H would mean four carbons and one hydrogen. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-005', chapterId:'g9s-c1-atmosphere', subsection:'air_pollutants', difficulty:2,
    ...
    explanation:'<b>Chlorofluorocarbons (CFCs)</b> release chlorine high in the atmosphere, which breaks ozone apart. Sulfur dioxide and oxides of nitrogen cause acid rain instead. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-006', chapterId:'g9s-c1-atmosphere', subsection:'eutrophication', difficulty:2,
    ...
    explanation:'<b>Fertiliser</b> washed into a river adds nitrates and phosphates. Algae grow rapidly, block the light, then die and decay - and the decay uses up the dissolved oxygen, killing the fish. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-007', chapterId:'g9s-c4-metals', subsection:'metals_with_acids', difficulty:2,
    ...
    explanation:'Metal + acid &rarr; salt + <b>hydrogen</b>. Here zinc + hydrochloric acid gives zinc chloride and hydrogen, which is tested with a lighted splint and a squeaky pop. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-008', chapterId:'g9s-c4-metals', subsection:'metals_with_oxygen', difficulty:3,
    ...
    explanation:'<b>Copper</b> is the least reactive here: heated in air it only forms a black coating of copper oxide, without burning or glowing. Magnesium burns with a brilliant white flame, and iron and zinc glow. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-009', chapterId:'g9s-c5-salts', subsection:'neutralisation_in_daily_life', difficulty:2,
    ...
    explanation:'<b>Calcium hydroxide</b> (slaked lime) is a base, so it neutralises acid in the soil and raises the pH. Nitric acid would make the soil more acidic, and the other two are fertilisers. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-010', chapterId:'g9s-c5-salts', subsection:'soluble_insoluble', difficulty:2,
    ...
    explanation:'Most <b>carbonates are insoluble</b>, and magnesium carbonate is one of them. All nitrates dissolve, ammonium compounds all dissolve, and zinc sulfate is soluble too. 📄 NCE 2024 exam.' }),
  ...
  makeMCQ({ id:'g9s-pp24c-011', chapterId:'g9s-c2-mixtures', subsection:'choosing_a_technique', difficulty:2,
    ...
    explanation:'<b>Distillation</b> boils the water off and condenses the vapour back to pure liquid water, leaving the salt behind. Crystallisation would keep the salt and lose the water. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-012', chapterId:'g9s-c2-mixtures', subsection:'choosing_a_technique', difficulty:3,
    ...
    explanation:'Iodine <b>sublimes</b> - it goes from solid to vapour and back to solid without becoming a liquid - while sand does not. Heating the mixture and collecting the deposit separates them. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-013', chapterId:'g9s-c2-mixtures', subsection:'sublimation', difficulty:3,
    ...
    explanation:'An <b>inverted funnel</b> over the dish catches the vapour so it re-solidifies on the cool inside surface, and a <b>cotton wool plug</b> in the stem stops any escaping. Leaving it open loses the product - and iodine vapour is harmful. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-014', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:2,
    ...
    explanation:'Potassium is <b>K</b> (from <i>kalium</i>) and oxygen is <b>O</b>. P is the symbol for phosphorus, which is why potassium cannot use it. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-015', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:3,
    ...
    explanation:'Potassium (valency 1) and oxygen (valency 2) cross over to give <b>K<sub>2</sub>O</b> - two potassium atoms are needed to balance one oxygen atom. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-016', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:3,
    ...
    explanation:'Calcium’s valency of 2 needs <b>two</b> chlorine atoms of valency 1, giving <b>CaCl<sub>2</sub></b>. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-017', chapterId:'g9s-c3-language', subsection:'formulae_of_compounds', difficulty:4,
    ...
    explanation:'Iron (III) has valency 3 and sulfate has valency 2, so crossing over gives two iron and three sulfate groups: <b>Fe<sub>2</sub>(SO<sub>4</sub>)<sub>3</sub></b>. The brackets are essential - without them the 3 would apply only to the oxygen. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-018', chapterId:'g9s-c3-language', subsection:'word_equations', difficulty:2,
    ...
    explanation:'A metal plus oxygen gives a metal <b>oxide</b>, so magnesium + oxygen &rarr; magnesium oxide. Magnesium burns with a brilliant white flame and leaves a white ash. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-019', chapterId:'g9s-c3-language', subsection:'word_equations', difficulty:2,
    ...
    explanation:'Metal + chlorine gives a metal <b>chloride</b>, so the product is aluminium chloride. Names ending in -ate (such as chlorate) contain oxygen as well. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-020', chapterId:'g9s-c3-language', subsection:'word_equations', difficulty:2,
    ...
    explanation:'Hydrogen burns in oxygen to form <b>water</b> (H<sub>2</sub>O). Hydrogen peroxide is H<sub>2</sub>O<sub>2</sub>, a different compound made a different way. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-021', chapterId:'g9s-c1-atmosphere', subsection:'greenhouse_gases', difficulty:2,
    ...
    explanation:'450 &minus; 230 = <b>220 ppm</b>. Adding the two figures would give the meaningless total of 680. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-022', chapterId:'g9s-c1-atmosphere', subsection:'greenhouse_gases', difficulty:2,
    ...
    explanation:'A greenhouse gas lets sunlight through but <b>absorbs the heat radiated back</b> from the surface, warming the atmosphere. Ozone depletion and acid rain are caused by different gases. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-023', chapterId:'g9s-c1-atmosphere', subsection:'greenhouse_gases', difficulty:2,
    ...
    explanation:'<b>Methane</b> is a powerful greenhouse gas. Nitrogen, oxygen and argon make up most of the air but do not trap heat in this way. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-024', chapterId:'g9s-c1-atmosphere', subsection:'global_warming', difficulty:3,
    ...
    explanation:'<b>Burning fossil fuels</b> releases carbon dioxide, and <b>deforestation</b> removes the trees that would have absorbed it - so the two act together. Every other option reduces emissions. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-025', chapterId:'g9s-c4-metals', subsection:'metals_with_water_steam', difficulty:2,
    ...
    explanation:'Metal + water &rarr; metal hydroxide + <b>hydrogen</b>. With sodium the reaction is vigorous enough that the hydrogen often ignites. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-026', chapterId:'g9s-c4-metals', subsection:'metals_with_water_steam', difficulty:3,
    ...
    explanation:'Sodium <b>floats</b> (it is less dense than water), melts into a ball from the heat released, and <b>darts about fizzing</b> as hydrogen is given off. The solution formed turns red litmus blue. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-027', chapterId:'g9s-c3-language', subsection:'balancing_equations', difficulty:4,
    ...
    explanation:'<b>2Na + 2H<sub>2</sub>O &rarr; 2NaOH + H<sub>2</sub></b> balances: 2 Na, 4 H and 2 O on each side. The unbalanced version leaves hydrogen unequal. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-028', chapterId:'g9s-c5-salts', subsection:'neutralisation', difficulty:2,
    ...
    explanation:'An acid reacting with a base is <b>neutralisation</b>: acid + base &rarr; salt + water. Here it gives a sodium salt and water. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-029', chapterId:'g9s-c4-metals', subsection:'reactivity_series', difficulty:4,
    ...
    explanation:'<b>Iron</b> is unreactive enough to ignore cold water but does react with steam, while <b>copper</b> sits low enough to react with neither. Sodium and potassium react violently with cold water, so neither can be X or Y. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-030', chapterId:'g9s-c5-salts', subsection:'uses_of_salts', difficulty:2,
    ...
    explanation:'<b>Sodium chloride</b> is common table salt, used to season food. Sodium hydrogen carbonate is baking soda and calcium sulfate is plaster of Paris. 📄 NCE 2024 exam.' }),
  makeMCQ({ id:'g9s-pp24c-031', chapterId:'g9s-c5-salts', subsection:'uses_of_salts', difficulty:3,
    ...
    explanation:'<b>Sodium hydrogen carbonate</b> (baking soda) decomposes on heating and releases carbon dioxide, and those bubbles make the mixture rise. 📄 NCE 2024 exam.' })
);
