...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({
    ...
    options: ["C, because salt water accelerates rusting and both oxygen and water are present","A and B equally, because each of them has either the air or the water present","A, because dry air contains the greatest amount of oxygen of the three tubes","B, because the water is present and water is what makes iron nails rust"],
  ...
  makeMCQ({
    ...
    options: ["Powdered limestone (calcium carbonate), because it is an alkali that neutralises the acid in the soil","Copper sulfate solution, because it is used as a pesticide and will help the crops to grow better","Dilute sulfuric acid, because adding an acid is the usual way to change the pH of a garden soil","A great deal more water, because that will dilute the acidity that is already present in the soil"],
  ...
  makeMCQ({
    ...
    options: ["It lowers the pH of the water, making conditions too acidic for fish, invertebrates and aquatic plants","It increases the biodiversity of the river by supplying extra sulfur as a nutrient for plants","It raises the pH of the water, which causes toxic algal blooms to form all along the banks","It has no significant effect, because the river water naturally neutralises all of the acid"],
  ...
  makeMCQ({
    ...
    options: ["The gas is carbon dioxide, which reacts with calcium hydroxide to form a white precipitate of calcium carbonate","The gas is hydrogen chloride, which neutralises the calcium hydroxide and forms a white solid in the tube","The gas is oxygen, which oxidises the calcium hydroxide and so forms a white solid inside the test tube","The gas is nitrogen dioxide, which always turns a tube of clear limewater a milky white colour like this"],
