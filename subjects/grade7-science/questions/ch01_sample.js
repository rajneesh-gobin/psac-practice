'use strict';
// Grade 7 Science - PLACEHOLDER. Delete this file when real questions land.
// IDs format: g7s-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g7s-samp-001', chapterId:'g7s-inquiry', difficulty:1,
    question:'Placeholder - this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 7 Science questions.',
    explanation:'Placeholder question for the Grade 7 Science pack.' })
