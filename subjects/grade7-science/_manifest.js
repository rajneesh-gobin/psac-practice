'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 7 — Science   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g7s-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G7SC_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g7s-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
