'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 1 - ICT Skills   ·   PLACEHOLDER PACK
//
...
//    2. Write questions/ch01_*.js. IDs: g1ict-samp-001 style.
...
registerSubject({
  ...
  comingSoon: true,
  syllabus:   G1ICT_SYLLABUS,
  chapters: [
    { id: 'g1ict-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
