'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 3 — English   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g3eng-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G3ENG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g3eng-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
