'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 1 — History & Geography   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g1h-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G1HG_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g1h-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
