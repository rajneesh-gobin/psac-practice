'use strict';
// Grade 1 History & Geography — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g1h-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g1h-samp-001', chapterId:'g1h-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 1 History & Geography questions.',
    explanation:'Placeholder question for the Grade 1 History & Geography pack.' })
