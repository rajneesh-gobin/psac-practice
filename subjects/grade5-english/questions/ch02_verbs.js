...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5eng-verb-011', chapterId:'eng-verbs', subsection:'future_tense', difficulty:2,
    ...
    answer:"won\'t",
    hint:'A tag question repeats the auxiliary of the main clause and flips it. Find the auxiliary in "Jack will go".',
  ...
  makeMCQ({ id:'g5eng-verb-012', chapterId:'eng-verbs', subsection:'present_tense', difficulty:2,
    ...
    answer:"isn\'t",
    hint:'A positive statement takes a negative tag built from the SAME auxiliary. Which auxiliary does this sentence use?',
