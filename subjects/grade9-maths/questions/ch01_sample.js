'use strict';
// Grade 9 Mathematics — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g9m-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g9m-samp-001', chapterId:'g9m-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 9 Maths questions.',
    explanation:'Placeholder question for the Grade 9 Mathematics pack.' })
