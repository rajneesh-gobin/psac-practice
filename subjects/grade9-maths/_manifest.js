'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 9 — Mathematics   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g9m-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G9M_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g9m-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
