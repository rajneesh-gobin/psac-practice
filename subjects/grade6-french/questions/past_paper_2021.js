...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6fr-pp21-001', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Chat</em> est masculin singulier → adjectif possessif <em>son</em>. (Sa/son/ses → accord avec le nom, pas le possesseur.) 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-002', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'La chenille est <em>dans</em> la papaye (à l\'intérieur). 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-003', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Devant un nom masculin singulier commençant par une voyelle, on utilise <em>bel</em> : un <em>bel</em> oiseau. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-004', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Combien</em> s\'utilise pour demander une quantité ou un prix. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-005', chapterId:'g6fr-futur', subsection:'formation', difficulty:1,
    ...
    explanation:'<em>Ton cousin et toi</em> = <em>vous</em>. Partir au futur simple : vous <em>partirez</em>. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-006', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'La préposition <em>de</em> est toujours suivie de l\'infinitif : n\'oublie pas <em>de fermer</em>. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-007', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'En français, « entre A <em>et</em> B » : choisir entre le football <em>et</em> le tennis. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-008', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Lui</em> est le pronom COI singulier (complément d\'objet indirect) : il <em>lui</em> donne une pièce. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-009', chapterId:'g6fr-subordonnees', subsection:'analyse', difficulty:2,
    ...
    explanation:'<em>Que</em> (COD) remplace « le sari » : le sari <em>que</em> porte la mariée. (Que = objet ; qui = sujet.) 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-010', chapterId:'g6fr-imparfait', subsection:'formation', difficulty:1,
    ...
    explanation:'<em>Autrefois</em> exprime une habitude passée → imparfait : <em>transportait</em>. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-011', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Un thé fade manque de saveur. Pour le rendre moins fade et plus agréable, on y ajoute du <em>sucre</em>. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-012', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Un <em>jockey</em> est un cavalier professionnel qui monte des chevaux lors des courses hippiques. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-013', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Étroit</em> = peu large. Un couloir trop étroit oblige à passer en file indienne. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-014', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Les ailes servent à <em>voler</em>. Le dodo avait de trop petites ailes pour voler. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-015', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Jusqu\'à</em> indique la limite dans le temps : fermée <em>jusqu\'à</em> mardi prochain. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-016', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Le texte dit : « Renard sort de sa <em>tanière</em>. » (Abri creusé dans le sol.) 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-017', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Renard est affamé → la charrette de poissons est une chance de <em>se nourrir</em>. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-018', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Le marchand se méfie parce que Renard a l\'habitude de <em>jouer des tours</em> (= faire des ruses). 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-019', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Renard est déjà <em>hors de vue</em> (= on ne le voit plus) → inutile de courir après lui. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp21-020', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Renard invente une ruse brillante → il est <em>malin</em> (= rusé, intelligent). 📄 PSAC 2021 exam.' })
