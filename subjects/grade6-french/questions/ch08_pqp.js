...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6fr-pqp-001', chapterId:'g6fr-pqp', subsection:'usage', difficulty:1,
  ...
  makeMCQ({ id:'g6fr-pqp-002', chapterId:'g6fr-pqp', subsection:'formation', difficulty:1,
    question:'Comment se forme le plus-que-parfait ?',
    options:['futur d\'avoir/être + participe passé','présent d\'avoir/être + participe passé','imparfait d\'avoir/être + participe passé','passé simple d\'avoir/être + participe passé'],
    answer:'imparfait d\'avoir/être + participe passé',
    hint:'Plus-que-parfait = imparfait de l\'auxiliaire + participe passé.',
    explanation:'Le plus-que-parfait se forme avec : <b>imparfait d\'avoir ou être</b> + <b>participe passé</b>. Manger → j\'avais mangé (j\'avais = imparfait d\'avoir + mangé = participe passé).' }),

  makeMCQ({ id:'g6fr-pqp-003', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:1,
    question:'Complète : "Il ___ déjà ___ quand je suis arrivé." (manger)',
    options:['avait / mangé','a / mangé','était / mangé','avait / mangeait'],
    answer:'avait / mangé',
    hint:'Plus-que-parfait : imparfait d\'avoir (il → avait) + participe passé (manger → mangé).',
    explanation:'"Il <b>avait déjà mangé</b>" - imparfait d\'avoir pour "il" = <b>avait</b>. Participe passé de manger = <b>mangé</b>. "Déjà" est souvent utilisé avec le plus-que-parfait.' }),

  makeTF({ id:'g6fr-pqp-004', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:1,
    question:'"J\'avais fini mes devoirs avant de regarder la télé." utilise correctement le plus-que-parfait.',
    answer:true,
    hint:'"J\'avais fini" = imparfait d\'avoir (avais) + participe passé (fini).',
  ...
  makeMCQ({ id:'g6fr-pqp-005', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:1,
    ...
    hint:'Imparfait d\'avoir pour "nous" = avions. Participe passé de parler = parlé.',
    explanation:'"Nous <b>avions parlé</b>" - imparfait d\'avoir (nous) = <b>avions</b> + participe passé = <b>parlé</b>.' }),

  makeMCQ({ id:'g6fr-pqp-006', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:2,
  ...
  makeMCQ({ id:'g6fr-pqp-007', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:2,
    ...
    hint:'Aller utilise ÊTRE comme auxiliaire. Imparfait d\'être (elle) = était. Participe passé = allée (accord féminin).',
    explanation:'"Elle <b>était allée</b>" - aller utilise l\'auxiliaire <b>être</b>. Imparfait d\'être pour "elle" = <b>était</b>. Participe passé = <b>allée</b> (accord féminin). Rappel : les verbes avec être s\'accordent avec le sujet.' }),

  makeMCQ({ id:'g6fr-pqp-008', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:2,
  ...
  makeTF({ id:'g6fr-pqp-009', chapterId:'g6fr-pqp', subsection:'formation', difficulty:2,
    question:'"Nous étions partis avant que le film commence." est un exemple de plus-que-parfait avec l\'auxiliaire être.',
    answer:true,
    hint:'"Étions partis" = imparfait d\'être (étions) + participe passé (partis). Partir utilise être.',
    explanation:'<b>Vrai.</b> Partir utilise l\'auxiliaire <b>être</b>. Imparfait d\'être pour "nous" = <b>étions</b>. Participe passé de partir = <b>partis</b> (accord avec le sujet nous = masculin pluriel). Correct.' }),

  makeMCQ({ id:'g6fr-pqp-010', chapterId:'g6fr-pqp', subsection:'formation', difficulty:2,
    ...
    hint:'Plus-que-parfait = imparfait d\'avoir/être + participe passé.',
    explanation:'"Elle <b>avait lu</b>" - imparfait d\'avoir (avait) + participe passé (lu) = plus-que-parfait. "Lisait" = imparfait. "Avons lu" = passé composé. "Lirez" = futur.' }),

  makeMCQ({ id:'g6fr-pqp-011', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:2,
    ...
    explanation:'"Tu <b>avais fait</b>" - faire → participe passé irrégulier = <b>fait</b>. Imparfait d\'avoir pour "tu" = <b>avais</b>.' }),

  makeMCQ({ id:'g6fr-pqp-012', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:3,
    ...
    explanation:'"Mon père <b>est rentré</b>" (passé composé = action principale). "Ma mère <b>avait déjà préparé</b>" (plus-que-parfait = action antérieure, faite avant). Rentrer → auxiliaire être : <b>est</b> rentré.' }),

  makeMCQ({ id:'g6fr-pqp-013', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:3,
    ...
    hint:'Venir utilise être. Imparfait d\'être (ils) = étaient. Participe passé = venus (pluriel).',
    explanation:'"Ils <b>étaient venus</b>" - venir utilise l\'auxiliaire <b>être</b>. Imparfait d\'être pour "ils" = <b>étaient</b>. Participe passé = <b>venus</b> (accord masculin pluriel).' }),

  makeMCQ({ id:'g6fr-pqp-014', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
  ...
  makeTF({ id:'g6fr-pqp-015', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
    question:'"Elles avaient fini leurs devoirs avant que le cours commence." est correctement formé.',
    answer:true,
    hint:'"Avaient fini" = imparfait d\'avoir (elles → avaient) + participe passé (finir → fini). Correct.',
    explanation:'<b>Vrai.</b> "Elles <b>avaient fini</b>" - finir utilise avoir. Imparfait d\'avoir pour "elles" = <b>avaient</b>. Participe passé de finir = <b>fini</b>. Plus-que-parfait bien formé.' }),

  makeMCQ({ id:'g6fr-pqp-016', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
  ...
  makeMCQ({ id:'g6fr-pqp-018', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:4,
  ...
  makeMCQ({ id:'g6fr-pqp-019', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:4,
  ...
  makeMCQ({ id:'g6fr-pqp-020', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:1,
    ...
    hint:'PQP = imparfait d\'avoir (tu → avais) + participe passé (finir → fini).',
    explanation:'"Tu <b>avais fini</b>" - imparfait d\'avoir pour "tu" = <b>avais</b>. Participe passé de finir = <b>fini</b>.' }),

  makeMCQ({ id:'g6fr-pqp-021', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:1,
    ...
    hint:'PQP = imparfait d\'avoir (ils → avaient) + participe passé irrégulier (prendre → pris).',
    explanation:'"Ils <b>avaient pris</b>" - prendre → participe passé irrégulier = <b>pris</b>. Imparfait d\'avoir pour "ils" = <b>avaient</b>.' }),

  makeTF({ id:'g6fr-pqp-022', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:1,
    question:'"Elles étaient arrivées" est le plus-que-parfait de ARRIVER pour "elles".',
    answer:true,
    hint:'Arriver + être. Imparfait d\'être (elles → étaient) + arrivées (accord féminin pluriel).',
    explanation:'<b>Vrai.</b> Arriver utilise l\'auxiliaire <b>être</b>. Imparfait d\'être pour "elles" = <b>étaient</b>. Participe passé = <b>arrivées</b> (accord féminin pluriel : +es). "Elles étaient arrivées".' }),

  makeMCQ({ id:'g6fr-pqp-023', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:2,
    ...
    hint:'Dire → participe passé irrégulier = dit. Imparfait d\'avoir (nous → avions).',
    explanation:'"Nous <b>avions dit</b>" - dire → participe passé irrégulier = <b>dit</b>. Imparfait d\'avoir pour "nous" = <b>avions</b>. Attention : "dis" est incorrect, le participe passé de dire = <b>dit</b>.' }),

  makeMCQ({ id:'g6fr-pqp-024', chapterId:'g6fr-pqp', subsection:'formation', difficulty:2,
    ...
    explanation:'"Elle <b>avait ouvert</b>" - ouvrir → participe passé irrégulier = <b>ouvert</b>. Passé composé (a ouvert) → plus-que-parfait : remplacer "a" (présent d\'avoir) par "avait" (imparfait d\'avoir).' }),

  makeMCQ({ id:'g6fr-pqp-025', chapterId:'g6fr-pqp', subsection:'irreguliers', difficulty:2,
    ...
    hint:'Mettre → participe passé irrégulier = mis. Imparfait d\'avoir (vous → aviez).',
    explanation:'"Vous <b>aviez mis</b>" - mettre → participe passé irrégulier = <b>mis</b>. Imparfait d\'avoir pour "vous" = <b>aviez</b>. Famille : mettre, promettre, remettre, soumettre → tous avec participe passé en <b>-mis</b>.' }),

  makeMCQ({ id:'g6fr-pqp-026', chapterId:'g6fr-pqp', subsection:'formation', difficulty:2,
  ...
  makeMCQ({ id:'g6fr-pqp-027', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
    ...
    explanation:'"Elle <b>avait écrit</b>" - écrire → participe passé irrégulier = <b>écrit</b>. Imparfait d\'avoir pour "elle" = <b>avait</b>. Famille : écrire, décrire, inscrire → tous avec participe passé en <b>-crit</b>.' }),

  makeMCQ({ id:'g6fr-pqp-028', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
    ...
    explanation:'"Mes cousines <b>s\'étaient levées</b>" - se lever est pronominal → auxiliaire <b>être</b>. Imparfait d\'être pour "elles" = <b>étaient</b>. Accord avec "mes cousines" (féminin pluriel) → <b>levées</b> (+es).' }),

  makeMCQ({ id:'g6fr-pqp-029', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
  ...
  makeTF({ id:'g6fr-pqp-030', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
    ...
    explanation:'<b>Vrai.</b> "<b>avions étudié</b>" = plus-que-parfait d\'étudier (imparfait d\'avoir = avions + participe passé = étudié). "<b>aurions réussi</b>" = conditionnel passé (conditionnel d\'avoir = aurions + participe passé = réussi). Structure correcte : <b>si + PQP → conditionnel passé</b>.' }),

  makeMCQ({ id:'g6fr-pqp-031', chapterId:'g6fr-pqp', subsection:'formation', difficulty:3,
  ...
  makeMCQ({ id:'g6fr-pqp-032', chapterId:'g6fr-pqp', subsection:'formation', difficulty:4,
  ...
  makeMCQ({ id:'g6fr-pqp-033', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:4,
    question:'Riya n\'a pas pu regarder le film hier soir car elle avait déjà lu tout le livre. Transforme en récit : "Riya ne pouvait pas regarder le film car elle ___ déjà ___ le livre."',
    options:[
      'avait / lu',
      'a / lu',
      'avait / lire',
  ...
  makeMCQ({ id:'g6fr-pqp-034', chapterId:'g6fr-pqp', subsection:'concordance', difficulty:3,
    ...
    explanation:'"le professeur <b>avait déjà commencé</b> le cours." - Le cours a commencé <b>avant</b> notre arrivée → <b>PQP</b>. Action de référence : nous sommes arrivés (passé composé). Action antérieure : avait commencé (PQP). "Déjà" confirme l\'antériorité. Commencer → participe passé = commencé ; auxiliaire avoir imparfait = avait.' }),

  makeMCQ({ id:'g6fr-pqp-035', chapterId:'g6fr-pqp', subsection:'formation', difficulty:4,
