...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6fr-pp23-001', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Descendre de</em> la montagne. Devant « la montagne » (féminin), on écrit <em>de la</em> : le blanc = <em>de</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-002', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Quelle</em> s\'accorde avec le nom féminin singulier <em>surprise</em>. (Quel/beau/belle/beaux/belles : même logique.) 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-003', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'Passé composé de <em>réussir</em> : tu <em>as</em> réussi. (Réussir prend l\'auxiliaire avoir.) 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-004', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Dans la voix passive, le complément d\'agent se construit avec <em>par</em> : acheté <em>par</em> mon oncle. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-005', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Ma mère et moi</em> = <em>nous</em>. Sortir au présent : nous <em>sortons</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-006', chapterId:'g6fr-subordonnees', subsection:'analyse', difficulty:2,
    ...
    explanation:'<em>Que</em> est le pronom relatif COD (complément d\'objet direct). Tu vois <em>qui</em> ? → la fille <em>que</em> tu vois. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-007', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Défense de</em> + infinitif est une expression d\'interdiction (équivaut à « il est interdit de »). 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-008', chapterId:'g6fr-subordonnees', subsection:'analyse', difficulty:2,
    ...
    explanation:'<em>Où</em> est le pronom relatif de lieu (et de temps). L\'endroit <em>où</em> tu habites = dans lequel tu habites. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-009', chapterId:'g6fr-imparfait', subsection:'formation', difficulty:1,
    ...
    explanation:'<em>Autrefois</em> signale une action habituelle dans le passé → imparfait : <em>vivaient</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-010', chapterId:'g6fr-futur', subsection:'formation', difficulty:2,
    ...
    explanation:'<em>Quand</em> + futur simple pour une action future : Pierre rendra visite <em>quand</em> il ira à Curepipe. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-011', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Faux</em> = contraire de vrai. Ce n\'est pas vrai = c\'est <em>faux</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-012', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>La rage</em> est une colère violente. Quelqu\'un de furieux crie de <em>rage</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-013', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'On fait de l\'exercice pour <em>être</em> en bonne santé. « Pour + infinitif » exprime le but. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-014', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Des obstacles rendent la randonnée <em>difficile</em>, pas facile ou agréable. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-015', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Un réveille-matin émet une <em>sonnerie</em> (bruit d\'alarme) pour réveiller. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-016', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Un <em>chou</em> est un légume. Sam n\'aime pas être comparé à <em>un légume</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-017', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Le texte précise que Mme Michat <em>lave des assiettes</em> dans l\'évier. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-018', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'L\'<em>effroi</em> est une grande peur. Mme Michat pousse un cri parce qu\'elle est <em>effrayée</em>. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-019', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Elle le caresse, le cajole, le console → elle prend le chou dans ses bras <em>pour le consoler</em> (elle croit que c\'est son fils transformé). 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp23-020', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'L\'instituteur regarde d\'un <em>air surpris</em> → il est <em>étonné</em> de voir Mme Michat arriver avec un chou. 📄 PSAC 2023 exam.' })
