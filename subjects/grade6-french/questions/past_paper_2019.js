...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6fr-pp19-001', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Restons</em> est la 1re personne du pluriel de « rester » → pronom sujet <em>nous</em>. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-002', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'Devant un nom masculin singulier commençant par une consonne : <em>ce</em>. (Cet = devant voyelle ou h muet.) 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-003', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Dans</em> indique l\'intérieur : les billes sont <em>dans</em> ta poche. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-004', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>À + les</em> se contracte en <em>aux</em> : participer <em>aux</em> Jeux des Îles. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-005', chapterId:'g6fr-futur', subsection:'formation', difficulty:1,
    ...
    explanation:'<em>Tes amis et toi</em> = <em>vous</em>. Faire au futur : vous <em>ferez</em>. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-006', chapterId:'g6fr-subordonnees', subsection:'analyse', difficulty:2,
    ...
    explanation:'<em>Que</em> = pronom relatif COD : le livre <em>que</em> j\'ai eu en cadeau (= j\'ai eu le livre en cadeau). 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-007', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Les élèves</em> est pluriel → pronom COD <em>les</em> : leur enseignant <em>les</em> emmène. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-008', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'Futur proche : aller + infinitif. Les enfants vont <em>courir</em> au stade. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-009', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:1,
    ...
    explanation:'<em>Quand</em> exprime la simultanéité : j\'ai eu mal au genou <em>quand</em> je suis tombé. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-010', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Celui</em> remplace un nom masculin singulier (le crayon). <em>Celle</em> = féminin ; <em>ceux/celles</em> = pluriel. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-011', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Bien chanter est une réussite → maman a <em>félicité</em> Toto (= lui a dit bravo, l\'a complimenté). 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-012', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Avec une blessure à la jambe, on a du mal à marcher vite → on marche <em>lentement</em>. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-013', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'On appelle <em>l\'ambulance</em> pour transporter les blessés et leur donner les premiers soins. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-014', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'<em>Le dictionnaire</em> donne la définition et le sens des mots. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-015', chapterId:'g6fr-lecture', subsection:'reperage', difficulty:2,
    ...
    explanation:'Les clowns se produisent <em>au cirque</em>. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-016', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Les trois compagnons sont : la <em>coccinelle</em>, le <em>mille-pattes</em> et l\'<em>abeille</em>. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-017', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'L\'escargot marchait avec peine, loin derrière → il était <em>lent</em>. Les autres étaient rapides. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-018', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Les autres « s\'étaient déjà bien reposées et avaient bien mangé », et il ne restait plus de place pour se coucher : quand l\'escargot arrivait, tous <em>dormaient</em> déjà. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-019', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'Le texte dit : « <em>Curieux</em>, et comme la chose ne bougeait pas, il y pénétra. » 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g6fr-pp19-020', chapterId:'g6fr-textes', subsection:'recit', difficulty:2,
    ...
    explanation:'La dernière phrase : « l\'escargot porte son coquillage sur le dos » → l\'histoire explique pourquoi l\'escargot <em>a une coquille sur le dos</em>. 📄 PSAC 2019 exam.' })
