...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6eng-pp23-001', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Last week" requires simple past tense - "missed". 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-002', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"In" is the correct preposition for location within a place. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-003', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'"They" replaces a plural noun phrase - Jay and Aaron are two people. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-004', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Many" is used with countable nouns. "Much" is for uncountable nouns. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-005', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Which" introduces a relative clause about a thing; "who" is for people. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-006', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Yours" is a possessive pronoun - it replaces "your cat" without repeating "cat". 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-007', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:2,
    ...
    explanation:'In negative sentences, we use "anything" (not "nothing", which creates a double negative). 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-008', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'First conditional: "If + present simple, will + base verb" - "will have". 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-009', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:2,
    ...
    explanation:'Present perfect auxiliary "have" → negative tag is "haven\'t you". 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-010', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Although + subject + verb" shows contrast. "Despite" is followed by a noun/gerund. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-011', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'A factory is a place where goods (like electric bulbs) are produced in large quantities. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-012', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'A carpenter works with wood - fixing chairs, tables and other wooden items. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-013', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Beautiful" fits - people love things that are attractive. "Poor" would be the opposite. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-014', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'You "pay" a fare. Without money, you cannot pay. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-015', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Waste time" is a fixed collocation meaning to use time carelessly or without purpose. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-016', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'The text says "Only the juice of a magic fruit could cure his illness" - the King needed it to cure his sick son. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-017', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"Whoever brings this magic fruit will be rewarded," announced the King - a reward is a gift or prize. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-018', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"The King\'s reward would help the family to earn some money" - earning money was their reason. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-019', chapterId:'g6eng-comprehension', subsection:'language', difficulty:2,
    ...
    explanation:'"Exhausted" means extremely tired - they had "travelled for months" trying to find the fruit. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp23-020', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"The parrots were very hungry and could not find anything to eat" - that is why Ancy shared her food. 📄 PSAC 2023 exam.' })
