...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6eng-pp24-001', chapterId:'g6eng-nouns', subsection:'common_proper', difficulty:1,
    ...
    explanation:'"She" replaces "my mother" (female, singular). 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-002', chapterId:'g6eng-verbs', subsection:'past_tense', difficulty:1,
    ...
    explanation:'Simple past of "take" = took. "Yesterday" requires simple past tense. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-003', chapterId:'g6eng-nouns', subsection:'common_proper', difficulty:1,
    ...
    explanation:'"Some" is used with uncountable nouns in positive statements. "Many/few" need countable nouns. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-004', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:1,
    ...
    explanation:'"The funniest" is the superlative of "funny", used when comparing one item with all others in a group. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-005', chapterId:'g6eng-clauses', subsection:'clause_types', difficulty:1,
    ...
    explanation:'"During" is a preposition used with a noun phrase to show something happened within that time period. "While" needs a verb/clause. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-006', chapterId:'g6eng-verbs', subsection:'present_tense', difficulty:2,
    ...
    explanation:'Past continuous (was cleaning) describes the ongoing background action interrupted by "found" (simple past). 📄 PSAC 2024 exam.',
  ...
  makeMCQ({ id:'g6eng-pp24-007', chapterId:'g6eng-nouns', subsection:'common_proper', difficulty:2,
    ...
    explanation:'"Themselves" is the plural reflexive pronoun matching "the children". 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-008', chapterId:'g6eng-verbs', subsection:'present_tense', difficulty:2,
    ...
    explanation:'Present perfect = have + past participle. The past participle of "do" is "done". 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-009', chapterId:'g6eng-clauses', subsection:'clause_types', difficulty:2,
    ...
    explanation:'"Whose" is the possessive relative pronoun. "The pupil whose bag was lost" = the bag belongs to the pupil. 📄 PSAC 2024 exam.',
  ...
  makeMCQ({ id:'g6eng-pp24-010', chapterId:'g6eng-clauses', subsection:'clause_types', difficulty:1,
    ...
    explanation:'"Because" introduces a reason/cause. "Although/yet/despite" would create a contrast, which makes no sense here. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-011', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:2,
    ...
    explanation:'"Ordered" is the correct reporting verb for a command or instruction. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-012', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:1,
    ...
    explanation:'Mechanics repair cars (vehicles). Plumbers fix taps, carpenters fix doors. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-013', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:1,
    ...
    explanation:'A bakery bakes and sells bread and pastries. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-014', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:1,
    ...
    explanation:'"Angry" fits the context - someone destroyed his property. The other words describe character traits, not an emotional reaction. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-015', chapterId:'g6eng-vocabulary', subsection:'meaning', difficulty:1,
    ...
    explanation:'"Loudly" describes the manner of shouting. You shout loudly to be heard. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-016', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:1,
    ...
    explanation:'The passage states "Mummy and Daddy were sleeping" when Mia heard the noise. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-017', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:1,
    ...
    explanation:'The text says "The sound seemed to be coming from a nearby plant." 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-018', chapterId:'g6eng-comprehension', subsection:'vocabulary', difficulty:2,
    ...
    explanation:'"Struggled to come out" means it had great difficulty getting out of the branches. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-019', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'The text says "she was very happy to be free" - Mia had freed her from the branches. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp24-020', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"An unexpected friend" best captures the story - Mia makes an unlikely friend (a unicorn) who saves her. 📄 PSAC 2024 exam.' })
