...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6eng-pp22-001', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Yesterday" signals simple past tense - "made" is the past form of "make". 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-002', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"On" is used with specific days and dates - "on the 29th of May". 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-003', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'"His" is a possessive adjective. "Him" and "he" are subject/object pronouns; "himself" is reflexive. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-004', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Little" is used with uncountable nouns to mean a small amount. "Few" is for countable nouns. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-005', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:2,
    ...
    explanation:'"We" → "ourselves" (reflexive). "Myself" = I; "themselves" = they; "himself" = he. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-006', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'Comparative form (one syllable + -er) is used when comparing two things: "bigger than". 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-007', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Saw" is simple past - it describes what the speaker perceived at a specific moment in the past. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-008', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:1,
    ...
    explanation:'After "did", the main verb must be in the base (infinitive) form - "play". 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-009', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Where" introduces a relative clause about a place. "Who" = people; "when" = time. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-010', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"If" introduces a conditional clause: success depends on the condition of working hard. 📄 PSAC 2022 exam.' }),

  // --- Question 3B: Vocabulary MCQs (5 marks) ---

  makeMCQ({ id:'g6eng-pp22-011', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Loud" means producing a lot of noise - you turn down a radio that is too loud. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-012', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'A cinema with no seats available is "full" - all seats have been taken. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-013', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Asked" reports a question or request. "Told" + object reports a statement; "said" has no direct object. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-014', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Drown" means to die from sinking under water - the logical risk of swimming in a dangerous sea. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-015', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Hid" means put out of sight - she hid the chocolates so the children could not find and eat them. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-016', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:1,
    ...
    explanation:'"At 09 10, when he should have been in the school assembly, Swami was lying in his mother\'s room." 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g6eng-pp22-017', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"He punishes children who come in late very severely" - that was Swami\'s excuse. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-018', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"Swami knew how strict his father could be. So, he changed his excuses." - his father\'s strictness made Swami try harder. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-019', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"No problem. You can submit the work tomorrow," Mr Samuel said gently - he was kind. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp22-020', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"When the bell rang at 15 30, Swami ran to the head teacher\'s office to deliver the letter." 📄 PSAC 2022 exam.' })
