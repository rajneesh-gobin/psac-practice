...
(function () {
  ...
  add('purpose_result', [
    ...
    ['Speak slowly.','The younger pupils can follow the instructions.','Speak slowly so that the younger pupils can follow the instructions.',['Speak slowly because the pupils followed yesterday.','Speak slowly although the pupils can follow.','Speak slowly unless the pupils can follow.']],
