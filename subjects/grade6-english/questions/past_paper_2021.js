...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g6eng-pp21-001', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Gave" is the simple past form of "give". "Given" is the past participle (needs "has/had"). 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-002', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Switch on" means to start a device by operating a switch. "Switch up" is not standard. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-003', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Himself" is the reflexive pronoun for a male singular subject (he/the gardener). 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-004', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'"How much" is used with uncountable nouns. "How many" is used with countable nouns. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-005', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"During" is a preposition used before a noun: "during recess". "While" needs a subject + verb. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-006', chapterId:'g6eng-nouns', subsection:'cloze', difficulty:1,
    ...
    explanation:'Superlative form ("fastest") is used when comparing one thing against all others in a group. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-007', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:2,
    ...
    explanation:'Past continuous "was cutting" shows an action in progress at a specific past moment. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-008', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Which" introduces a relative clause about a thing. "Who/whom" refer to people. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-009', chapterId:'g6eng-verbs', subsection:'cloze', difficulty:1,
    ...
    explanation:'After "did", always use the base form of the verb - "enjoy", not "enjoyed". 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-010', chapterId:'g6eng-clauses', subsection:'cloze', difficulty:2,
    ...
    explanation:'"Despite + noun/gerund" shows contrast. "Although" needs a full clause: "Although it rained...". 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-011', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'A dentist is a doctor who treats teeth. A florist sells flowers; a mechanic repairs machines. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-012', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Forgot" means failed to take it along. "Broke" means damaged it; "gave" means transferred it. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-013', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Kind" means caring and generous to others - the word fits perfectly with "always helps people". 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-014', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Quickly" means at high speed - that is why nobody caught the thief. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-015', chapterId:'g6eng-vocabulary', subsection:'cloze', difficulty:1,
    ...
    explanation:'"Noisy" means full of noise. A very noisy crowd would drown out the coach\'s voice. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-016', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"He often felt lonely… he got tired of being alone" - loneliness made him visit his friend. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-017', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"Some children… noticed that the gate to the giant\'s castle was open. Curious, they went inside." - children entered his garden. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-018', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"Terrified" means extremely frightened - "scared" is the correct synonym. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-019', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"This garden belongs to me only. I cannot let anybody play in it," the giant grumbled - he wanted to keep children out. 📄 PSAC 2021 exam.' }),
  ...
  makeMCQ({ id:'g6eng-pp21-020', chapterId:'g6eng-comprehension', subsection:'retrieval', difficulty:2,
    ...
    explanation:'"The children stayed indoors and they felt miserable" - being confined at home in winter made them miserable. 📄 PSAC 2021 exam.' })
