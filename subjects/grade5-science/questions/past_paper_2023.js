...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp23-001', chapterId:'energy', subsection:'renewable', difficulty:1,
    ...
    explanation:'Coal is a fossil fuel formed from ancient plants compressed underground over millions of years. Bagasse, wax, and wood are not fossil fuels. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-002', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'Many traditional thermometers contain mercury, a shiny liquid metal. Modern thermometers often use coloured alcohol instead, as mercury is toxic. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-003', chapterId:'energy', subsection:'forms', difficulty:2,
    ...
    explanation:'A sailing boat is powered by wind energy, which is a form of movement (kinetic) energy. The wind pushes the sails, making the boat move. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-004', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'The large, chunky underground part of a cassava plant is the root. Cassava roots (tubers) are an important food source and store starch. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-005', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Cardinal jaune (Rodrigues warbler) is endemic to Rodrigues. The Echo parakeet, Kestrel, and Pink Pigeon are endemic to the main island of Mauritius. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-006', chapterId:'energy', subsection:'forms', difficulty:1,
    ...
    explanation:'Food contains chemical energy, which the body converts into movement, heat, and other forms of energy needed for daily activities. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp23-007', chapterId:'energy', subsection:'sources', difficulty:1,
    ...
    explanation:'Solar street lamps use solar energy (sunlight) captured by solar panels, which is then converted to electrical energy to light the lamps at night. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp23-008', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'A cell (battery) provides the electrical energy needed to drive the current around the circuit. Without it, the bulb would not light up. 📄 PSAC 2023 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp23-009', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Fish live in water (rivers, lakes, seas, or oceans). They breathe by extracting dissolved oxygen from water using their gills. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-010', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Frogs are amphibians. Amphibians can live both in water and on land and typically lay eggs in water. Toads and salamanders are also amphibians. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-011', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Echo parakeet is endemic to Mauritius. Crows and sparrows are found worldwide and are not endemic. Eagles are found across many continents. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-012', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'Ice is water in its solid state. Solids have a definite shape and volume. When heated, ice melts to become liquid water. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-013', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'Evaporation is the process where liquid water is heated and changes into water vapour (steam). It happens at the surface of a liquid. 📄 PSAC 2023 exam.' }),

  makeMCQ({ id:'g5sc-pp23-014', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'Ice is in the solid state. It has a fixed shape and volume. The water droplets forming on the outside of the cold glass are due to condensation of water vapour from the warm air. 📄 PSAC 2023 exam.' })
);
