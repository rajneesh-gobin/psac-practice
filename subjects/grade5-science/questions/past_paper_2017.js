...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp17-001', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The fruit develops from the fertilised flower and holds (contains) the seeds. Examples: mango, apple, and tomato are all fruits containing seeds. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-002', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'The sun provides the heat energy that causes water to evaporate from the surfaces of oceans, seas, rivers, and lakes into the atmosphere. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-003', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'Ice cubes from a freezer are typically at around −18°C, which is below 4°C (and well below 0°C, the freezing point of water). The correct answer is D (below 4°C). 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-004', chapterId:'energy', subsection:'forms', difficulty:2,
    ...
    explanation:'In a torch, chemical energy stored in the battery is converted into electrical energy, which then becomes light energy in the bulb. The main transformation is chemical → light. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-005', chapterId:'animals', subsection:'habitats', difficulty:2,
    ...
    explanation:'The Cape Ground Squirrel lives in deserts and arid (very dry) grasslands in southern Africa. It is adapted to hot, dry conditions and digs burrows to escape the heat. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-006', chapterId:'energy', subsection:'transfer', difficulty:2,
    ...
    explanation:'When the guitar strings are plucked (movement), they vibrate and produce sound energy. The movement (kinetic) energy of her fingers becomes sound energy. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-007', chapterId:'energy', subsection:'renewable', difficulty:2,
    ...
    explanation:'Natural gas (methane) is a fossil fuel formed from ancient organic matter. Bagasse is a sugarcane by-product (biomass); solar and wind are renewable energy sources, not fossil fuels. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-008', chapterId:'energy', subsection:'sources', difficulty:2,
    ...
    explanation:'The human body obtains energy from food, which contains chemical energy. This chemical energy is released by the body\'s cells and used for movement, warmth, and other activities. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-009', chapterId:'water-matter', subsection:'states', difficulty:3,
    ...
    explanation:'Salt pans work by evaporating sea water using the sun\'s heat. In winter, there is less sunlight and lower temperatures, so evaporation is slower, and less salt is obtained than in hot, sunny summer months. 📄 PSAC 2017 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp17-010', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'A dry cell (battery) provides the electrical energy needed to drive the current around the circuit. It converts chemical energy into electrical energy. 📄 PSAC 2017 exam.' })
);
...
window.PSAC_PDF_QUESTIONS.push(
  ...
  { id:'g5sc-pp17-pdf-002', image:'assets/past-papers/g5-science-2017/d11-plant-experiment.png', imageAlt:'The diagram printed with this question in the exam paper', chapterId:'plants', marks:3, year:2017, grade:5, subject:'Science',
