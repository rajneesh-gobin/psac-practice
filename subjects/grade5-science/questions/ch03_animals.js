...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5sci-an-001', chapterId:'animals', subsection:'classification', difficulty:3,
    question:'A species is described as <b>endemic</b> to Mauritius. What does this tell you about it?',
    options:['It is found naturally nowhere else in the world','It was brought to Mauritius by early settlers','It is in danger of dying out completely','It lives on several islands in the region'],
    answer:'It is found naturally nowhere else in the world',
    hint:'The word says where the species belongs, not how rare it is.',
    explanation:'<b>Endemic</b> means found naturally in one place and nowhere else on Earth. It is not the same as endangered - a species can be endemic and still be common - and it is the opposite of introduced.' }),
  ...
  makeMCQ({ id:'g5sci-an-011', chapterId:'animals', subsection:'classification', difficulty:3,
    question:'Why is an endemic species usually at greater risk of extinction than a widespread one?',
    options:['If it disappears from that one place, it is gone everywhere','It always produces fewer young than other species','It cannot survive inside a protected nature reserve','It is always smaller than the species related to it'],
    answer:'If it disappears from that one place, it is gone everywhere',
    hint:'Think about how many places the species could be lost from.',
    explanation:'A widespread species can be wiped out in one area and survive in another. An <b>endemic</b> species has nowhere else to survive, so a single cyclone, disease or new predator can end it - which is why Mauritius guards species like the echo parakeet so closely.' }),
  ...
  makeMCQ({ id:'g5sci-an-012', chapterId:'animals', subsection:'classification', difficulty:1,
    ...
    answer:'Water',
    hint:'Think about what a fish\'s gills need around them in order to work.',
  ...
  makeMCQ({ id:'g5sci-an-020', chapterId:'animals', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/foodchain.png" alt="a food chain diagram" style="max-height:220px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.12)"></div><b>In a food chain like the one shown, which type of organism is always the PRODUCER?</b>',
  ...
  makeMCQ({ id:'g5sci-an-024', chapterId:'animals', subsection:'photos', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/food-web.png" alt="a food web diagram" style="max-height:220px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.12)"></div><b>In a food web, the organism at the very top that is not hunted or eaten by any other animal is called the:</b>',
