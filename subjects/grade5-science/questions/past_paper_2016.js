...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp16-001', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'A thermometer is used to measure temperature. The liquid inside (mercury or coloured alcohol) expands as temperature rises, allowing the temperature to be read from the scale. 📄 PSAC 2016 exam.' }),

  makeMCQ({ id:'g5sc-pp16-002', chapterId:'energy', subsection:'sources', difficulty:1,
    ...
    explanation:'An electric iron converts electrical energy mainly into heat energy. This heat warms the soleplate of the iron, which then presses and removes creases from fabric. 📄 PSAC 2016 exam.' }),

  makeMCQ({ id:'g5sc-pp16-003', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'Flowers attract insects (and other animals) for pollination. When insects collect nectar, they carry pollen between flowers, enabling fertilisation and reproduction of the plant. 📄 PSAC 2016 exam.' }),

  makeMCQ({ id:'g5sc-pp16-004', chapterId:'conservation', subsection:'pollution', difficulty:2,
    ...
    explanation:'Collecting rainwater to water plants is a great way to save tap water. It is free, helps reduce water usage, and is better for plants than treated tap water. 📄 PSAC 2016 exam.' }),

  makeMCQ({ id:'g5sc-pp16-005', chapterId:'plants', subsection:'growth', difficulty:2,
    ...
    explanation:'A cactus has a thick, fleshy stem that stores large amounts of water. It also has waxy skin to reduce water loss and long roots to collect rainwater quickly when it does rain. 📄 PSAC 2016 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp16-006', chapterId:'energy', subsection:'sources', difficulty:1,
    ...
    explanation:'Petrol contains chemical energy. When it burns in the car\'s engine, this chemical energy is converted to movement (kinetic) energy to drive the car. 📄 PSAC 2016 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp16-007', chapterId:'energy', subsection:'sources', difficulty:1,
    ...
    explanation:'Plants use solar (sunlight) energy to carry out photosynthesis. The sun\'s energy is captured by chlorophyll in leaves and used to convert carbon dioxide and water into food (glucose). 📄 PSAC 2016 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp16-008', chapterId:'energy', subsection:'sources', difficulty:2,
    ...
    explanation:'The sun provides heat (solar) energy that evaporates water from the octopuses, drying them. This is the same process as drying clothes on a washing line. 📄 PSAC 2016 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp16-009', chapterId:'electricity', subsection:'circuits', difficulty:2,
    ...
    explanation:'When a switch is open, it creates a gap in the circuit. Electricity cannot flow across this gap, so the circuit is incomplete and no current flows - the bulb does not light up. 📄 PSAC 2016 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp16-010', chapterId:'electricity', subsection:'circuits', difficulty:2,
    ...
    explanation:'Because the bulb lights up, the iron nail allows electricity to pass through it. This means iron is a conductor of electricity. Metals are generally good electrical conductors. 📄 PSAC 2016 exam.' })
);
