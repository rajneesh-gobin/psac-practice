...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp22-001', chapterId:'plants', subsection:'reproduction', difficulty:1,
    ...
    explanation:'The petals (flower) are brightly coloured and may have nectar to attract insects, which then carry pollen from one flower to another, enabling pollination. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-002', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The carrot is a root vegetable - the orange part we eat is the plant\'s root. Sugarcane is grown for its stem, while grass and vetiver are grown for other purposes. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp22-003', chapterId:'animals', subsection:'classification', difficulty:1,
    ...
    explanation:'Frogs are amphibians - they can live both in water and on land. Butterflies are insects, dogs are mammals, and dolphins are mammals that live only in water. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp22-004', chapterId:'electricity', subsection:'conductors', difficulty:1,
    ...
    explanation:'An iron nail is a metal and therefore a good conductor of electricity. Glass, wood, and rubber are insulators that do not allow electricity to pass through. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-005', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'Ice melts fastest when heated in a pan because direct heat provides the most energy, speeding up the change from solid to liquid. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-006', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'Evaporation is the process by which liquid water at the surface of seas, rivers, and lakes is heated by the sun and turns into water vapour. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-007', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'Condensation is the process by which water vapour in the air cools and changes back into liquid water droplets. This forms clouds and dew. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-008', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'A switch opens or closes an electric circuit. When open, no current flows and the bulb does not light. When closed, current flows and the bulb lights up. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-009', chapterId:'electricity', subsection:'components', difficulty:2,
    ...
    explanation:'Plastic and rubber are electrical insulators. The covering on electric wires prevents electricity from passing to anyone who accidentally touches the wire, preventing electric shocks. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-010', chapterId:'energy', subsection:'transfer', difficulty:2,
    ...
    explanation:'When a bird flies, chemical energy from food is converted to movement (kinetic) energy as its muscles power the wings to flap. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-011', chapterId:'energy', subsection:'sources', difficulty:2,
    ...
    explanation:'Thermal power stations in Mauritius burn coal (a fossil fuel) to heat water and produce steam, which drives turbines connected to generators. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp22-012', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Camels are perfectly adapted to life in deserts - their humps store fat for energy, and they can go long periods without drinking water. 📄 PSAC 2022 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp22-013', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Echo parakeet is endemic to Mauritius, meaning it is found nowhere else in the world. Crows, mynahs, and sparrows are introduced or widespread species. 📄 PSAC 2022 exam.' }),

  makeMCQ({ id:'g5sc-pp22-014', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Pink Pigeon (Nesoenas mayeri) is endemic to Mauritius. It nearly went extinct in the 1980s but was saved through conservation breeding programmes. 📄 PSAC 2022 exam.' })
);
