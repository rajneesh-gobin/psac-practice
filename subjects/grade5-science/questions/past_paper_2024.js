...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp24-001', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The male part (stamen/anther) of the hibiscus produces pollen. The female part receives it during pollination. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-002', chapterId:'water-matter', subsection:'properties', difficulty:1,
    ...
    explanation:'Ice is cold, and this low temperature numbs pain and reduces swelling when applied to an injury. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-003', chapterId:'electricity', subsection:'conductors', difficulty:1,
    ...
    explanation:'A metal coin is made of metal, which allows electricity to pass through it. Plastic, rubber, and glass are insulators. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-004', chapterId:'plants', subsection:'growth', difficulty:2,
    ...
    explanation:'Strong winds are a natural cause of soil erosion. Overgrazing, burning forests, and cutting trees are all caused by humans. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-005', chapterId:'plants', subsection:'reproduction', difficulty:2,
    ...
    explanation:'During germination, the root (radicle) appears first and grows downward, then the shoot grows upward toward light. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-006', chapterId:'plants', subsection:'growth', difficulty:1,
    ...
    explanation:'The root absorbs water and mineral salts from the soil and transports them upward to the rest of the plant. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-007', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'Plants absorb carbon dioxide from the air through tiny pores (stomata) in their leaves to carry out photosynthesis. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-008', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'Evaporation is the process by which liquid water gains energy from the sun and changes to water vapour, rising into the atmosphere. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-009', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'When temperature increases, the mercury (or alcohol) in the thermometer expands and rises up the tube, giving a higher reading. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-010', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Echo parakeet (Psittacula eques) is endemic to Mauritius - it is found nowhere else in the world. It was saved from extinction by conservation efforts. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-011', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Rodrigues warbler (Cardinal jaune / Acrocephalus rodericanus) is endemic to Rodrigues. The Echo parakeet and Kestrel are endemic to Mauritius. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-012', chapterId:'energy', subsection:'sources', difficulty:1,
    ...
    explanation:'Trees (and all green plants) use sunlight (solar energy) along with carbon dioxide and water to make food through photosynthesis. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-013', chapterId:'energy', subsection:'renewable', difficulty:2,
    ...
    explanation:'Petrol is a fossil fuel derived from crude oil. Bagasse is a by-product of sugarcane, charcoal comes from burning wood, and wood itself is not a fossil fuel. 📄 PSAC 2024 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp24-014', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'Wires covered in plastic or rubber insulation are safer because the insulating layer prevents accidental electric shocks by stopping electricity from passing through to a person who touches the wire. 📄 PSAC 2024 exam.' })
);
