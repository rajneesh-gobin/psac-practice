...
STATIC_QUESTIONS.push(
  ...
  makeTF({ id:'g5sci-pl-003', chapterId:'plants', subsection:'parts', difficulty:1,
  ...
  makeMCQ({ id:'g5sci-pl-004', chapterId:'plants', subsection:'parts', difficulty:1,
    question:'What is the main function of the stem in a plant?',
    options:['It absorbs sunlight to make food','It produces the seeds and fruits','It transports water from roots to leaves','It absorbs water from the soil'],
  ...
  makeMCQ({ id:'g5sci-pl-005', chapterId:'plants', subsection:'reproduction', difficulty:2,
  ...
  makeMCQ({ id:'g5sci-pl-009', chapterId:'plants', subsection:'reproduction', difficulty:2,
    question:'What happens during pollination?',
    options:[
      'Pollen is transferred from the male part to the female part',
      'A seed is transferred from the flower to the soil',
      'Water is transferred from the roots to the leaves',
      'Pollen is transferred from the female part to the male part'
    ],
    answer:'Pollen is transferred from the male part to the female part',
  ...
  makeMCQ({ id:'g5sci-pl-010', chapterId:'plants', subsection:'parts', difficulty:1,
  ...
  makeMatch({ id:'g5sci-pl-011', chapterId:'plants', subsection:'parts', difficulty:1,
    leftItem:'Root',
  ...
  makeMatch({ id:'g5sci-pl-012', chapterId:'plants', subsection:'parts', difficulty:1,
    leftItem:'Stem',
    allRights:['Absorbs water and minerals from the soil','Transports water from roots to leaves','Makes food through photosynthesis','Produces seeds through reproduction'],
  ...
  makeMCQ({ id:'g5sci-pl-013', chapterId:'plants', subsection:'growth', difficulty:2,
  ...
  makeMCQ({ id:'g5sci-pl-014', chapterId:'plants', subsection:'reproduction', difficulty:1,
  ...
  makeMCQ({ id:'g5sci-pl-015', chapterId:'plants', subsection:'parts', difficulty:1,
  ...
  makeMCQ({ id:'g5sci-pl-016', chapterId:'plants', subsection:'photosynthesis', difficulty:2,
  ...
  makeMCQ({ id:'g5sci-pl-017', chapterId:'plants', subsection:'growth', difficulty:2,
  ...
  makeNum({ id:'g5sci-pl-018', chapterId:'plants', subsection:'parts', difficulty:2,
  ...
  makeMCQ({ id:'g5sci-pl-019', chapterId:'plants', subsection:'reproduction', difficulty:2,
  ...
  makeTF({ id:'g5sci-pl-020', chapterId:'plants', subsection:'reproduction', difficulty:2,
  ...
  makeMCQ({ id:'g5sci-pl-021', chapterId:'plants', subsection:'parts', difficulty:3,
  ...
  makeMCQ({ id:'g5sci-pl-022', chapterId:'plants', subsection:'reproduction', difficulty:3,
    ...
    options:[
      'Seed A - because water is one of the conditions for germination',
      'Seed B - because dry conditions speed up germination',
      'Both seeds - temperature is the only factor that matters',
      'Neither seed - because seeds need sunlight to germinate'
    ],
    answer:'Seed A - because water is one of the conditions for germination',
  ...
  makeMCQ({ id:'g5sci-pl-023', chapterId:'plants', subsection:'growth', difficulty:3,
    ...
    options:[
      'The plant will overheat because there is no fresh breeze',
      'The plant will use up the carbon dioxide and cannot make food',
      'The plant cannot grow without wind to spread its seeds',
      'The sealed room traps too much oxygen, which poisons the plant'
    ],
    answer:'The plant will use up the carbon dioxide and cannot make food',
  ...
  makeMCQ({ id:'g5sci-pl-024', chapterId:'plants', subsection:'reproduction', difficulty:4,
    ...
    options:[
      ...
      'Because a fair test changes only ONE variable at a time',
      'Because seeds always germinate when they are watered',
      'Because the friend should have done the experiment themselves'
    ],
    answer:'Because a fair test changes only ONE variable at a time',
  ...
  makeMCQ({ id:'g5sci-pl-025', chapterId:'plants', subsection:'growth', difficulty:4,
    ...
    options:[
      'Grass roots bind the soil and its leaves slow the falling rain',
      ...
      'Grass produces a chemical that repels rainwater from the soil'
    ],
    answer:'Grass roots bind the soil and its leaves slow the falling rain',
  ...
  makeMCQ({ id:'g5sci-pl-028', chapterId:'plants', subsection:'diagrams', difficulty:2,
    ...
    options:[
      ...
      'Soil erosion - prevented by planting trees and grass',
      'Photosynthesis - prevented by removing leaves',
      'Germination - prevented by watering crops'
    ],
    answer:'Soil erosion - prevented by planting trees and grass',
  ...
  makeMCQ({ id:'g5sci-pl-030', chapterId:'plants', subsection:'diagrams', difficulty:1,
    ...
    options:[
      'They absorb water and minerals from the soil AND anchor the plant',
      'They make food through photosynthesis AND transport it to the leaves',
      'They attract insects for pollination AND produce new seeds',
      'They store seeds for the plant AND release oxygen into the soil'
    ],
    answer:'They absorb water and minerals from the soil AND anchor the plant',
