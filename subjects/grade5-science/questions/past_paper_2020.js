...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp20-001', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Spiders use their silk webs to trap insects for food. The sticky threads hold the prey until the spider arrives to eat it. 📄 PSAC 2020 exam.' }),

  makeMCQ({ id:'g5sc-pp20-002', chapterId:'energy', subsection:'sources', difficulty:2,
    ...
    explanation:'Only 2 families used electric water heaters, making it the least popular choice. Solar heaters were the most popular (10 families) as Mauritius has abundant sunshine. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-003', chapterId:'energy', subsection:'sources', difficulty:2,
    ...
    explanation:'Mauritius is close to the equator and receives lots of sunlight all year. Solar energy is free and renewable, making solar water heaters cheaper to run than electric ones. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-004', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'Roots absorb water and mineral salts from the soil through tiny root hair cells. The absorbed water is then transported up the stem to the leaves. 📄 PSAC 2020 exam.' }),

  makeMCQ({ id:'g5sc-pp20-005', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'Plants absorb carbon dioxide from the air through their stomata (pores in leaves) and use it, along with sunlight and water, to make food through photosynthesis. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-006', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'When the switch is open, it creates a break in the circuit. No current can flow, so the bulb does not light up. The circuit must be complete (closed) for current to flow. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-007', chapterId:'electricity', subsection:'circuits', difficulty:2,
    ...
    explanation:'An iron nail is made of metal, which is a conductor of electricity. When placed to bridge the gap in the circuit, current flows through it and lights the bulb. Plastic, rubber, and wood are insulators. 📄 PSAC 2020 exam.' }),

  makeMCQ({ id:'g5sc-pp20-008', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'The container at 75°C loses water fastest because higher temperature gives water molecules more energy to break free from the liquid surface and evaporate. The rate of evaporation increases with temperature. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-009', chapterId:'water-matter', subsection:'water_cycle', difficulty:2,
    ...
    explanation:'Precipitation is any form of water that falls from clouds to the ground, including rain, hail, sleet, and snow. It is a key step in the water cycle. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-010', chapterId:'animals', subsection:'endangered', difficulty:2,
    ...
    explanation:'The Mauritius Kestrel nearly went extinct due to destruction of its forest habitat, use of pesticides (DDT), and predation by introduced animals like rats and monkeys. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-011', chapterId:'energy', subsection:'transfer', difficulty:1,
    ...
    explanation:'When cycling, the body converts chemical energy from food into movement (kinetic) energy. The muscles use food energy to power the pedalling motion. 📄 PSAC 2020 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp20-012', chapterId:'plants', subsection:'growth', difficulty:2,
    ...
    explanation:'Planting trees and dense vegetation prevents soil erosion because plant roots bind the soil together and the plant cover protects it from the impact of rain and wind. 📄 PSAC 2020 exam.' })
);
