...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp18-001', chapterId:'water-matter', subsection:'properties', difficulty:1,
    ...
    explanation:'Ice is hard (solid state) and slippery (low friction at its surface). These two properties make it ideal for ice skating. It is cold, not warm. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-002', chapterId:'plants', subsection:'reproduction', difficulty:2,
    ...
    explanation:'The female part (stigma/pistil) receives pollen during pollination. Pollen is produced by the male part (anther/stamen) and must travel to the female part for fertilisation to occur. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-003', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'Bulrush (cattail) is adapted to grow in waterlogged, marshy, and wetland conditions. Cactus is adapted to dry deserts; ferns prefer shaded, moist-but-not-flooded areas; papayas need well-drained soil. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-004', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'Sugar cane is cultivated for its thick stem, which is rich in sucrose (sugar). Tea is grown for its leaves, beetroot for its root, and water lily for ornamental flowers. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-005', chapterId:'energy', subsection:'transfer', difficulty:2,
    ...
    explanation:'A washing machine transforms electrical energy into movement (kinetic) energy as the electric motor spins the drum. There is also some heat and sound produced, but movement is the main output. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-006', chapterId:'electricity', subsection:'circuits', difficulty:2,
    ...
    explanation:'A circuit connected to only one terminal of the battery is an open circuit. Current cannot flow because there is no complete path from one terminal, through the circuit, back to the other terminal. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-007', chapterId:'electricity', subsection:'circuits', difficulty:1,
    ...
    explanation:'A switch allows you to open or close the circuit. Opening the switch breaks the circuit so no current flows and the bulb goes off, saving electrical energy. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-008', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'The main function of a leaf is to make food for the plant through photosynthesis, using sunlight, carbon dioxide, and water. Chlorophyll in leaves captures the sunlight energy. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-009', chapterId:'plants', subsection:'growth', difficulty:2,
    ...
    explanation:'Heavy rain and strong winds are the main natural agents of soil erosion. Raindrops dislodge soil particles and water flows carry them away; wind blows dry topsoil. 📄 PSAC 2018 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp18-010', chapterId:'conservation', subsection:'deforestation', difficulty:3,
    ...
    explanation:'Mangrove trees have complex root systems that trap sediment and absorb wave energy, protecting coastlines from erosion. They also act as nurseries for fish and other marine animals. 📄 PSAC 2018 exam.' })
);
