...
STATIC_QUESTIONS.push(
  makeMCQ({ id:'g5sc-pp19-001', chapterId:'water-matter', subsection:'states', difficulty:1,
    ...
    explanation:'Ice is water in its solid state. It has a fixed shape and volume. Air and steam are gases; water (liquid) and steam are not solids. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-002', chapterId:'plants', subsection:'parts', difficulty:1,
    ...
    explanation:'The stem transports water and mineral salts from the roots upward to all other parts of the plant, including the leaves, through tubes called xylem vessels. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-003', chapterId:'plants', subsection:'growth', difficulty:2,
    ...
    explanation:'Growing dense vegetation (plants and trees) prevents soil erosion because plant roots bind the soil together and plant cover protects the ground from the force of rain and wind. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-004', chapterId:'energy', subsection:'transfer', difficulty:1,
    ...
    explanation:'An electric iron converts electrical energy to heat energy. This heat is used to smooth out creases in clothing. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-005', chapterId:'electricity', subsection:'circuits', difficulty:2,
    ...
    explanation:'The bulb lights up only in Circuit B, which is a complete closed circuit with a battery and no breaks. Circuits A, C, and D all have either a break or no power source. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-006', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'Flowers are brightly coloured and often scented to attract insects such as bees and butterflies. When insects visit for nectar, they pick up pollen and carry it to other flowers, enabling pollination. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-007', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Earthworms live in the soil. They burrow through it, which improves drainage and aeration, making the soil better for plant growth. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-008', chapterId:'animals', subsection:'habitats', difficulty:1,
    ...
    explanation:'Frogs are amphibians and can live both in water and on land. They breathe through gills as tadpoles in water and through lungs and skin as adults on land. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-009', chapterId:'animals', subsection:'classification', difficulty:2,
    ...
    explanation:'The Mauritius Kestrel (Falco punctatus) is endemic to Mauritius and is the national bird. It was saved from extinction through a successful breeding programme. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-010', chapterId:'plants', subsection:'parts', difficulty:2,
    ...
    explanation:'Chlorophyll is the green pigment found in plant leaves that absorbs sunlight energy. It is essential for photosynthesis - the process by which plants make their own food. 📄 PSAC 2019 exam.' }),
  ...
  makeMCQ({ id:'g5sc-pp19-011', chapterId:'water-matter', subsection:'states', difficulty:2,
    ...
    explanation:'The sun provides the heat energy that drives evaporation in the water cycle. Sunlight heats the surface of oceans and lakes, causing liquid water to change into water vapour. 📄 PSAC 2019 exam.' })
);
