...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-vol-002', chapterId:'volcanism', subsection:'craters', difficulty:1,
  ...
  makeTF({ id:'g5hg-vol-003', chapterId:'volcanism', subsection:'craters', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-vol-004', chapterId:'volcanism', subsection:'formation', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-vol-005', chapterId:'volcanism', subsection:'rocks_soil', difficulty:2,
    ...
    options:[
      ...
      'Because volcanic rock breaks down into rich soil',
      'Because farmers import special soil from Africa',
      'Because the coral reef keeps the soil rich'
    ],
    answer:'Because volcanic rock breaks down into rich soil',
  ...
  makeMCQ({ id:'g5hg-vol-006', chapterId:'volcanism', subsection:'formation', difficulty:2,
    question:'What is "alluvium"?',
    options:[
      'A type of basalt rock found on mountain peaks',
      'Fine fertile sediment deposited by rivers',
      'The hot liquid rock inside a volcano',
      'A type of coral found in the Mauritian lagoon'
    ],
    answer:'Fine fertile sediment deposited by rivers',
  ...
  makeMCQ({ id:'g5hg-vol-007', chapterId:'volcanism', subsection:'active', difficulty:2,
  ...
  makeMCQ({ id:'g5hg-vol-008', chapterId:'volcanism', subsection:'craters', difficulty:1,
    question:'What is a volcanic CRATER?',
    options:[
      'The tunnel through which lava flows underground',
      'The bowl-shaped hollow at the top of a volcano',
      'A type of fertile soil found near volcanoes',
      'The flat plain at the base of a mountain'
    ],
    answer:'The bowl-shaped hollow at the top of a volcano',
  ...
  makeMCQ({ id:'g5hg-vol-009', chapterId:'volcanism', subsection:'formation', difficulty:2,
    ...
    options:[
      ...
      'They were carved out by rivers over millions of years',
      'They were created by a massive earthquake',
      'They were formed when lava tubes collapsed'
    ],
    answer:'They were carved out by rivers over millions of years',
  ...
  makeTF({ id:'g5hg-vol-010', chapterId:'volcanism', subsection:'active', difficulty:1,
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-vol-011', chapterId:'volcanism', subsection:'formation', difficulty:2,
    question:'What is Karthala?',
    options:[
      'An extinct volcanic crater in the centre of Mauritius',
      'An active volcano on Grand Comore in the Comoros',
      'A type of volcanic rock found only in Rodrigues',
      'A coral island near the coast of Mauritius'
    ],
    answer:'An active volcano on Grand Comore in the Comoros',
  ...
  makeMCQ({ id:'g5hg-vol-012', chapterId:'volcanism', subsection:'active', difficulty:2,
    question:'What is LAVA?',
    options:[
      'The molten rock INSIDE the Earth before it reaches the surface',
      'Molten rock that has erupted and reached the surface',
      'The cloud of ash and gas released by a volcano',
      'The solid black rock found in fields in Mauritius'
    ],
    answer:'Molten rock that has erupted and reached the surface',
  ...
  makeTF({ id:'g5hg-vol-013', chapterId:'volcanism', subsection:'active', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-vol-014', chapterId:'volcanism', subsection:'rocks_soil', difficulty:2,
    ...
    options:[
      ...
      'On the central plateau, where basalt has weathered into rich red soil',
    ...
    answer:'On the central plateau, where basalt has weathered into rich red soil',
  ...
  makeMCQ({ id:'g5hg-vol-015', chapterId:'volcanism', subsection:'active', difficulty:3,
    ...
    options:[
      'Réunion still sits over the hot spot; Mauritius has drifted away',
    ...
    answer:'Réunion still sits over the hot spot; Mauritius has drifted away',
  ...
  makeMCQ({ id:'g5hg-vol-016', chapterId:'volcanism', subsection:'formation', difficulty:3,
    ...
    options:[
      ...
      'The layers show repeated lava flows, each a separate eruption',
      'The basalt fell from the sky in horizontal layers',
      'The layering shows this is sedimentary rock, not volcanic'
    ],
    answer:'The layers show repeated lava flows, each a separate eruption',
  ...
  makeMCQ({ id:'g5hg-vol-017', chapterId:'volcanism', subsection:'formation', difficulty:2,
    ...
    options:[
      ...
      'Native forests absorb rain and release it slowly into rivers',
    ...
    answer:'Native forests absorb rain and release it slowly into rivers',
  ...
  makeMCQ({ id:'g5hg-vol-018', chapterId:'volcanism', subsection:'formation', difficulty:2,
    question:'What is a volcanic HOT SPOT?',
    options:[
      'A very hot beach lying next to a volcano',
      'A fixed point of volcanic activity that plates slowly move over',
      'The crater at the top of a volcano which is the hottest part',
      'An area near a volcano where the ground temperature is warm'
    ],
    answer:'A fixed point of volcanic activity that plates slowly move over',
  ...
  makeMCQ({ id:'g5hg-vol-019', chapterId:'volcanism', subsection:'active', difficulty:4,
    ...
    options:[
      'Volcanic soil feeds the cane; no eruptions mean safe land; the reef stops erosion; rivers irrigate',
      'Volcanoes warm the soil; the reef shelters ships; the rivers water nothing on the farms',
      'None of these features matter for sugar cane - success was due only to cheap labour',
      'The reef feeds the workers; the soil needs new ash constantly; the rivers flood the fields'
    ],
    answer:'Volcanic soil feeds the cane; no eruptions mean safe land; the reef stops erosion; rivers irrigate',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-vol-020', chapterId:'volcanism', subsection:'formation', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/trou-aux-cerfs-crater.jpg" alt="a landscape seen from above" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>What type of volcanic feature is shown in this photo, located in Curepipe, Mauritius?</b>',
    options:['A collapsed lava tube','An active volcano crater','An extinct volcanic crater','A deep river gorge'],
  ...
  makeMCQ({ id:'g5hg-vol-021', chapterId:'volcanism', subsection:'craters', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/grand-bassin-ganga-talao.jpg" alt="a lake inside a crater surrounded by forested hills" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>Grand Bassin (Ganga Talao) is a crater lake in Mauritius. For what is it primarily famous?</b>',
    options:[
      'It is the largest freshwater reservoir used for drinking water',
      'It is a sacred Hindu site for the Maha Shivaratri festival',
      'It is a nature reserve protecting the Pink Pigeon',
      'It is the site of Mauritius\'s first sugar mill'
    ],
    answer:'It is a sacred Hindu site for the Maha Shivaratri festival',
  ...
  makeMCQ({ id:'g5hg-vol-022', chapterId:'volcanism', subsection:'active', difficulty:2,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/piton-de-la-fournaise-eruption.jpg" alt="a volcanic landscape" style="max-height:220px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>This volcano (Piton de la Fournaise) is located on which island near Mauritius - and is it active or extinct?</b>',
    options:[
      'Rodrigues - it is long extinct',
      'Réunion - one of the most active volcanoes',
      'Madagascar - it last erupted in 1902',
      'Comoros - it is a dormant volcano'
    ],
    answer:'Réunion - one of the most active volcanoes',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-vol-024', chapterId:'volcanism', subsection:'formation', difficulty:1,
    question:'<div style="text-align:center;margin-bottom:12px"><img src="assets/questions/volcano.jpg" alt="a mountain with a wide crater at its summit" style="max-height:200px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.15)"></div><b>Mauritius was formed by this type of natural feature. What is it called?</b>',
