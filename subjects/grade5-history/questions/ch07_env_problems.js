...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ep-001', chapterId:'env-problems', subsection:'beach_erosion', difficulty:1,
    ...
    options:[
      ...
      'The wearing away of beach sand by waves',
      'The planting of trees along the beach',
      'The natural cleaning of a beach by rainfall'
    ],
    answer:'The wearing away of beach sand by waves',
  ...
  makeMCQ({ id:'g5hg-ep-005', chapterId:'env-problems', subsection:'soil_erosion', difficulty:2,
    ...
    options:[
      ...
      'Tree roots hold soil together, so bare soil washes away',
      'Deforestation makes it rain more heavily',
      'Trees absorb soil minerals, leaving the soil unstable'
    ],
    answer:'Tree roots hold soil together, so bare soil washes away',
  ...
  makeMCQ({ id:'g5hg-ep-007', chapterId:'env-problems', subsection:'pollution', difficulty:2,
    ...
    options:[
      ...
      'The coral reef is damaged - corals die and bleach',
      'Pollution protects the reef from storm waves',
      'Pollution has no real effect on the coral reef'
    ],
    answer:'The coral reef is damaged - corals die and bleach',
  ...
  makeMCQ({ id:'g5hg-ep-010', chapterId:'env-problems', subsection:'conservation', difficulty:2,
    ...
    options:[
      'Only because the island looks pretty',
      'Because nature supports tourism, fishing, water and wildlife',
      'Because the government has been told to by another country',
      'Because the environment is not really important'
    ],
    answer:'Because nature supports tourism, fishing, water and wildlife',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ep-011', chapterId:'env-problems', subsection:'beach_erosion', difficulty:1,
    ...
    answer:'A powerful tropical storm with strong winds and heavy rain',
  ...
  makeMCQ({ id:'g5hg-ep-012', chapterId:'env-problems', subsection:'beach_erosion', difficulty:2,
    ...
    options:[
      ...
      'Powerful cyclone waves strike the coast and remove sand',
    ...
    answer:'Powerful cyclone waves strike the coast and remove sand',
  ...
  makeMCQ({ id:'g5hg-ep-014', chapterId:'env-problems', subsection:'pollution', difficulty:2,
    ...
    options:[
      'The fertilisers make the fish grow too large to be caught',
      'Nutrients cause algae blooms that block sunlight and kill coral',
    ...
    answer:'Nutrients cause algae blooms that block sunlight and kill coral',
  ...
  makeMCQ({ id:'g5hg-ep-015', chapterId:'env-problems', subsection:'pollution', difficulty:2,
    ...
    options:[
      ...
      'Marine oil pollution that harms sea life and coral',
      'Noise pollution from rescue helicopters',
      'Plastic pollution from the ship\'s cargo'
    ],
    answer:'Marine oil pollution that harms sea life and coral',
  ...
  makeMCQ({ id:'g5hg-ep-016', chapterId:'env-problems', subsection:'beach_erosion', difficulty:3,
    ...
    options:[
      'Sea wall: stops the waves at once; Mangroves: trap sand and cost less',
      'Sea wall: grows bigger on its own; Mangroves: are made of concrete',
      'Both solutions are exactly identical in cost, effect and lifespan',
      'Sea wall: is completely free; Mangroves: cost millions of rupees and never work'
    ],
    answer:'Sea wall: stops the waves at once; Mangroves: trap sand and cost less',
  ...
  makeMCQ({ id:'g5hg-ep-017', chapterId:'env-problems', subsection:'pollution', difficulty:3,
    ...
    options:[
      'Turtles eat plastic bags thinking they are jellyfish and starve',
    ...
    answer:'Turtles eat plastic bags thinking they are jellyfish and starve',
  ...
  makeMCQ({ id:'g5hg-ep-018', chapterId:'env-problems', subsection:'pollution', difficulty:4,
    ...
    options:[
      ...
      'Environmental problems are interconnected - damage spreads to nature, jobs and the economy',
    ...
    answer:'Environmental problems are interconnected - damage spreads to nature, jobs and the economy',
  ...
  makeMCQ({ id:'g5hg-ep-019', chapterId:'env-problems', subsection:'pollution', difficulty:2,
    ...
    options:[
      'Pour used cooking oil down the kitchen drain',
      'Use fewer garden chemicals and dispose of rubbish properly',
      'Throw plastic rubbish near the beach where tides can carry it away',
      'Wash the car on the beach itself to save tap water'
    ],
    answer:'Use fewer garden chemicals and dispose of rubbish properly',
