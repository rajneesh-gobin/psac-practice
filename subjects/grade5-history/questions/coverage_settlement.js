...
(function () {
  ...
  ],['Britain','the Battle of Grand Port','French','Mauritius','Sir Robert Farquhar','to control an important Indian Ocean route','1810','the abolition of slavery','the ending of slavery by law','slavery was abolished','French period','Britain','to work as indentured labourers','the arrival of indentured labourers','a worker under a contract for a set time','it changed laws and people’s lives','some French laws and customs','control of the island','respect for people’s experiences','1968'],'Think about the change from French to British rule and the important dates.');
})();
