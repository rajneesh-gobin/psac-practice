...
const G5HG_LEARN = {
  'g5hg-cov-sett-dutch-4': 'The <b>Dodo</b> was a large, flightless bird found only in Mauritius. Having evolved with no natural predators, it had no instinct to flee from humans. Settlers hunted it for food, while rats from their ships raided its ground-level nests. The combination of hunting and egg predation made it extinct within about a century of human arrival.',
  'g5hg-cov-sett-dutch-14': 'The Dodo\'s extinction teaches us about <b>conservation</b> — protecting species and their habitats before it is too late. Once a species is gone, it cannot be brought back. Today, Mauritius protects many endemic species through nature reserves, conservation programmes, and laws against hunting.',
  'g5hg-cov-sett-french-3': '<b>Sugar cane</b> thrives in the hot, wet climate of Mauritius. The French introduced large-scale sugar production, using plantation labour to grow and harvest the cane. The juice is crushed out and refined into sugar, which could be stored and shipped to Europe for profit. Sugar dominated the Mauritian economy for over 200 years.',
  'g5hg-cov-sett-british-7': 'The <b>abolition of slavery</b> in 1835 was one of the most significant events in Mauritian history. Previously, enslaved people were owned as property and forced to work without pay. The Slavery Abolition Act freed approximately 66,000 enslaved people in Mauritius, changing the island\'s society completely.',
  'g5hg-cov-sett-british-8': '<b>Abolition</b> means formally ending something by law. When applied to slavery, it means making it illegal to own or trade people. After abolition in 1835, former enslaved people were legally free, though they often faced continued hardship with little land or resources of their own.',
  'g5hg-cov-sett-british-12': '<b>Indentured workers</b> came mainly from India after abolition. They signed a contract to work for a fixed number of years (usually five) in exchange for a wage and passage to Mauritius. The system replaced enslaved labour on the sugar plantations, though conditions were often harsh. Most stayed after their contracts ended.',
  'g5hg-cov-sett-british-14': 'An <b>indentured labourer</b> is a worker bound by a legal contract to work for a specific employer for a set period. Unlike a slave, they could not be bought or sold, and they received a wage. However, they could not leave their employer before the contract ended, and conditions were often very difficult.',
};
  const add=(id,s,q,o,a,h)=>STATIC_QUESTIONS.push(makeMCQ({id,chapterId:'settlement',subsection:s,difficulty:2,question:q,options:o,answer:a,hint:h,explanation:G5HG_EXPL[id]||`<b>${a}</b> is correct.`,learnMore:G5HG_LEARN[id]||''}));
