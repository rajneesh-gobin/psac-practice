...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ne-001', chapterId:'natural-env', subsection:'relief', difficulty:1,
    ...
    options:['Corps de Garde, Quatre Bornes','Le Morne Brabant, Black River','Piton de la Petite Rivière Noire','Trou aux Cerfs, Curepipe'],
  ...
  makeMCQ({ id:'g5hg-ne-005', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    answer:'Hot wet summer and cool dry winter',
  ...
  makeMCQ({ id:'g5hg-ne-006', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:['The eastern coastal strip','The western coastal plain','The central plateau and south-east','The northern coastal plain'],
  ...
  makeMCQ({ id:'g5hg-ne-008', chapterId:'natural-env', subsection:'coast', difficulty:2,
    ...
    options:[
      ...
      'The mountains create a rain shadow in the west',
      'The sea is warmer on the west coast',
      'The west coast has a coral reef that stops rain'
    ],
    answer:'The mountains create a rain shadow in the west',
  ...
  makeMCQ({ id:'g5hg-ne-009', chapterId:'natural-env', subsection:'coast', difficulty:1,
    ...
    options:[
      ...
      'Shallow calm water inside a coral reef',
      'A freshwater lake in the mountains',
      'A fast-flowing river in a gorge'
    ],
    answer:'Shallow calm water inside a coral reef',
  ...
  makeMCQ({ id:'g5hg-ne-010', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:[
      ...
      'Because the plateau is higher, so water flows down',
      'Because the sea is higher than the land',
      'Because wind pushes the rivers towards the coast'
    ],
    answer:'Because the plateau is higher, so water flows down',
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ne-011', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:['Piton de la Petite Rivière Noire','Le Morne Brabant, Black River','Mont Limon','Corps de Garde, Quatre Bornes'],
    answer:'Mont Limon',
  ...
  makeMCQ({ id:'g5hg-ne-012', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:[
      ...
      'A western limestone plateau and a volcanic central ridge',
      'An eastern coral atoll and a western volcanic peak',
      'A northern basalt plain and a southern limestone coast'
    ],
    answer:'A western limestone plateau and a volcanic central ridge',
  ...
  makeMCQ({ id:'g5hg-ne-014', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:[
      ...
      'A line joining places with the same rainfall',
      'A line joining places with the same temperature',
      'A line showing the path of a cyclone'
    ],
    answer:'A line joining places with the same rainfall',
  ...
  makeMCQ({ id:'g5hg-ne-015', chapterId:'natural-env', subsection:'relief', difficulty:2,
    ...
    options:[
      ...
      'Rain caused by moist air being forced to rise over mountains',
    ...
    answer:'Rain caused by moist air being forced to rise over mountains',
  ...
  makeMCQ({ id:'g5hg-ne-016', chapterId:'natural-env', subsection:'relief', difficulty:1,
    ...
    options:[
      ...
      'Rain caused by hot ground making moist air rise quickly',
      'Rain caused by cold ocean currents chilling the air above',
      'Rain blown in from the sea without rising'
    ],
    answer:'Rain caused by hot ground making moist air rise quickly',
  ...
  makeMCQ({ id:'g5hg-ne-018', chapterId:'natural-env', subsection:'relief', difficulty:3,
    ...
    options:[
      ...
      'The air cools with altitude and the plateau forces winds to rise',
    ...
    answer:'The air cools with altitude and the plateau forces winds to rise',
  ...
  makeMCQ({ id:'g5hg-ne-019', chapterId:'natural-env', subsection:'relief', difficulty:4,
    ...
    options:[
      ...
      'Trade winds bring rain to the windward plateau; the west coast lies in a rain shadow',
    ...
    answer:'Trade winds bring rain to the windward plateau; the west coast lies in a rain shadow',
