...
const G5HG_EXPL = {
  ...
  add('g5hg-cov-port-history-4','port-louis','history','What was Mauritius called during French rule?',['Île de France, or Isle of France','Île aux Cerfs','La Belle Province','Île Rodrigues'],'Île de France, or Isle of France',PH);
