...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ta-001', chapterId:'trade-agri', subsection:'personalities', difficulty:1,
    question:'Who was the French governor who built Port Louis harbour, sugar mills, roads and a hospital in Isle de France?',
  ...
  makeMCQ({ id:'g5hg-ta-002', chapterId:'trade-agri', subsection:'crops', difficulty:1,
    question:'What was the MAIN crop grown on plantations in Mauritius during the French period?',
    options:['Tea','Coffee','Sugar cane','Cotton'],
    answer:'Sugar cane',
    hint:'This crop became the backbone of the Mauritian economy for centuries.',
    explanation:'<b>Sugar cane</b> became the dominant crop in Mauritius during French rule. The island\'s fertile volcanic soil and tropical climate were ideal for sugar cane cultivation.' }),

  makeMCQ({ id:'g5hg-ta-003', chapterId:'trade-agri', subsection:'crops', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-ta-004', chapterId:'trade-agri', subsection:'personalities', difficulty:1,
    question:'Who was the FIRST British governor of Mauritius after the British captured it in 1810?',
    options:['Charles Decaen','Mahé de Labourdonnais','Pierre Poivre','Robert Farquhar'],
    answer:'Robert Farquhar',
    hint:'He governed the island from 1810 and continued many of the French developments.',
    explanation:'<b>Robert Farquhar</b> became the first British governor of Mauritius after the British took control in 1810. He governed until 1823 and oversaw the transition from French to British rule.' }),

  makeMCQ({ id:'g5hg-ta-005', chapterId:'trade-agri', subsection:'crops', difficulty:2,
  ...
  makeTF({ id:'g5hg-ta-006', chapterId:'trade-agri', subsection:'personalities', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-ta-007', chapterId:'trade-agri', subsection:'crops', difficulty:2,
    ...
    hint:'He needed a place to cultivate the spice plants he had brought from the East Indies.',
    explanation:'<b>Pierre Poivre</b> developed the Pamplemousses gardens as a place to grow and study the spice plants he introduced from the East Indies. The garden is now a national heritage site.' }),

  makeMCQ({ id:'g5hg-ta-008', chapterId:'trade-agri', subsection:'crops', difficulty:2,
  ...
  makeMCQ({ id:'g5hg-ta-009', chapterId:'trade-agri', subsection:'personalities', difficulty:2,
    question:'Which French governor ruled Isle de France during the Napoleonic period (1803–1810), just before the British took over?',
    options:['Mahé de Labourdonnais','Pierre Poivre','Robert Farquhar','Charles Decaen'],
    answer:'Charles Decaen',
    hint:'Napoleon Bonaparte was emperor of France during this period.',
    explanation:'<b>Charles Decaen</b> was the French governor of Isle de France from 1803 to 1810, during the Napoleonic era. He governed the island until the British captured it.' }),

  makeMCQ({ id:'g5hg-ta-010', chapterId:'trade-agri', subsection:'crops', difficulty:2,
    question:'What happened to the enslaved people working on Mauritius plantations after Britain took control?',
    options:[
      'They were immediately freed when the British arrived in 1810',
      'Slavery continued for over 20 more years; it was abolished in 1835',
      'They were returned to Africa by the British',
      'They became British soldiers'
    ],
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g5hg-ta-011', chapterId:'trade-agri', subsection:'personalities', difficulty:2,
  ...
  makeMCQ({ id:'g5hg-ta-012', chapterId:'trade-agri', subsection:'crops', difficulty:2,
  ...
  makeMCQ({ id:'g5hg-ta-013', chapterId:'trade-agri', subsection:'crops', difficulty:1,
    question:'After slavery was abolished in 1835, who came to work on the sugar cane plantations in Mauritius?',
    options:[
      'Workers from France and Britain',
      'Indentured workers, mainly from India',
      'Chinese workers from Hong Kong',
      'Freed workers from the United States'
    ],
  ...
  makeTF({ id:'g5hg-ta-014', chapterId:'trade-agri', subsection:'crops', difficulty:1,
  ...
  makeMCQ({ id:'g5hg-ta-015', chapterId:'trade-agri', subsection:'crops', difficulty:2,
  ...
  makeMCQ({ id:'g5hg-ta-016', chapterId:'trade-agri', subsection:'crops', difficulty:3,
  ...
  makeMCQ({ id:'g5hg-ta-017', chapterId:'trade-agri', subsection:'crops', difficulty:3,
  ...
  makeMCQ({ id:'g5hg-ta-019', chapterId:'trade-agri', subsection:'personalities', difficulty:2,
    question:'How did Robert Farquhar, the first British governor, help the sugar industry in Mauritius?',
    options:[
      'He banned sugar production and replaced it with cotton farming',
      'He encouraged planters to expand sugar cane cultivation and granted them land',
      'He imported French workers to replace Indian labourers',
      'He introduced a sugar tax whose revenue went directly to the planters'
    ],
    answer:'He encouraged planters to expand sugar cane cultivation and granted them land',
    hint:'Farquhar wanted Mauritius to be economically productive for Britain.',
    explanation:'<b>Robert Farquhar</b> (first British governor, 1810–1823) actively encouraged the expansion of <b>sugar cane cultivation</b>. He granted land to planters and promoted the industry as the foundation of the island\'s economy. Under his governance, sugar production grew significantly.' })
