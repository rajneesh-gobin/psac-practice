'use strict';
// Grade 1 Science — PLACEHOLDER. Delete this file when real questions land.
// IDs format: g1s-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g1s-samp-001', chapterId:'g1s-sample', difficulty:1,
    question:'Placeholder — this pack has no real questions yet.',
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 1 Science questions.',
    explanation:'Placeholder question for the Grade 1 Science pack.' })
