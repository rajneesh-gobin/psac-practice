'use strict';
// ══════════════════════════════════════════════════════════════════════════
//  Grade 1 — Science   ·   PLACEHOLDER PACK
//
...
//       model. IDs: g1s-samp-001 style. Every question needs a `subsection:`
//       tag that matches an id declared in G1SC_SYLLABUS below.
...
registerSubject({
  ...
  chapters: [
    ...
    { id: 'g1s-sample', name: 'Sample Chapter', icon: '📝', examWeight: 0,
      syllabus: '' },
  ],
});
