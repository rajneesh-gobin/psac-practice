'use strict';
// Grade 9 Français - PLACEHOLDER. Delete this file when real questions land.
// IDs format: g9fr-samp-NNN
//
...
STATIC_QUESTIONS.push(
  ...
  makeMCQ({ id:'g9fr-samp-001', chapterId:'g9fr-grammaire', difficulty:1,
    ...
    options:['A','B','C','D'],
    answer:'A',
    hint:'Replace this file with real Grade 9 Français questions.',
    explanation:'Placeholder question for the Grade 9 Français pack.' })
